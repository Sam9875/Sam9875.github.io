...
void main() {
	...
	`}var co=class extends ze{constructor(t=1,e={}){super(t,t,e),this.isWebGLCubeRenderTarget=!0;let n={width:t,height:t,depth:1},s=[n,n,n,n,n,n];this.texture=new Us(s),this._setTextureOptions(e),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(t,e){this.texture.type=e.type,this.texture.colorSpace=e.colorSpace,this.texture.generateMipmaps=e.generateMipmaps,this.texture.minFilter=e.minFilter,this.texture.magFilter=e.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var sg={[al]:"Linear",[ol]:"Reinhard",[ll]:"Cineon",[Js]:"ACESFilmic",[hl]:"AgX",[ul]:"Neutral",[cl]:"Custom"};function rg(i,t){let e=sg[t];return e===void 0?(Pt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}var oo=new L;function ag(){qt.getLuminanceCoefficients(oo);let i=oo.x.toFixed(4),t=oo.y.toFixed(4),e=oo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+d);let C=E+g+a,v=E+d+o,w=Rh(s,s.VERTEX_SHADER,C),T=Rh(s,s.FRAGMENT_SHADER,v);s.attachShader(b,w),s.attachShader(b,T),e.index0AttributeName!==void 0?s.bindAttribLocation(b,0,e.index0AttributeName):e.hasPositionAttribute===!0&&s.bindAttribLocation(b,0,"position"),s.linkProgram(b);function R(F){if(i.debug.checkShaderErrors){let B=s.getProgramInfoLog(b)||"",G=s.getShaderInfoLog(w)||"",U=s.getShaderInfoLog(T)||"",V=B.trim(),J=G.trim(),Y=U.trim(),K=!0,X=!0;if(s.getProgramParameter(b,s.LINK_STATUS)===!1)if(K=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,b,w,T);else{let tt=Ih(s,w,"vertex"),et=Ih(s,T,"fragment");Lt("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(b,s.VALIDATE_STATUS)+`
...
Program Info Log: `+V+`
`+tt+`
`+et)}else V!==""?Pt("WebGLProgram: Program Info Log:",V):(J===""||Y==="")&&(X=!1);X&&(F.diagnostics={runnable:K,programLog:V,vertexShader:{log:J,prefix:g},fragmentShader:{log:Y,prefix:d}})}s.deleteShader(w),s.deleteShader(T),x=new os(s,b),A=cg(s,b)}let x;this.getUniforms=function(){return x===void 0&&R(this),x};let A;this.getAttributes=function(){return A===void 0&&R(this),A};let I=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return I===!1&&(I=s.getProgramParameter(b,Qm)),I},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(b),this.program=void 0},this.type=e.shaderType,this.name=e.shaderName,this.id=tg++,this.cacheKey=t,this.usedTimes=1,this.program=b,this.vertexShader=w,this.fragmentShader=T,this}var wg=0,Bl=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t,e,n){let s=this._getShaderCacheForMaterial(t);return s.has(e)===!1&&(s.add(e),e.usedTimes++),s.has(n)===!1&&(s.add(n),n.usedTimes++),this}remove(t){let e=this.materialCache.get(t);for(let n of e)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(t),this}getVertexShaderStage(t){return this._getShaderStage(t.vertexShader)}getFragmentShaderStage(t){return this._getShaderStage(t.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){let e=this.materialCache,n=e.get(t);return n===void 0&&(n=new Set,e.set(t,n)),n}_getShaderStage(t){let e=this.shaderCache,n=e.get(t);return n===void 0&&(n=new kl(t),e.set(t,n)),n}},kl=class{constructor(t){this.id=wg++,this.code=t,this.usedTimes=0}};function Tg(i){return i===ei||i===nr||i===ir}function Ag(i,t,e,n,s,r){let a=new Hi,o=new Bl,l=new Set,c=[],u=new Map,m=n.logarithmicDepthBuffer,h=n.precision,f={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(x){return l.add(x),x===0?"uv":`uv${x}`}function b(x,A,I,F,B,G){let U=F.fog,V=B.geometry,J=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?F.environment:null,Y=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap,K=t.get(x.envMap||J,Y),X=K&&K.mapping===Ks?K.image.height:null,tt=f[x.type];x.precision!==null&&(h=n.getMaxPrecision(x.precision),h!==x.precision&&Pt("WebGLProgram.getParameters:",x.precision,"not supported, using",h,"instead."));let et=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,wt=et!==void 0?et.length:0,xt=0;V.morphAttributes.position!==void 0&&(xt=1),V.morphAttributes.normal!==void 0&&(xt=2),V.morphAttributes.color!==void 0&&(xt=3);let Xt,Ht,Yt,Z;if(tt){let ae=Mn[tt];Xt=ae.vertexShader,Ht=ae.fragmentShader}else{Xt=x.vertexShader,Ht=x.fragmentShader;let ae=o.getVertexShaderStage(x),Kt=o.getFragmentShaderStage(x);o.update(x,ae,Kt),Yt=ae.id,Z=Kt.id}let Q=i.getRenderTarget(),mt=i.state.buffers.depth.getReversed(),Dt=B.isInstancedMesh===!0,pt=B.isBatchedMesh===!0,Ot=!!x.map,pe=!!x.matcap,Bt=!!K,Zt=!!x.aoMap,te=!!x.lightMap,Gt=!!x.bumpMap&&x.wireframe===!1,re=!!x.normalMap,me=!!x.displacementMap,Ae=!!x.emissiveMap,le=!!x.metalnessMap,fe=!!x.roughnessMap,S=x.anisotropy>0,Mt=x.clearcoat>0,Tt=x.dispersion>0,M=x.retroreflectivity>0,p=x.iridescence>0,P=x.sheen>0,O=x.transmission>0,H=S&&!!x.anisotropyMap,it=Mt&&!!x.clearcoatMap,st=Mt&&!!x.clearcoatNormalMap,q=Mt&&!!x.clearcoatRoughnessMap,j=p&&!!x.iridescenceMap,rt=p&&!!x.iridescenceThicknessMap,At=P&&!!x.sheenColorMap,ct=P&&!!x.sheenRoughnessMap,at=!!x.specularMap,Ct=!!x.specularColorMap,It=!!x.specularIntensityMap,Ut=O&&!!x.transmissionMap,N=O&&!!x.thicknessMap,ot=!!x.gradientMap,$=!!x.alphaMap,lt=x.alphaTest>0,ft=!!x.alphaHash,nt=!!x.extensions,Rt=hn;x.toneMapped&&(Q===null||Q.isXRRenderTarget===!0)&&(Rt=i.toneMapping);let St={shaderID:tt,shaderType:x.type,shaderName:x.name,vertexShader:Xt,fragmentShader:Ht,defines:x.defines,customVertexShaderID:Yt,customFragmentShaderID:Z,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:h,batching:pt,batchingColor:pt&&B._colorsTexture!==null,instancing:Dt,instancingColor:Dt&&B.instanceColor!==null,instancingMorph:Dt&&B.morphTexture!==null,outputColorSpace:Q===null?i.outputColorSpace:Q.isXRRenderTarget===!0?Q.texture.colorSpace:qt.workingColorSpace,alphaToCoverage:!!x.alphaToCoverage,map:Ot,matcap:pe,envMap:Bt,envMapMode:Bt&&K.mapping,envMapCubeUVHeight:X,aoMap:Zt,lightMap:te,bumpMap:Gt,normalMap:re,displacementMap:me,emissiveMap:Ae,normalMapObjectSpace:re&&x.normalMapType===nh,normalMapTangentSpace:re&&x.normalMapType===io,packedNormalMap:re&&x.normalMapType===io&&Tg(x.normalMap.format),metalnessMap:le,roughnessMap:fe,anisotropy:S,anisotropyMap:H,clearcoat:Mt,clearcoatMap:it,clearcoatNormalMap:st,clearcoatRoughnessMap:q,dispersion:Tt,retroreflection:M,iridescence:p,iridescenceMap:j,iridescenceThicknessMap:rt,sheen:P,sheenColorMap:At,sheenRoughnessMap:ct,specularMap:at,specularColorMap:Ct,specularIntensityMap:It,transmission:O,transmissionMap:Ut,thicknessMap:N,gradientMap:ot,opaque:x.transparent===!1&&x.blending===ns&&x.alphaToCoverage===!1,alphaMap:$,alphaTest:lt,alphaHash:ft,combine:x.combine,mapUv:Ot&&_(x.map.channel),aoMapUv:Zt&&_(x.aoMap.channel),lightMapUv:te&&_(x.lightMap.channel),bumpMapUv:Gt&&_(x.bumpMap.channel),normalMapUv:re&&_(x.normalMap.channel),displacementMapUv:me&&_(x.displacementMap.channel),emissiveMapUv:Ae&&_(x.emissiveMap.channel),metalnessMapUv:le&&_(x.metalnessMap.channel),roughnessMapUv:fe&&_(x.roughnessMap.channel),anisotropyMapUv:H&&_(x.anisotropyMap.channel),clearcoatMapUv:it&&_(x.clearcoatMap.channel),clearcoatNormalMapUv:st&&_(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:q&&_(x.clearcoatRoughnessMap.channel),iridescenceMapUv:j&&_(x.iridescenceMap.channel),iridescenceThicknessMapUv:rt&&_(x.iridescenceThicknessMap.channel),sheenColorMapUv:At&&_(x.sheenColorMap.channel),sheenRoughnessMapUv:ct&&_(x.sheenRoughnessMap.channel),specularMapUv:at&&_(x.specularMap.channel),specularColorMapUv:Ct&&_(x.specularColorMap.channel),specularIntensityMapUv:It&&_(x.specularIntensityMap.channel),transmissionMapUv:Ut&&_(x.transmissionMap.channel),thicknessMapUv:N&&_(x.thicknessMap.channel),alphaMapUv:$&&_(x.alphaMap.channel),vertexTangents:!!V.attributes.tangent&&(re||S),vertexNormals:!!V.attributes.normal,vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,pointsUvs:B.isPoints===!0&&!!V.attributes.uv&&(Ot||$),fog:!!U,useFog:x.fog===!0,fogExp2:!!U&&U.isFogExp2,flatShading:x.wireframe===!1&&(x.flatShading===!0||V.attributes.normal===void 0&&re===!1&&(x.isMeshLambertMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isMeshPhysicalMaterial)),sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:m,reversedDepthBuffer:mt,skinning:B.isSkinnedMesh===!0,hasPositionAttribute:V.attributes.position!==void 0,morphTargets:V.morphAttributes.position!==void 0,morphNormals:V.morphAttributes.normal!==void 0,morphColors:V.morphAttributes.color!==void 0,morphTargetsCount:wt,morphTextureStride:xt,numSunLights:A.sun.length,numDirLights:A.directional.length,numPointLights:A.point.length,numSpotLights:A.spot.length,numSpotLightMaps:A.spotLightMap.length,numRectAreaLights:A.rectArea.length,numHemiLights:A.hemi.length,numSunLightShadows:A.sunShadowMap.length,numDirLightShadows:A.directionalShadowMap.length,numPointLightShadows:A.pointShadowMap.length,numSpotLightShadows:A.spotShadowMap.length,numSpotLightShadowsWithMaps:A.numSpotLightShadowsWithMaps,numLightProbes:A.numLightProbes,numLightProbeGrids:G.length,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:x.dithering,shadowMapEnabled:i.shadowMap.enabled&&I.length>0,shadowMapType:i.shadowMap.type,toneMapping:Rt,decodeVideoTexture:Ot&&x.map.isVideoTexture===!0&&qt.getTransfer(x.map.colorSpace)===jt,decodeVideoTextureEmissive:Ae&&x.emissiveMap.isVideoTexture===!0&&qt.getTransfer(x.emissiveMap.colorSpace)===jt,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===Ve,flipSided:x.side===Be,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:nt&&x.extensions.clipCullDistance===!0&&e.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(nt&&x.extensions.multiDraw===!0||pt)&&e.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:e.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return St.vertexUv1s=l.has(1),St.vertexUv2s=l.has(2),St.vertexUv3s=l.has(3),l.clear(),St}function g(x){let A=[];if(x.shaderID?A.push(x.shaderID):(A.push(x.customVertexShaderID),A.push(x.customFragmentShaderID)),x.defines!==void 0)for(let I in x.defines)A.push(I),A.push(x.defines[I]);return x.isRawShaderMaterial===!1&&(d(A,x),E(A,x),A.push(i.outputColorSpace)),A.push(x.customProgramCacheKey),A.join()}function d(x,A){x.push(A.precision),x.push(A.outputColorSpace),x.push(A.envMapMode),x.push(A.envMapCubeUVHeight),x.push(A.mapUv),x.push(A.alphaMapUv),x.push(A.lightMapUv),x.push(A.aoMapUv),x.push(A.bumpMapUv),x.push(A.normalMapUv),x.push(A.displacementMapUv),x.push(A.emissiveMapUv),x.push(A.metalnessMapUv),x.push(A.roughnessMapUv),x.push(A.anisotropyMapUv),x.push(A.clearcoatMapUv),x.push(A.clearcoatNormalMapUv),x.push(A.clearcoatRoughnessMapUv),x.push(A.iridescenceMapUv),x.push(A.iridescenceThicknessMapUv),x.push(A.sheenColorMapUv),x.push(A.sheenRoughnessMapUv),x.push(A.specularMapUv),x.push(A.specularColorMapUv),x.push(A.specularIntensityMapUv),x.push(A.transmissionMapUv),x.push(A.thicknessMapUv),x.push(A.combine),x.push(A.fogExp2),x.push(A.sizeAttenuation),x.push(A.morphTargetsCount),x.push(A.morphAttributeCount),x.push(A.numSunLights),x.push(A.numDirLights),x.push(A.numPointLights),x.push(A.numSpotLights),x.push(A.numSpotLightMaps),x.push(A.numHemiLights),x.push(A.numRectAreaLights),x.push(A.numSunLightShadows),x.push(A.numDirLightShadows),x.push(A.numPointLightShadows),x.push(A.numSpotLightShadows),x.push(A.numSpotLightShadowsWithMaps),x.push(A.numLightProbes),x.push(A.shadowMapType),x.push(A.toneMapping),x.push(A.numClippingPlanes),x.push(A.numClipIntersection),x.push(A.depthPacking)}function E(x,A){a.disableAll(),A.instancing&&a.enable(0),A.instancingColor&&a.enable(1),A.instancingMorph&&a.enable(2),A.matcap&&a.enable(3),A.envMap&&a.enable(4),A.normalMapObjectSpace&&a.enable(5),A.normalMapTangentSpace&&a.enable(6),A.clearcoat&&a.enable(7),A.iridescence&&a.enable(8),A.alphaTest&&a.enable(9),A.vertexColors&&a.enable(10),A.vertexAlphas&&a.enable(11),A.vertexUv1s&&a.enable(12),A.vertexUv2s&&a.enable(13),A.vertexUv3s&&a.enable(14),A.vertexTangents&&a.enable(15),A.anisotropy&&a.enable(16),A.alphaHash&&a.enable(17),A.batching&&a.enable(18),A.dispersion&&a.enable(19),A.retroreflection&&a.enable(24),A.batchingColor&&a.enable(20),A.gradientMap&&a.enable(21),A.packedNormalMap&&a.enable(22),A.vertexNormals&&a.enable(23),x.push(a.mask),a.disableAll(),A.fog&&a.enable(0),A.useFog&&a.enable(1),A.flatShading&&a.enable(2),A.logarithmicDepthBuffer&&a.enable(3),A.reversedDepthBuffer&&a.enable(4),A.skinning&&a.enable(5),A.morphTargets&&a.enable(6),A.morphNormals&&a.enable(7),A.morphColors&&a.enable(8),A.premultipliedAlpha&&a.enable(9),A.shadowMapEnabled&&a.enable(10),A.doubleSided&&a.enable(11),A.flipSided&&a.enable(12),A.useDepthPacking&&a.enable(13),A.dithering&&a.enable(14),A.transmission&&a.enable(15),A.sheen&&a.enable(16),A.opaque&&a.enable(17),A.pointsUvs&&a.enable(18),A.decodeVideoTexture&&a.enable(19),A.decodeVideoTextureEmissive&&a.enable(20),A.alphaToCoverage&&a.enable(21),A.numLightProbeGrids>0&&a.enable(22),A.hasPositionAttribute&&a.enable(23),x.push(a.mask)}function C(x){let A=f[x.type],I;if(A){let F=Mn[A];I=gh.clone(F.uniforms)}else I=x.uniforms;return I}function v(x,A){let I=u.get(A);return I!==void 0?++I.usedTimes:(I=new Eg(i,A,x,s),c.push(I),u.set(A,I)),I}function w(x){if(--x.usedTimes===0){let A=c.indexOf(x);c[A]=c[c.length-1],c.pop(),u.delete(x.cacheKey),x.destroy()}}function T(x){o.remove(x)}function R(){o.dispose()}return{getParameters:b,getProgramCacheKey:g,getUniforms:C,acquireProgram:v,releaseProgram:w,releaseShaderCache:T,programs:c,dispose:R}}function Cg(){let i=new WeakMap;function t(a){return i.has(a)}function e(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function s(a,o,l){i.get(a)[o]=l}function r(){i=new WeakMap}return{has:t,get:e,remove:n,update:s,dispose:r}}function Rg(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.material.id!==t.material.id?i.material.id-t.material.id:i.materialVariant!==t.materialVariant?i.materialVariant-t.materialVariant:i.z!==t.z?i.z-t.z:i.id-t.id}function Fh(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.z!==t.z?t.z-i.z:i.id-t.id}function Oh(){let i=[],t=0,e=[],n=[],s=[];function r(){t=0,e.length=0,n.length=0,s.length=0}function a(h){let f=0;return h.isInstancedMesh&&(f+=2),h.isSkinnedMesh&&(f+=1),f}function o(h,f,_,b,g,d){let E=i[t];return E===void 0?(E={id:h.id,object:h,geometry:f,material:_,materialVariant:a(h),groupOrder:b,renderOrder:h.renderOrder,z:g,group:d},i[t]=E):(E.id=h.id,E.object=h,E.geometry=f,E.material=_,E.materialVariant=a(h),E.groupOrder=b,E.renderOrder=h.renderOrder,E.z=g,E.group=d),t++,E}function l(h,f,_,b,g,d,E){E.reversedDepth===!0&&(g=-g);let C=o(h,f,_,b,g,d);_.transmission>0?n.push(C):_.transparent===!0?s.push(C):e.push(C)}function c(h,f,_,b,g,d){let E=o(h,f,_,b,g,d);_.transmission>0?n.unshift(E):_.transparent===!0?s.unshift(E):e.unshift(E)}function u(h,f){e.length>1&&e.sort(h||Rg),n.length>1&&n.sort(f||Fh),s.length>1&&s.sort(f||Fh)}function m(){for(let h=t,f=i.length;h<f;h++){let _=i[h];if(_.id===null)break;_.id=null,_.object=null,_.geometry=null,_.material=null,_.group=null}}return{opaque:e,transmissive:n,transparent:s,init:r,push:l,unshift:c,finish:m,sort:u}}function Pg(){let i=new WeakMap;function t(n,s){let r=i.get(n),a;return r===void 0?(a=new Oh,i.set(n,[a])):s>=r.length?(a=new Oh,r.push(a)):a=r[s],a}function e(){i=new WeakMap}return{get:t,dispose:e}}function Ig(){let i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"SunLight":case"DirectionalLight":e={direction:new L,color:new Ft};break;case"SpotLight":e={position:new L,direction:new L,color:new Ft,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new L,color:new Ft,distance:0,decay:0};break;case"HemisphereLight":e={direction:new L,skyColor:new Ft,groundColor:new Ft};break;case"RectAreaLight":e={color:new Ft,position:new L,halfWidth:new L,halfHeight:new L};break}return i[t.id]=e,e}}}function Lg(){let i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"SunLight":case"DirectionalLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new bt};break;case"SpotLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new bt};break;case"PointLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new bt,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[t.id]=e,e}}}var Dg=0;function Ng(i,t){return(t.castShadow?2:0)-(i.castShadow?2:0)+(t.map?1:0)-(i.map?1:0)}function Ug(i){let t=new Ig,e=Lg(),n={version:0,hash:{sunLength:-1,directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numSunShadows:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],sun:[],sunShadow:[],sunShadowMap:[],sunShadowMatrix:[],sunShadowCascade:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new L);let s=new L,r=new Qt,a=new Qt;function o(c){let u=0,m=0,h=0;for(let B=0;B<9;B++)n.probe[B].set(0,0,0);let f=0,_=0,b=0,g=0,d=0,E=0,C=0,v=0,w=0,T=0,R=0,x=0,A=0,I=0;c.sort(Ng);for(let B=0,G=c.length;B<G;B++){let U=c[B],V=U.color,J=U.intensity,Y=U.distance,K=null;if(U.shadow&&U.shadow.map&&(U.shadow.map.texture.format===ei?K=U.shadow.map.texture:K=U.shadow.map.depthTexture||U.shadow.map.texture),U.isAmbientLight)u+=V.r*J,m+=V.g*J,h+=V.b*J;else if(U.isLightProbe){for(let X=0;X<9;X++)n.probe[X].addScaledVector(U.sh.coefficients[X],J);I++}else if(U.isSunLight){let X=t.get(U);if(X.color.copy(U.color).multiplyScalar(U.intensity),U.castShadow){let tt=U.shadow,et=e.get(U);et.shadowIntensity=tt.intensity,et.shadowBias=tt.bias,et.shadowNormalBias=tt.normalBias,et.shadowRadius=tt.radius,et.shadowMapSize.copy(tt.mapSize).multiply(tt.getFrameExtents()),n.sunShadow[_]=et,n.sunShadowMap[_]=K;let wt=tt.getViewportCount();for(let xt=0;xt<wt;xt++)n.sunShadowMatrix[b+xt]=tt.getMatrix(xt),n.sunShadowCascade[b+xt]=tt._cascadeData[xt];b+=wt,_++}n.sun[f]=X,f++}else if(U.isDirectionalLight){let X=t.get(U);if(X.color.copy(U.color).multiplyScalar(U.intensity),U.castShadow){let tt=U.shadow,et=e.get(U);et.shadowIntensity=tt.intensity,et.shadowBias=tt.bias,et.shadowNormalBias=tt.normalBias,et.shadowRadius=tt.radius,et.shadowMapSize=tt.mapSize,n.directionalShadow[g]=et,n.directionalShadowMap[g]=K,n.directionalShadowMatrix[g]=U.shadow.matrix,w++}n.directional[g]=X,g++}else if(U.isSpotLight){let X=t.get(U);X.position.setFromMatrixPosition(U.matrixWorld),X.color.copy(V).multiplyScalar(J),X.distance=Y,X.coneCos=Math.cos(U.angle),X.penumbraCos=Math.cos(U.angle*(1-U.penumbra)),X.decay=U.decay,n.spot[E]=X;let tt=U.shadow;if(U.map&&(n.spotLightMap[x]=U.map,x++,tt.updateMatrices(U),U.castShadow&&A++),n.spotLightMatrix[E]=tt.matrix,U.castShadow){let et=e.get(U);et.shadowIntensity=tt.intensity,et.shadowBias=tt.bias,et.shadowNormalBias=tt.normalBias,et.shadowRadius=tt.radius,et.shadowMapSize=tt.mapSize,n.spotShadow[E]=et,n.spotShadowMap[E]=K,R++}E++}else if(U.isRectAreaLight){let X=t.get(U);X.color.copy(V).multiplyScalar(J),X.halfWidth.set(U.width*.5,0,0),X.halfHeight.set(0,U.height*.5,0),n.rectArea[C]=X,C++}else if(U.isPointLight){let X=t.get(U);if(X.color.copy(U.color).multiplyScalar(U.intensity),X.distance=U.distance,X.decay=U.decay,U.castShadow){let tt=U.shadow,et=e.get(U);et.shadowIntensity=tt.intensity,et.shadowBias=tt.bias,et.shadowNormalBias=tt.normalBias,et.shadowRadius=tt.radius,et.shadowMapSize=tt.mapSize,et.shadowCameraNear=tt.camera.near,et.shadowCameraFar=tt.camera.far,n.pointShadow[d]=et,n.pointShadowMap[d]=K,n.pointShadowMatrix[d]=U.shadow.matrix,T++}n.point[d]=X,d++}else if(U.isHemisphereLight){let X=t.get(U);X.skyColor.copy(U.color).multiplyScalar(J),X.groundColor.copy(U.groundColor).multiplyScalar(J),n.hemi[v]=X,v++}}C>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ht.LTC_FLOAT_1,n.rectAreaLTC2=ht.LTC_FLOAT_2):(n.rectAreaLTC1=ht.LTC_HALF_1,n.rectAreaLTC2=ht.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=m,n.ambient[2]=h;let F=n.hash;(F.sunLength!==f||F.directionalLength!==g||F.pointLength!==d||F.spotLength!==E||F.rectAreaLength!==C||F.hemiLength!==v||F.numSunShadows!==_||F.numDirectionalShadows!==w||F.numPointShadows!==T||F.numSpotShadows!==R||F.numSpotMaps!==x||F.numLightProbes!==I)&&(n.sun.length=f,n.directional.length=g,n.spot.length=E,n.rectArea.length=C,n.point.length=d,n.hemi.length=v,n.sunShadow.length=_,n.sunShadowMap.length=_,n.sunShadowMatrix.length=b,n.sunShadowCascade.length=b,n.directionalShadow.length=w,n.directionalShadowMap.length=w,n.directionalShadowMatrix.length=w,n.pointShadow.length=T,n.pointShadowMap.length=T,n.pointShadowMatrix.length=T,n.spotShadow.length=R,n.spotShadowMap.length=R,n.spotLightMatrix.length=R+x-A,n.spotLightMap.length=x,n.numSpotLightShadowsWithMaps=A,n.numLightProbes=I,F.sunLength=f,F.directionalLength=g,F.pointLength=d,F.spotLength=E,F.rectAreaLength=C,F.hemiLength=v,F.numSunShadows=_,F.numDirectionalShadows=w,F.numPointShadows=T,F.numSpotShadows=R,F.numSpotMaps=x,F.numLightProbes=I,n.version=Dg++)}function l(c,u){let m=0,h=0,f=0,_=0,b=0,g=0,d=u.matrixWorldInverse;for(let E=0,C=c.length;E<C;E++){let v=c[E];if(v.isSunLight){let w=n.sun[m];w.direction.setFromMatrixPosition(v.matrixWorld),w.direction.transformDirection(d),m++}else if(v.isDirectionalLight){let w=n.directional[h];w.direction.setFromMatrixPosition(v.matrixWorld),s.setFromMatrixPosition(v.target.matrixWorld),w.direction.sub(s),w.direction.transformDirection(d),h++}else if(v.isSpotLight){let w=n.spot[_];w.position.setFromMatrixPosition(v.matrixWorld),w.position.applyMatrix4(d),w.direction.setFromMatrixPosition(v.matrixWorld),s.setFromMatrixPosition(v.target.matrixWorld),w.direction.sub(s),w.direction.transformDirection(d),_++}else if(v.isRectAreaLight){let w=n.rectArea[b];w.position.setFromMatrixPosition(v.matrixWorld),w.position.applyMatrix4(d),a.identity(),r.copy(v.matrixWorld),r.premultiply(d),a.extractRotation(r),w.halfWidth.set(v.width*.5,0,0),w.halfHeight.set(0,v.height*.5,0),w.halfWidth.applyMatrix4(a),w.halfHeight.applyMatrix4(a),b++}else if(v.isPointLight){let w=n.point[f];w.position.setFromMatrixPosition(v.matrixWorld),w.position.applyMatrix4(d),f++}else if(v.isHemisphereLight){let w=n.hemi[g];w.direction.setFromMatrixPosition(v.matrixWorld),w.direction.transformDirection(d),g++}}}return{setup:o,setupView:l,state:n}}function Bh(i){let t=new Ug(i),e=[],n=[],s=[];function r(h){m.camera=h,e.length=0,n.length=0,s.length=0}function a(h){e.push(h)}function o(h){n.push(h)}function l(h){s.push(h)}function c(){t.setup(e)}function u(h){t.setupView(e,h)}let m={lightsArray:e,shadowsArray:n,lightProbeGridArray:s,camera:null,lights:t,transmissionRenderTarget:{},textureUnits:0};return{init:r,state:m,setupLights:c,setupLightsView:u,pushLight:a,pushShadow:o,pushLightProbeGrid:l}}function Fg(i){let t=new WeakMap;function e(s,r=0){let a=t.get(s),o;return a===void 0?(o=new Bh(i),t.set(s,[o])):r>=a.length?(o=new Bh(i),a.push(o)):o=a[r],o}function n(){t=new WeakMap}return{get:e,dispose:n}}var Og=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,kg=[new L(1,0,0),new L(-1,0,0),new L(0,1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1)],zg=[new L(0,-1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1),new L(0,-1,0),new L(0,-1,0)],kh=new Qt,rr=new L,Ll=new L;function Vg(i,t,e){let n=new Yi,s=new bt,r=new bt,a=new de,o=new ia,l=new sa,c={},u=e.maxTextureSize,m={[$n]:Be,[Be]:$n,[Ve]:Ve},h=new Ze({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new bt},radius:{value:4}},vertexShader:Og,fragmentShader:Bg}),f=h.clone();f.defines.HORIZONTAL_PASS=1;let _=new be;_.setAttribute("position",new ke(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let b=new _e(_,h),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Zs;let d=this.type;this.render=function(T,R,x){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||T.length===0)return;this.type===Dc&&(Pt("WebGLShadowMap: PCFSoftShadowMap has been removed. Using PCFShadowMap instead."),this.type=Zs);let A=i.getRenderTarget(),I=i.getActiveCubeFace(),F=i.getActiveMipmapLevel(),B=i.state;B.setBlending(bn),B.buffers.depth.getReversed()===!0?B.buffers.color.setClear(0,0,0,0):B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);let G=d!==this.type;G&&R.traverse(function(U){U.material&&(Array.isArray(U.material)?U.material.forEach(V=>V.needsUpdate=!0):U.material.needsUpdate=!0)});for(let U=0,V=T.length;U<V;U++){let J=T[U],Y=J.shadow;if(Y===void 0){Pt("WebGLShadowMap:",J,"has no shadow.");continue}if(Y.autoUpdate===!1&&Y.needsUpdate===!1)continue;s.copy(Y.mapSize);let K=Y.getFrameExtents();s.multiply(K),r.copy(Y.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/K.x),s.x=r.x*K.x,Y.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/K.y),s.y=r.y*K.y,Y.mapSize.y=r.y));let X=i.state.buffers.depth.getReversed();if(Y.camera._reversedDepth=X,Y.map===null||G===!0){if(Y.map!==null&&(Y.map.depthTexture!==null&&(Y.map.depthTexture.dispose(),Y.map.depthTexture=null),Y.map.dispose()),this.type===es){if(J.isPointLight){Pt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}Y.map=new ze(s.x,s.y,{format:ei,type:dn,minFilter:Pe,magFilter:Pe,generateMipmaps:!1}),Y.map.texture.name=J.name+".shadowMap",Y.map.depthTexture=new Xn(s.x,s.y,je),Y.map.depthTexture.name=J.name+".shadowMapDepth",Y.map.depthTexture.format=_n,Y.map.depthTexture.compareFunction=null,Y.map.depthTexture.minFilter=Te,Y.map.depthTexture.magFilter=Te}else J.isPointLight?(Y.map=new co(s.x),Y.map.depthTexture=new Qr(s.x,un)):(Y.map=new ze(s.x,s.y),Y.map.depthTexture=new Xn(s.x,s.y,un)),Y.map.depthTexture.name=J.name+".shadowMap",Y.map.depthTexture.format=_n,this.type===Zs?(Y.map.depthTexture.compareFunction=X?ro:so,Y.map.depthTexture.minFilter=Pe,Y.map.depthTexture.magFilter=Pe):(Y.map.depthTexture.compareFunction=null,Y.map.depthTexture.minFilter=Te,Y.map.depthTexture.magFilter=Te);Y.camera.updateProjectionMatrix()}Y.map.isWebGLCubeRenderTarget!==!0&&(Y.map.width!==s.x||Y.map.height!==s.y)&&Y.map.setSize(s.x,s.y);let tt=Y.map.isWebGLCubeRenderTarget?6:Y.getViewportCount();J.isPointLight!==!0&&Y.updateMatrices(J,x);for(let et=0;et<tt;et++){let wt=Y.getCamera(et);if(J.isPointLight){let xt=Y.camera,Xt=Y.matrix,Ht=J.distance||xt.far;Ht!==xt.far&&(xt.far=Ht,xt.updateProjectionMatrix()),rr.setFromMatrixPosition(J.matrixWorld),xt.position.copy(rr),Ll.copy(xt.position),Ll.add(kg[et]),xt.up.copy(zg[et]),xt.lookAt(Ll),xt.updateMatrixWorld(),Xt.makeTranslation(-rr.x,-rr.y,-rr.z),kh.multiplyMatrices(xt.projectionMatrix,xt.matrixWorldInverse),Y._frustum.setFromProjectionMatrix(kh,xt.coordinateSystem,xt.reversedDepth)}if(Y.map.isWebGLCubeRenderTarget)i.setRenderTarget(Y.map,et),i.clear();else{et===0&&(i.setRenderTarget(Y.map),i.clear());let xt=Y.getViewport(et);a.set(r.x*xt.x,r.y*xt.y,r.x*xt.z,r.y*xt.w),B.viewport(a)}n=Y.getFrustum(et),v(R,x,wt,J,this.type)}Y.isPointLightShadow!==!0&&this.type===es&&E(Y,x),Y.needsUpdate=!1}d=this.type,g.needsUpdate=!1,i.setRenderTarget(A,I,F)};function E(T,R){let x=t.update(b);h.defines.VSM_SAMPLES!==T.blurSamples&&(h.defines.VSM_SAMPLES=T.blurSamples,f.defines.VSM_SAMPLES=T.blurSamples,h.needsUpdate=!0,f.needsUpdate=!0),T.mapPass===null?T.mapPass=new ze(s.x,s.y,{format:ei,type:dn}):(T.mapPass.width!==T.map.width||T.mapPass.height!==T.map.height)&&T.mapPass.setSize(T.map.width,T.map.height),h.uniforms.shadow_pass.value=T.map.depthTexture,h.uniforms.resolution.value.set(T.map.width,T.map.height),h.uniforms.radius.value=T.radius,i.setRenderTarget(T.mapPass),i.clear(),i.renderBufferDirect(R,null,x,h,b,null),f.uniforms.shadow_pass.value=T.mapPass.texture,f.uniforms.resolution.value.set(T.map.width,T.map.height),f.uniforms.radius.value=T.radius,i.setRenderTarget(T.map),i.clear(),i.renderBufferDirect(R,null,x,f,b,null)}function C(T,R,x,A){let I=null,F=x.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(F!==void 0)I=F;else if(I=x.isPointLight===!0?l:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){let B=I.uuid,G=R.uuid,U=c[B];U===void 0&&(U={},c[B]=U);let V=U[G];V===void 0&&(V=I.clone(),U[G]=V,R.addEventListener("dispose",w)),I=V}if(I.visible=R.visible,I.wireframe=R.wireframe,A===es?I.side=R.shadowSide!==null?R.shadowSide:R.side:I.side=R.shadowSide!==null?R.shadowSide:m[R.side],I.alphaMap=R.alphaMap,I.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,I.map=R.map,I.clipShadows=R.clipShadows,I.clippingPlanes=R.clippingPlanes,I.clipIntersection=R.clipIntersection,I.displacementMap=R.displacementMap,I.displacementScale=R.displacementScale,I.displacementBias=R.displacementBias,I.wireframeLinewidth=R.wireframeLinewidth,I.linewidth=R.linewidth,x.isPointLight===!0&&I.isMeshDistanceMaterial===!0){let B=i.properties.get(I);B.light=x}return I}function v(T,R,x,A,I){if(T.visible===!1)return;if(T.layers.test(R.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&I===es)&&(!T.frustumCulled||T.intersectsFrustum(n))){T.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,T.matrixWorld);let G=t.update(T),U=T.material;if(Array.isArray(U)){let V=G.groups;for(let J=0,Y=V.length;J<Y;J++){let K=V[J],X=U[K.materialIndex];if(X&&X.visible){let tt=C(T,X,A,I);T.onBeforeShadow(i,T,R,x,G,tt,K),i.renderBufferDirect(x,null,G,tt,T,K),T.onAfterShadow(i,T,R,x,G,tt,K)}}}else if(U.visible){let V=C(T,U,A,I);T.onBeforeShadow(i,T,R,x,G,V,null),i.renderBufferDirect(x,null,G,V,T,null),T.onAfterShadow(i,T,R,x,G,V,null)}}let B=T.children;for(let G=0,U=B.length;G<U;G++)v(B[G],R,x,A,I)}function w(T){T.target.removeEventListener("dispose",w);for(let x in c){let A=c[x],I=T.target.uuid;I in A&&(A[I].dispose(),delete A[I])}}}function Gg(i,t){function e(){let N=!1,ot=new de,$=null,lt=new de(0,0,0,0);return{setMask:function(ft){$!==ft&&!N&&(i.colorMask(ft,ft,ft,ft),$=ft)},setLocked:function(ft){N=ft},setClear:function(ft,nt,Rt,St,ae){ae===!0&&(ft*=St,nt*=St,Rt*=St),ot.set(ft,nt,Rt,St),lt.equals(ot)===!1&&(i.clearColor(ft,nt,Rt,St),lt.copy(ot))},reset:function(){N=!1,$=null,lt.set(-1,0,0,0)}}}function n(){let N=!1,ot=!1,$=null,lt=null,ft=null;return{setReversed:function(nt){if(ot!==nt){let Rt=t.get("EXT_clip_control");nt?Rt.clipControlEXT(Rt.LOWER_LEFT_EXT,Rt.ZERO_TO_ONE_EXT):Rt.clipControlEXT(Rt.LOWER_LEFT_EXT,Rt.NEGATIVE_ONE_TO_ONE_EXT),ot=nt;let St=ft;ft=null,this.setClear(St)}},getReversed:function(){return ot},setTest:function(nt){nt?Q(i.DEPTH_TEST):mt(i.DEPTH_TEST)},setMask:function(nt){$!==nt&&!N&&(i.depthMask(nt),$=nt)},setFunc:function(nt){if(ot&&(nt=fh[nt]),lt!==nt){switch(nt){case Or:i.depthFunc(i.NEVER);break;case Br:i.depthFunc(i.ALWAYS);break;case kr:i.depthFunc(i.LESS);break;case Bi:i.depthFunc(i.LEQUAL);break;case zr:i.depthFunc(i.EQUAL);break;case Vr:i.depthFunc(i.GEQUAL);break;case Gr:i.depthFunc(i.GREATER);break;case Hr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}lt=nt}},setLocked:function(nt){N=nt},setClear:function(nt){ft!==nt&&(ft=nt,ot&&(nt=1-nt),i.clearDepth(nt))},reset:function(){N=!1,$=null,lt=null,ft=null,ot=!1}}}function s(){let N=!1,ot=null,$=null,lt=null,ft=null,nt=null,Rt=null,St=null,ae=null;return{setTest:function(Kt){N||(Kt?Q(i.STENCIL_TEST):mt(i.STENCIL_TEST))},setMask:function(Kt){ot!==Kt&&!N&&(i.stencilMask(Kt),ot=Kt)},setFunc:function(Kt,nn,fn){($!==Kt||lt!==nn||ft!==fn)&&(i.stencilFunc(Kt,nn,fn),$=Kt,lt=nn,ft=fn)},setOp:function(Kt,nn,fn){(nt!==Kt||Rt!==nn||St!==fn)&&(i.stencilOp(Kt,nn,fn),nt=Kt,Rt=nn,St=fn)},setLocked:function(Kt){N=Kt},setClear:function(Kt){ae!==Kt&&(i.clearStencil(Kt),ae=Kt)},reset:function(){N=!1,ot=null,$=null,lt=null,ft=null,nt=null,Rt=null,St=null,ae=null}}}let r=new e,a=new n,o=new s,l=new WeakMap,c=new WeakMap,u={},m={},h={},f=new WeakMap,_=[],b=null,g=!1,d=null,E=null,C=null,v=null,w=null,T=null,R=null,x=new Ft(0,0,0),A=0,I=!1,F=null,B=null,G=null,U=null,V=null,J=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),Y=!1,K=0,X=i.getParameter(i.VERSION);X.indexOf("WebGL")!==-1?(K=parseFloat(/^WebGL (\d)/.exec(X)[1]),Y=K>=1):X.indexOf("OpenGL ES")!==-1&&(K=parseFloat(/^OpenGL ES (\d)/.exec(X)[1]),Y=K>=2);let tt=null,et={},wt=i.getParameter(i.SCISSOR_BOX),xt=i.getParameter(i.VIEWPORT),Xt=new de().fromArray(wt),Ht=new de().fromArray(xt);function Yt(N,ot,$,lt){let ft=new Uint8Array(4),nt=i.createTexture();i.bindTexture(N,nt),i.texParameteri(N,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(N,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Rt=0;Rt<$;Rt++)N===i.TEXTURE_3D||N===i.TEXTURE_2D_ARRAY?i.texImage3D(ot,0,i.RGBA,1,1,lt,0,i.RGBA,i.UNSIGNED_BYTE,ft):i.texImage2D(ot+Rt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ft);return nt}let Z={};Z[i.TEXTURE_2D]=Yt(i.TEXTURE_2D,i.TEXTURE_2D,1),Z[i.TEXTURE_CUBE_MAP]=Yt(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Z[i.TEXTURE_2D_ARRAY]=Yt(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Z[i.TEXTURE_3D]=Yt(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),Q(i.DEPTH_TEST),a.setFunc(Bi),Gt(!1),re(Qo),Q(i.CULL_FACE),Zt(bn);function Q(N){u[N]!==!0&&(i.enable(N),u[N]=!0)}function mt(N){u[N]!==!1&&(i.disable(N),u[N]=!1)}function Dt(N,ot){return h[N]!==ot?(i.bindFramebuffer(N,ot),h[N]=ot,N===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=ot),N===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=ot),!0):!1}function pt(N,ot){let $=_,lt=!1;if(N){$=f.get(ot),$===void 0&&($=[],f.set(ot,$));let ft=N.textures;if($.length!==ft.length||$[0]!==i.COLOR_ATTACHMENT0){for(let nt=0,Rt=ft.length;nt<Rt;nt++)$[nt]=i.COLOR_ATTACHMENT0+nt;$.length=ft.length,lt=!0}}else $[0]!==i.BACK&&($[0]=i.BACK,lt=!0);lt&&i.drawBuffers($)}function Ot(N){return b!==N?(i.useProgram(N),b=N,!0):!1}let pe={[fi]:i.FUNC_ADD,[Uc]:i.FUNC_SUBTRACT,[Fc]:i.FUNC_REVERSE_SUBTRACT};pe[Oc]=i.MIN,pe[Bc]=i.MAX;let Bt={[kc]:i.ZERO,[zc]:i.ONE,[Vc]:i.SRC_COLOR,[il]:i.SRC_ALPHA,[Yc]:i.SRC_ALPHA_SATURATE,[Xc]:i.DST_COLOR,[Hc]:i.DST_ALPHA,[Gc]:i.ONE_MINUS_SRC_COLOR,[sl]:i.ONE_MINUS_SRC_ALPHA,[qc]:i.ONE_MINUS_DST_COLOR,[Wc]:i.ONE_MINUS_DST_ALPHA,[Zc]:i.CONSTANT_COLOR,[Jc]:i.ONE_MINUS_CONSTANT_COLOR,[Kc]:i.CONSTANT_ALPHA,[$c]:i.ONE_MINUS_CONSTANT_ALPHA};function Zt(N,ot,$,lt,ft,nt,Rt,St,ae,Kt){if(N===bn){g===!0&&(mt(i.BLEND),g=!1);return}if(g===!1&&(Q(i.BLEND),g=!0),N!==Nc){if(N!==d||Kt!==I){if((E!==fi||w!==fi)&&(i.blendEquation(i.FUNC_ADD),E=fi,w=fi),Kt)switch(N){case ns:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case tl:i.blendFunc(i.ONE,i.ONE);break;case el:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case nl:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Lt("WebGLState: Invalid blending: ",N);break}else switch(N){case ns:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case tl:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case el:Lt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case nl:Lt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Lt("WebGLState: Invalid blending: ",N);break}C=null,v=null,T=null,R=null,x.set(0,0,0),A=0,d=N,I=Kt}return}ft=ft||ot,nt=nt||$,Rt=Rt||lt,(ot!==E||ft!==w)&&(i.blendEquationSeparate(pe[ot],pe[ft]),E=ot,w=ft),($!==C||lt!==v||nt!==T||Rt!==R)&&(i.blendFuncSeparate(Bt[$],Bt[lt],Bt[nt],Bt[Rt]),C=$,v=lt,T=nt,R=Rt),(St.equals(x)===!1||ae!==A)&&(i.blendColor(St.r,St.g,St.b,ae),x.copy(St),A=ae),d=N,I=!1}function te(N,ot){N.side===Ve?mt(i.CULL_FACE):Q(i.CULL_FACE);let $=N.side===Be;ot&&($=!$),Gt($),N.blending===ns&&N.transparent===!1?Zt(bn):Zt(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),a.setFunc(N.depthFunc),a.setTest(N.depthTest),a.setMask(N.depthWrite),r.setMask(N.colorWrite);let lt=N.stencilWrite;o.setTest(lt),lt&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),Ae(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?Q(i.SAMPLE_ALPHA_TO_COVERAGE):mt(i.SAMPLE_ALPHA_TO_COVERAGE)}function Gt(N){F!==N&&(N?i.frontFace(i.CW):i.frontFace(i.CCW),F=N)}function re(N){N!==Ic?(Q(i.CULL_FACE),N!==B&&(N===Qo?i.cullFace(i.BACK):N===Lc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):mt(i.CULL_FACE),B=N}function me(N){N!==G&&(Y&&i.lineWidth(N),G=N)}function Ae(N,ot,$){N?(Q(i.POLYGON_OFFSET_FILL),(U!==ot||V!==$)&&(U=ot,V=$,a.getReversed()&&(ot=-ot),i.polygonOffset(ot,$))):mt(i.POLYGON_OFFSET_FILL)}function le(N){N?Q(i.SCISSOR_TEST):mt(i.SCISSOR_TEST)}function fe(N){N===void 0&&(N=i.TEXTURE0+J-1),tt!==N&&(i.activeTexture(N),tt=N)}function S(N,ot,$){$===void 0&&(tt===null?$=i.TEXTURE0+J-1:$=tt);let lt=et[$];lt===void 0&&(lt={type:void 0,texture:void 0},et[$]=lt),(lt.type!==N||lt.texture!==ot)&&(tt!==$&&(i.activeTexture($),tt=$),i.bindTexture(N,ot||Z[N]),lt.type=N,lt.texture=ot)}function Mt(){let N=et[tt];N!==void 0&&N.type!==void 0&&(i.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function Tt(){try{i.compressedTexImage2D(...arguments)}catch(N){Lt("WebGLState:",N)}}function M(){try{i.compressedTexImage3D(...arguments)}catch(N){Lt("WebGLState:",N)}}function p(){try{i.texSubImage2D(...arguments)}catch(N){Lt("WebGLState:",N)}}function P(){try{i.texSubImage3D(...arguments)}catch(N){Lt("WebGLState:",N)}}function O(){try{i.compressedTexSubImage2D(...arguments)}catch(N){Lt("WebGLState:",N)}}function H(){try{i.compressedTexSubImage3D(...arguments)}catch(N){Lt("WebGLState:",N)}}function it(){try{i.texStorage2D(...arguments)}catch(N){Lt("WebGLState:",N)}}function st(){try{i.texStorage3D(...arguments)}catch(N){Lt("WebGLState:",N)}}function q(){try{i.texImage2D(...arguments)}catch(N){Lt("WebGLState:",N)}}function j(){try{i.texImage3D(...arguments)}catch(N){Lt("WebGLState:",N)}}function rt(N){return m[N]!==void 0?m[N]:i.getParameter(N)}function At(N,ot){m[N]!==ot&&(i.pixelStorei(N,ot),m[N]=ot)}function ct(N){Xt.equals(N)===!1&&(i.scissor(N.x,N.y,N.z,N.w),Xt.copy(N))}function at(N){Ht.equals(N)===!1&&(i.viewport(N.x,N.y,N.z,N.w),Ht.copy(N))}function Ct(N,ot){let $=c.get(ot);$===void 0&&($=new WeakMap,c.set(ot,$));let lt=$.get(N);lt===void 0&&(lt=i.getUniformBlockIndex(ot,N.name),$.set(N,lt))}function It(N,ot){let lt=c.get(ot).get(N);l.get(ot)!==lt&&(i.uniformBlockBinding(ot,lt,N.__bindingPointIndex),l.set(ot,lt))}function Ut(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),u={},m={},tt=null,et={},h={},f=new WeakMap,_=[],b=null,g=!1,d=null,E=null,C=null,v=null,w=null,T=null,R=null,x=new Ft(0,0,0),A=0,I=!1,F=null,B=null,G=null,U=null,V=null,Xt.set(0,0,i.canvas.width,i.canvas.height),Ht.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:Q,disable:mt,bindFramebuffer:Dt,drawBuffers:pt,useProgram:Ot,setBlending:Zt,setMaterial:te,setFlipSided:Gt,setCullFace:re,setLineWidth:me,setPolygonOffset:Ae,setScissorTest:le,activeTexture:fe,bindTexture:S,unbindTexture:Mt,compressedTexImage2D:Tt,compressedTexImage3D:M,texImage2D:q,texImage3D:j,pixelStorei:At,getParameter:rt,updateUBOMapping:Ct,uniformBlockBinding:It,texStorage2D:it,texStorage3D:st,texSubImage2D:p,texSubImage3D:P,compressedTexSubImage2D:O,compressedTexSubImage3D:H,scissor:ct,viewport:at,reset:Ut}}function Hg(i,t,e,n,s,r,a){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new bt,u=new WeakMap,m=new Set,h,f=new WeakMap,_=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(M,p){return _?new OffscreenCanvas(M,p):ws("canvas")}function g(M,p,P){let O=1,H=Tt(M);if((H.width>P||H.height>P)&&(O=P/Math.max(H.width,H.height)),O<1)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap||typeof VideoFrame<"u"&&M instanceof VideoFrame){let it=Math.floor(O*H.width),st=Math.floor(O*H.height);h===void 0&&(h=b(it,st));let q=p?b(it,st):h;return q.width=it,q.height=st,q.getContext("2d").drawImage(M,0,0,it,st),Pt("WebGLRenderer: Texture has been resized from ("+H.width+"x"+H.height+") to ("+it+"x"+st+")."),q}else return"data"in M&&Pt("WebGLRenderer: Image in DataTexture is too big ("+H.width+"x"+H.height+")."),M;return M}function d(M){return M.generateMipmaps}function E(M){i.generateMipmap(M)}function C(M){return M.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:M.isWebGL3DRenderTarget?i.TEXTURE_3D:M.isWebGLArrayRenderTarget||M.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function v(M,p,P,O,H,it=!1){if(M!==null){if(i[M]!==void 0)return i[M];Pt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let st;O&&(st=t.get("EXT_texture_norm16"),st||Pt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let q=p;if(p===i.RED&&(P===i.FLOAT&&(q=i.R32F),P===i.HALF_FLOAT&&(q=i.R16F),P===i.UNSIGNED_BYTE&&(q=i.R8),P===i.UNSIGNED_SHORT&&st&&(q=st.R16_EXT),P===i.SHORT&&st&&(q=st.R16_SNORM_EXT)),p===i.RED_INTEGER&&(P===i.UNSIGNED_BYTE&&(q=i.R8UI),P===i.UNSIGNED_SHORT&&(q=i.R16UI),P===i.UNSIGNED_INT&&(q=i.R32UI),P===i.BYTE&&(q=i.R8I),P===i.SHORT&&(q=i.R16I),P===i.INT&&(q=i.R32I)),p===i.RG&&(P===i.FLOAT&&(q=i.RG32F),P===i.HALF_FLOAT&&(q=i.RG16F),P===i.UNSIGNED_BYTE&&(q=i.RG8),P===i.UNSIGNED_SHORT&&st&&(q=st.RG16_EXT),P===i.SHORT&&st&&(q=st.RG16_SNORM_EXT)),p===i.RG_INTEGER&&(P===i.UNSIGNED_BYTE&&(q=i.RG8UI),P===i.UNSIGNED_SHORT&&(q=i.RG16UI),P===i.UNSIGNED_INT&&(q=i.RG32UI),P===i.BYTE&&(q=i.RG8I),P===i.SHORT&&(q=i.RG16I),P===i.INT&&(q=i.RG32I)),p===i.RGB_INTEGER&&(P===i.UNSIGNED_BYTE&&(q=i.RGB8UI),P===i.UNSIGNED_SHORT&&(q=i.RGB16UI),P===i.UNSIGNED_INT&&(q=i.RGB32UI),P===i.BYTE&&(q=i.RGB8I),P===i.SHORT&&(q=i.RGB16I),P===i.INT&&(q=i.RGB32I)),p===i.RGBA_INTEGER&&(P===i.UNSIGNED_BYTE&&(q=i.RGBA8UI),P===i.UNSIGNED_SHORT&&(q=i.RGBA16UI),P===i.UNSIGNED_INT&&(q=i.RGBA32UI),P===i.BYTE&&(q=i.RGBA8I),P===i.SHORT&&(q=i.RGBA16I),P===i.INT&&(q=i.RGBA32I)),p===i.RGB&&(P===i.UNSIGNED_SHORT&&st&&(q=st.RGB16_EXT),P===i.SHORT&&st&&(q=st.RGB16_SNORM_EXT),P===i.UNSIGNED_INT_5_9_9_9_REV&&(q=i.RGB9_E5),P===i.UNSIGNED_INT_10F_11F_11F_REV&&(q=i.R11F_G11F_B10F)),p===i.RGBA){let j=it?Es:qt.getTransfer(H);P===i.FLOAT&&(q=i.RGBA32F),P===i.HALF_FLOAT&&(q=i.RGBA16F),P===i.UNSIGNED_BYTE&&(q=j===jt?i.SRGB8_ALPHA8:i.RGBA8),P===i.UNSIGNED_SHORT&&st&&(q=st.RGBA16_EXT),P===i.SHORT&&st&&(q=st.RGBA16_SNORM_EXT),P===i.UNSIGNED_SHORT_4_4_4_4&&(q=i.RGBA4),P===i.UNSIGNED_SHORT_5_5_5_1&&(q=i.RGB5_A1)}return(q===i.R16F||q===i.R32F||q===i.RG16F||q===i.RG32F||q===i.RGBA16F||q===i.RGBA32F)&&t.get("EXT_color_buffer_float"),q}function w(M,p){let P;return M?p===null||p===un||p===ss?P=i.DEPTH24_STENCIL8:p===je?P=i.DEPTH32F_STENCIL8:p===is&&(P=i.DEPTH24_STENCIL8,Pt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):p===null||p===un||p===ss?P=i.DEPTH_COMPONENT24:p===je?P=i.DEPTH_COMPONENT32F:p===is&&(P=i.DEPTH_COMPONENT16),P}function T(M,p){return d(M)===!0||M.isFramebufferTexture&&M.minFilter!==Te&&M.minFilter!==Pe?Math.log2(Math.max(p.width,p.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?p.mipmaps.length:1}function R(M){let p=M.target;p.removeEventListener("dispose",R),A(p),p.isVideoTexture&&u.delete(p),p.isHTMLTexture&&m.delete(p)}function x(M){let p=M.target;p.removeEventListener("dispose",x),F(p)}function A(M){let p=n.get(M);if(p.__webglInit===void 0)return;let P=M.source,O=f.get(P);if(O){let H=O[p.__cacheKey];H.usedTimes--,H.usedTimes===0&&I(M),Object.keys(O).length===0&&f.delete(P)}n.remove(M)}function I(M){let p=n.get(M);i.deleteTexture(p.__webglTexture);let P=M.source,O=f.get(P);delete O[p.__cacheKey],a.memory.textures--}function F(M){let p=n.get(M);if(M.depthTexture&&(M.depthTexture.dispose(),n.remove(M.depthTexture)),M.isWebGLCubeRenderTarget)for(let O=0;O<6;O++){if(Array.isArray(p.__webglFramebuffer[O]))for(let H=0;H<p.__webglFramebuffer[O].length;H++)i.deleteFramebuffer(p.__webglFramebuffer[O][H]);else i.deleteFramebuffer(p.__webglFramebuffer[O]);p.__webglDepthbuffer&&i.deleteRenderbuffer(p.__webglDepthbuffer[O])}else{if(Array.isArray(p.__webglFramebuffer))for(let O=0;O<p.__webglFramebuffer.length;O++)i.deleteFramebuffer(p.__webglFramebuffer[O]);else i.deleteFramebuffer(p.__webglFramebuffer);if(p.__webglDepthbuffer&&i.deleteRenderbuffer(p.__webglDepthbuffer),p.__webglMultisampledFramebuffer&&i.deleteFramebuffer(p.__webglMultisampledFramebuffer),p.__webglColorRenderbuffer)for(let O=0;O<p.__webglColorRenderbuffer.length;O++)p.__webglColorRenderbuffer[O]&&i.deleteRenderbuffer(p.__webglColorRenderbuffer[O]);p.__webglDepthRenderbuffer&&i.deleteRenderbuffer(p.__webglDepthRenderbuffer)}let P=M.textures;for(let O=0,H=P.length;O<H;O++){let it=n.get(P[O]);it.__webglTexture&&(i.deleteTexture(it.__webglTexture),a.memory.textures--),n.remove(P[O])}n.remove(M)}let B=0;function G(){B=0}function U(){return B}function V(M){B=M}function J(){let M=B;return M>=s.maxTextures&&Pt("WebGLTextures: Trying to use "+(M+1)+" texture units while this GPU supports only "+s.maxTextures),B+=1,M}function Y(M){let p=[];return p.push(M.wrapS),p.push(M.wrapT),p.push(M.wrapR||0),p.push(M.magFilter),p.push(M.minFilter),p.push(M.anisotropy),p.push(M.internalFormat),p.push(M.format),p.push(M.type),p.push(M.generateMipmaps),p.push(M.premultiplyAlpha),p.push(M.flipY),p.push(M.unpackAlignment),p.push(M.colorSpace),p.join()}function K(M,p){let P=n.get(M);if(M.isVideoTexture&&S(M),M.isRenderTargetTexture===!1&&M.isExternalTexture!==!0&&M.version>0&&P.__version!==M.version){let O=M.image;if(O===null)Pt("WebGLRenderer: Texture marked for update but no image data found.");else if(O.complete===!1)Pt("WebGLRenderer: Texture marked for update but image is incomplete");else{mt(P,M,p);return}}else M.isExternalTexture&&(P.__webglTexture=M.sourceTexture?M.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,P.__webglTexture,i.TEXTURE0+p)}function X(M,p){let P=n.get(M);if(M.isRenderTargetTexture===!1&&M.version>0&&P.__version!==M.version){mt(P,M,p);return}else M.isExternalTexture&&(P.__webglTexture=M.sourceTexture?M.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,P.__webglTexture,i.TEXTURE0+p)}function tt(M,p){let P=n.get(M);if(M.isRenderTargetTexture===!1&&M.version>0&&P.__version!==M.version){mt(P,M,p);return}e.bindTexture(i.TEXTURE_3D,P.__webglTexture,i.TEXTURE0+p)}function et(M,p){let P=n.get(M);if(M.isCubeDepthTexture!==!0&&M.version>0&&P.__version!==M.version){Dt(P,M,p);return}e.bindTexture(i.TEXTURE_CUBE_MAP,P.__webglTexture,i.TEXTURE0+p)}let wt={[Wr]:i.REPEAT,[gn]:i.CLAMP_TO_EDGE,[Xr]:i.MIRRORED_REPEAT},xt={[Te]:i.NEAREST,[th]:i.NEAREST_MIPMAP_NEAREST,[$s]:i.NEAREST_MIPMAP_LINEAR,[Pe]:i.LINEAR,[ya]:i.LINEAR_MIPMAP_NEAREST,[Qn]:i.LINEAR_MIPMAP_LINEAR},Xt={[sh]:i.NEVER,[ch]:i.ALWAYS,[rh]:i.LESS,[so]:i.LEQUAL,[ah]:i.EQUAL,[ro]:i.GEQUAL,[oh]:i.GREATER,[lh]:i.NOTEQUAL};function Ht(M,p){if(p.type===je&&t.has("OES_texture_float_linear")===!1&&(p.magFilter===Pe||p.magFilter===ya||p.magFilter===$s||p.magFilter===Qn||p.minFilter===Pe||p.minFilter===ya||p.minFilter===$s||p.minFilter===Qn)&&Pt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(M,i.TEXTURE_WRAP_S,wt[p.wrapS]),i.texParameteri(M,i.TEXTURE_WRAP_T,wt[p.wrapT]),(M===i.TEXTURE_3D||M===i.TEXTURE_2D_ARRAY)&&i.texParameteri(M,i.TEXTURE_WRAP_R,wt[p.wrapR]),i.texParameteri(M,i.TEXTURE_MAG_FILTER,xt[p.magFilter]),i.texParameteri(M,i.TEXTURE_MIN_FILTER,xt[p.minFilter]),p.compareFunction&&(i.texParameteri(M,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(M,i.TEXTURE_COMPARE_FUNC,Xt[p.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(p.magFilter===Te||p.minFilter!==$s&&p.minFilter!==Qn||p.type===je&&t.has("OES_texture_float_linear")===!1)return;if(p.anisotropy>1||n.get(p).__currentAnisotropy){let P=t.get("EXT_texture_filter_anisotropic");i.texParameterf(M,P.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(p.anisotropy,s.getMaxAnisotropy())),n.get(p).__currentAnisotropy=p.anisotropy}}}function Yt(M,p){let P=!1;M.__webglInit===void 0&&(M.__webglInit=!0,p.addEventListener("dispose",R));let O=p.source,H=f.get(O);H===void 0&&(H={},f.set(O,H));let it=Y(p);if(it!==M.__cacheKey){H[it]===void 0&&(H[it]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,P=!0),H[it].usedTimes++;let st=H[M.__cacheKey];st!==void 0&&(H[M.__cacheKey].usedTimes--,st.usedTimes===0&&I(p)),M.__cacheKey=it,M.__webglTexture=H[it].texture}return P}function Z(M,p,P){return Math.floor(Math.floor(M/P)/p)}function Q(M,p,P,O){let it=M.updateRanges;if(it.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,p.width,p.height,P,O,p.data);else{it.sort((At,ct)=>At.start-ct.start);let st=0;for(let At=1;At<it.length;At++){let ct=it[st],at=it[At],Ct=ct.start+ct.count,It=Z(at.start,p.width,4),Ut=Z(ct.start,p.width,4);at.start<=Ct+1&&It===Ut&&Z(at.start+at.count-1,p.width,4)===It?ct.count=Math.max(ct.count,at.start+at.count-ct.start):(++st,it[st]=at)}it.length=st+1;let q=e.getParameter(i.UNPACK_ROW_LENGTH),j=e.getParameter(i.UNPACK_SKIP_PIXELS),rt=e.getParameter(i.UNPACK_SKIP_ROWS);e.pixelStorei(i.UNPACK_ROW_LENGTH,p.width);for(let At=0,ct=it.length;At<ct;At++){let at=it[At],Ct=Math.floor(at.start/4),It=Math.ceil(at.count/4),Ut=Ct%p.width,N=Math.floor(Ct/p.width),ot=It,$=1;e.pixelStorei(i.UNPACK_SKIP_PIXELS,Ut),e.pixelStorei(i.UNPACK_SKIP_ROWS,N),e.texSubImage2D(i.TEXTURE_2D,0,Ut,N,ot,$,P,O,p.data)}M.clearUpdateRanges(),e.pixelStorei(i.UNPACK_ROW_LENGTH,q),e.pixelStorei(i.UNPACK_SKIP_PIXELS,j),e.pixelStorei(i.UNPACK_SKIP_ROWS,rt)}}function mt(M,p,P){let O=i.TEXTURE_2D;(p.isDataArrayTexture||p.isCompressedArrayTexture)&&(O=i.TEXTURE_2D_ARRAY),p.isData3DTexture&&(O=i.TEXTURE_3D);let H=Yt(M,p),it=p.source;e.bindTexture(O,M.__webglTexture,i.TEXTURE0+P);let st=n.get(it);if(it.version!==st.__version||H===!0){if(e.activeTexture(i.TEXTURE0+P),(typeof ImageBitmap<"u"&&p.image instanceof ImageBitmap)===!1){let $=qt.getPrimaries(qt.workingColorSpace),lt=p.colorSpace===Un?null:qt.getPrimaries(p.colorSpace),ft=p.colorSpace===Un||$===lt?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,p.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,p.premultiplyAlpha),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ft)}e.pixelStorei(i.UNPACK_ALIGNMENT,p.unpackAlignment);let j=g(p.image,!1,s.maxTextureSize);j=Mt(p,j);let rt=r.convert(p.format,p.colorSpace),At=r.convert(p.type),ct=v(p.internalFormat,rt,At,p.normalized,p.colorSpace,p.isVideoTexture);Ht(O,p);let at,Ct=p.mipmaps,It=p.isVideoTexture!==!0,Ut=st.__version===void 0||H===!0,N=it.dataReady,ot=T(p,j);if(p.isDepthTexture)ct=w(p.format===ti,p.type),Ut&&(It?e.texStorage2D(i.TEXTURE_2D,1,ct,j.width,j.height):e.texImage2D(i.TEXTURE_2D,0,ct,j.width,j.height,0,rt,At,null));else if(p.isDataTexture)if(Ct.length>0){It&&Ut&&e.texStorage2D(i.TEXTURE_2D,ot,ct,Ct[0].width,Ct[0].height);for(let $=0,lt=Ct.length;$<lt;$++)at=Ct[$],It?N&&e.texSubImage2D(i.TEXTURE_2D,$,0,0,at.width,at.height,rt,At,at.data):e.texImage2D(i.TEXTURE_2D,$,ct,at.width,at.height,0,rt,At,at.data);p.generateMipmaps=!1}else It?(Ut&&e.texStorage2D(i.TEXTURE_2D,ot,ct,j.width,j.height),N&&Q(p,j,rt,At)):e.texImage2D(i.TEXTURE_2D,0,ct,j.width,j.height,0,rt,At,j.data);else if(p.isCompressedTexture)if(p.isCompressedArrayTexture){It&&Ut&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ot,ct,Ct[0].width,Ct[0].height,j.depth);for(let $=0,lt=Ct.length;$<lt;$++)if(at=Ct[$],p.format!==Qe)if(rt!==null)if(It){if(N)if(p.layerUpdates.size>0){let ft=Tl(at.width,at.height,p.format,p.type);for(let nt of p.layerUpdates){let Rt=at.data.subarray(nt*ft/at.data.BYTES_PER_ELEMENT,(nt+1)*ft/at.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,nt,at.width,at.height,1,rt,Rt)}}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,0,at.width,at.height,j.depth,rt,at.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,$,ct,at.width,at.height,j.depth,0,at.data,0,0);else Pt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else It?N&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,0,at.width,at.height,j.depth,rt,At,at.data):e.texImage3D(i.TEXTURE_2D_ARRAY,$,ct,at.width,at.height,j.depth,0,rt,At,at.data);p.layerUpdates.size>0&&p.clearLayerUpdates()}else{It&&Ut&&e.texStorage2D(i.TEXTURE_2D,ot,ct,Ct[0].width,Ct[0].height);for(let $=0,lt=Ct.length;$<lt;$++)at=Ct[$],p.format!==Qe?rt!==null?It?N&&e.compressedTexSubImage2D(i.TEXTURE_2D,$,0,0,at.width,at.height,rt,at.data):e.compressedTexImage2D(i.TEXTURE_2D,$,ct,at.width,at.height,0,at.data):Pt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):It?N&&e.texSubImage2D(i.TEXTURE_2D,$,0,0,at.width,at.height,rt,At,at.data):e.texImage2D(i.TEXTURE_2D,$,ct,at.width,at.height,0,rt,At,at.data)}else if(p.isDataArrayTexture)if(It){if(Ut&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ot,ct,j.width,j.height,j.depth),N)if(p.layerUpdates.size>0){let $=Tl(j.width,j.height,p.format,p.type);for(let lt of p.layerUpdates){let ft=j.data.subarray(lt*$/j.data.BYTES_PER_ELEMENT,(lt+1)*$/j.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,lt,j.width,j.height,1,rt,At,ft)}p.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,j.width,j.height,j.depth,rt,At,j.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,ct,j.width,j.height,j.depth,0,rt,At,j.data);else if(p.isData3DTexture)It?(Ut&&e.texStorage3D(i.TEXTURE_3D,ot,ct,j.width,j.height,j.depth),N&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,j.width,j.height,j.depth,rt,At,j.data)):e.texImage3D(i.TEXTURE_3D,0,ct,j.width,j.height,j.depth,0,rt,At,j.data);else if(p.isFramebufferTexture){if(Ut)if(It)e.texStorage2D(i.TEXTURE_2D,ot,ct,j.width,j.height);else{let $=j.width,lt=j.height;for(let ft=0;ft<ot;ft++)e.texImage2D(i.TEXTURE_2D,ft,ct,$,lt,0,rt,At,null),$>>=1,lt>>=1}}else if(p.isHTMLTexture){if("texElementImage2D"in i){let $=i.canvas;if($.hasAttribute("layoutsubtree")||$.setAttribute("layoutsubtree","true"),j.parentNode!==$){$.appendChild(j),m.add(p),$.onpaint=lt=>{let ft=lt.changedElements;for(let nt of m)ft.includes(nt.image)&&(nt.needsUpdate=!0)},$.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,j);else{let ft=i.RGBA,nt=i.RGBA,Rt=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,ft,nt,Rt,j)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Ct.length>0){if(It&&Ut){let $=Tt(Ct[0]);e.texStorage2D(i.TEXTURE_2D,ot,ct,$.width,$.height)}for(let $=0,lt=Ct.length;$<lt;$++)at=Ct[$],It?N&&e.texSubImage2D(i.TEXTURE_2D,$,0,0,rt,At,at):e.texImage2D(i.TEXTURE_2D,$,ct,rt,At,at);p.generateMipmaps=!1}else if(It){if(Ut){let $=Tt(j);e.texStorage2D(i.TEXTURE_2D,ot,ct,$.width,$.height)}N&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,rt,At,j)}else e.texImage2D(i.TEXTURE_2D,0,ct,rt,At,j);d(p)&&E(O),st.__version=it.version,p.onUpdate&&p.onUpdate(p)}M.__version=p.version}function Dt(M,p,P){if(p.image.length!==6)return;let O=Yt(M,p),H=p.source;e.bindTexture(i.TEXTURE_CUBE_MAP,M.__webglTexture,i.TEXTURE0+P);let it=n.get(H);if(H.version!==it.__version||O===!0){e.activeTexture(i.TEXTURE0+P);let st=qt.getPrimaries(qt.workingColorSpace),q=p.colorSpace===Un?null:qt.getPrimaries(p.colorSpace),j=p.colorSpace===Un||st===q?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,p.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,p.premultiplyAlpha),e.pixelStorei(i.UNPACK_ALIGNMENT,p.unpackAlignment),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,j);let rt=p.isCompressedTexture||p.image[0].isCompressedTexture,At=p.image[0]&&p.image[0].isDataTexture,ct=[];for(let nt=0;nt<6;nt++)!rt&&!At?ct[nt]=g(p.image[nt],!0,s.maxCubemapSize):ct[nt]=At?p.image[nt].image:p.image[nt],ct[nt]=Mt(p,ct[nt]);let at=ct[0],Ct=r.convert(p.format,p.colorSpace),It=r.convert(p.type),Ut=v(p.internalFormat,Ct,It,p.normalized,p.colorSpace),N=p.isVideoTexture!==!0,ot=it.__version===void 0||O===!0,$=H.dataReady,lt=T(p,at);Ht(i.TEXTURE_CUBE_MAP,p);let ft;if(rt){N&&ot&&e.texStorage2D(i.TEXTURE_CUBE_MAP,lt,Ut,at.width,at.height);for(let nt=0;nt<6;nt++){ft=ct[nt].mipmaps;for(let Rt=0;Rt<ft.length;Rt++){let St=ft[Rt];p.format!==Qe?Ct!==null?N?$&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Rt,0,0,St.width,St.height,Ct,St.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Rt,Ut,St.width,St.height,0,St.data):Pt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?$&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Rt,0,0,St.width,St.height,Ct,It,St.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Rt,Ut,St.width,St.height,0,Ct,It,St.data)}}}else{if(ft=p.mipmaps,N&&ot){ft.length>0&&lt++;let nt=Tt(ct[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,lt,Ut,nt.width,nt.height)}for(let nt=0;nt<6;nt++)if(At){N?$&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,0,0,ct[nt].width,ct[nt].height,Ct,It,ct[nt].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,Ut,ct[nt].width,ct[nt].height,0,Ct,It,ct[nt].data);for(let Rt=0;Rt<ft.length;Rt++){let ae=ft[Rt].image[nt].image;N?$&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Rt+1,0,0,ae.width,ae.height,Ct,It,ae.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Rt+1,Ut,ae.width,ae.height,0,Ct,It,ae.data)}}else{N?$&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,0,0,Ct,It,ct[nt]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,Ut,Ct,It,ct[nt]);for(let Rt=0;Rt<ft.length;Rt++){let St=ft[Rt];N?$&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Rt+1,0,0,Ct,It,St.image[nt]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Rt+1,Ut,Ct,It,St.image[nt])}}}d(p)&&E(i.TEXTURE_CUBE_MAP),it.__version=H.version,p.onUpdate&&p.onUpdate(p)}M.__version=p.version}function pt(M,p,P,O,H,it){let st=r.convert(P.format,P.colorSpace),q=r.convert(P.type),j=v(P.internalFormat,st,q,P.normalized,P.colorSpace),rt=n.get(p),At=n.get(P);if(At.__renderTarget=p,!rt.__hasExternalTextures){let ct=Math.max(1,p.width>>it),at=Math.max(1,p.height>>it);H===i.TEXTURE_3D||H===i.TEXTURE_2D_ARRAY?e.texImage3D(H,it,j,ct,at,p.depth,0,st,q,null):e.texImage2D(H,it,j,ct,at,0,st,q,null)}e.bindFramebuffer(i.FRAMEBUFFER,M),fe(p)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,O,H,At.__webglTexture,0,le(p)):(H===i.TEXTURE_2D||H>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&H<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,O,H,At.__webglTexture,it),e.bindFramebuffer(i.FRAMEBUFFER,null)}function Ot(M,p,P){if(i.bindRenderbuffer(i.RENDERBUFFER,M),p.depthBuffer){let O=p.depthTexture,H=O&&O.isDepthTexture?O.type:null,it=w(p.stencilBuffer,H),st=p.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;fe(p)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,le(p),it,p.width,p.height):P?i.renderbufferStorageMultisample(i.RENDERBUFFER,le(p),it,p.width,p.height):i.renderbufferStorage(i.RENDERBUFFER,it,p.width,p.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,st,i.RENDERBUFFER,M)}else{let O=p.textures;for(let H=0;H<O.length;H++){let it=O[H],st=r.convert(it.format,it.colorSpace),q=r.convert(it.type),j=v(it.internalFormat,st,q,it.normalized,it.colorSpace);fe(p)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,le(p),j,p.width,p.height):P?i.renderbufferStorageMultisample(i.RENDERBUFFER,le(p),j,p.width,p.height):i.renderbufferStorage(i.RENDERBUFFER,j,p.width,p.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function pe(M,p,P){let O=p.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,M),!(p.depthTexture&&p.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let H=n.get(p.depthTexture);if(H.__renderTarget=p,(!H.__webglTexture||p.depthTexture.image.width!==p.width||p.depthTexture.image.height!==p.height)&&(p.depthTexture.image.width=p.width,p.depthTexture.image.height=p.height,p.depthTexture.needsUpdate=!0),O){if(H.__webglInit===void 0&&(H.__webglInit=!0,p.depthTexture.addEventListener("dispose",R)),H.__webglTexture===void 0){H.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,H.__webglTexture),Ht(i.TEXTURE_CUBE_MAP,p.depthTexture);let rt=r.convert(p.depthTexture.format),At=r.convert(p.depthTexture.type),ct;p.depthTexture.format===_n?ct=i.DEPTH_COMPONENT24:p.depthTexture.format===ti&&(ct=i.DEPTH24_STENCIL8);for(let at=0;at<6;at++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+at,0,ct,p.width,p.height,0,rt,At,null)}}else K(p.depthTexture,0);let it=H.__webglTexture,st=le(p),q=O?i.TEXTURE_CUBE_MAP_POSITIVE_X+P:i.TEXTURE_2D,j=p.depthTexture.format===ti?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(p.depthTexture.format===_n)fe(p)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,j,q,it,0,st):i.framebufferTexture2D(i.FRAMEBUFFER,j,q,it,0);else if(p.depthTexture.format===ti)fe(p)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,j,q,it,0,st):i.framebufferTexture2D(i.FRAMEBUFFER,j,q,it,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Bt(M){let p=n.get(M),P=M.isWebGLCubeRenderTarget===!0;if(p.__boundDepthTexture!==M.depthTexture){let O=M.depthTexture;if(p.__depthDisposeCallback&&p.__depthDisposeCallback(),O){let H=()=>{delete p.__boundDepthTexture,delete p.__depthDisposeCallback,O.removeEventListener("dispose",H)};O.addEventListener("dispose",H),p.__depthDisposeCallback=H}p.__boundDepthTexture=O}if(M.depthTexture&&!p.__autoAllocateDepthBuffer)if(P)for(let O=0;O<6;O++)pe(p.__webglFramebuffer[O],M,O);else{let O=M.texture.mipmaps;O&&O.length>0?pe(p.__webglFramebuffer[0],M,0):pe(p.__webglFramebuffer,M,0)}else if(P){p.__webglDepthbuffer=[];for(let O=0;O<6;O++)if(e.bindFramebuffer(i.FRAMEBUFFER,p.__webglFramebuffer[O]),p.__webglDepthbuffer[O]===void 0)p.__webglDepthbuffer[O]=i.createRenderbuffer(),Ot(p.__webglDepthbuffer[O],M,!1);else{let H=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,it=p.__webglDepthbuffer[O];i.bindRenderbuffer(i.RENDERBUFFER,it),i.framebufferRenderbuffer(i.FRAMEBUFFER,H,i.RENDERBUFFER,it)}}else{let O=M.texture.mipmaps;if(O&&O.length>0?e.bindFramebuffer(i.FRAMEBUFFER,p.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,p.__webglFramebuffer),p.__webglDepthbuffer===void 0)p.__webglDepthbuffer=i.createRenderbuffer(),Ot(p.__webglDepthbuffer,M,!1);else{let H=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,it=p.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,it),i.framebufferRenderbuffer(i.FRAMEBUFFER,H,i.RENDERBUFFER,it)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Zt(M,p,P){let O=n.get(M);p!==void 0&&pt(O.__webglFramebuffer,M,M.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),P!==void 0&&Bt(M)}function te(M){let p=M.texture,P=n.get(M),O=n.get(p);M.addEventListener("dispose",x);let H=M.textures,it=M.isWebGLCubeRenderTarget===!0,st=H.length>1;if(st||(O.__webglTexture===void 0&&(O.__webglTexture=i.createTexture()),O.__version=p.version,a.memory.textures++),it){P.__webglFramebuffer=[];for(let q=0;q<6;q++)if(p.mipmaps&&p.mipmaps.length>0){P.__webglFramebuffer[q]=[];for(let j=0;j<p.mipmaps.length;j++)P.__webglFramebuffer[q][j]=i.createFramebuffer()}else P.__webglFramebuffer[q]=i.createFramebuffer()}else{if(p.mipmaps&&p.mipmaps.length>0){P.__webglFramebuffer=[];for(let q=0;q<p.mipmaps.length;q++)P.__webglFramebuffer[q]=i.createFramebuffer()}else P.__webglFramebuffer=i.createFramebuffer();if(st)for(let q=0,j=H.length;q<j;q++){let rt=n.get(H[q]);rt.__webglTexture===void 0&&(rt.__webglTexture=i.createTexture(),a.memory.textures++)}if(M.samples>0&&fe(M)===!1){P.__webglMultisampledFramebuffer=i.createFramebuffer(),P.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,P.__webglMultisampledFramebuffer);for(let q=0;q<H.length;q++){let j=H[q];P.__webglColorRenderbuffer[q]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,P.__webglColorRenderbuffer[q]);let rt=r.convert(j.format,j.colorSpace),At=r.convert(j.type),ct=v(j.internalFormat,rt,At,j.normalized,j.colorSpace,M.isXRRenderTarget===!0),at=le(M);i.renderbufferStorageMultisample(i.RENDERBUFFER,at,ct,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+q,i.RENDERBUFFER,P.__webglColorRenderbuffer[q])}i.bindRenderbuffer(i.RENDERBUFFER,null),M.depthBuffer&&(P.__webglDepthRenderbuffer=i.createRenderbuffer(),Ot(P.__webglDepthRenderbuffer,M,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(it){e.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture),Ht(i.TEXTURE_CUBE_MAP,p);for(let q=0;q<6;q++)if(p.mipmaps&&p.mipmaps.length>0)for(let j=0;j<p.mipmaps.length;j++)pt(P.__webglFramebuffer[q][j],M,p,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+q,j);else pt(P.__webglFramebuffer[q],M,p,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+q,0);d(p)&&E(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(st){for(let q=0,j=H.length;q<j;q++){let rt=H[q],At=n.get(rt),ct=i.TEXTURE_2D;(M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(ct=M.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(ct,At.__webglTexture),Ht(ct,rt),pt(P.__webglFramebuffer,M,rt,i.COLOR_ATTACHMENT0+q,ct,0),d(rt)&&E(ct)}e.unbindTexture()}else{let q=i.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(q=M.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(q,O.__webglTexture),Ht(q,p),p.mipmaps&&p.mipmaps.length>0)for(let j=0;j<p.mipmaps.length;j++)pt(P.__webglFramebuffer[j],M,p,i.COLOR_ATTACHMENT0,q,j);else pt(P.__webglFramebuffer,M,p,i.COLOR_ATTACHMENT0,q,0);d(p)&&E(q),e.unbindTexture()}M.depthBuffer&&Bt(M)}function Gt(M){let p=M.textures;for(let P=0,O=p.length;P<O;P++){let H=p[P];if(d(H)){let it=C(M),st=n.get(H).__webglTexture;e.bindTexture(it,st),E(it),e.unbindTexture()}}}let re=[],me=[];function Ae(M){if(M.samples>0){if(fe(M)===!1){let p=M.textures,P=M.width,O=M.height,H=i.COLOR_BUFFER_BIT,it=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,st=n.get(M),q=p.length>1;if(q)for(let rt=0;rt<p.length;rt++)e.bindFramebuffer(i.FRAMEBUFFER,st.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+rt,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,st.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+rt,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,st.__webglMultisampledFramebuffer);let j=M.texture.mipmaps;j&&j.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,st.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,st.__webglFramebuffer);for(let rt=0;rt<p.length;rt++){if(M.resolveDepthBuffer&&(M.depthBuffer&&(H|=i.DEPTH_BUFFER_BIT),M.stencilBuffer&&M.resolveStencilBuffer&&(H|=i.STENCIL_BUFFER_BIT)),q){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,st.__webglColorRenderbuffer[rt]);let At=n.get(p[rt]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,At,0)}i.blitFramebuffer(0,0,P,O,0,0,P,O,H,i.NEAREST),l===!0&&(re.length=0,me.length=0,re.push(i.COLOR_ATTACHMENT0+rt),M.depthBuffer&&M.storeMultisampledDepthBuffer===!1&&(re.push(it),me.push(it),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,me)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,re))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),q)for(let rt=0;rt<p.length;rt++){e.bindFramebuffer(i.FRAMEBUFFER,st.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+rt,i.RENDERBUFFER,st.__webglColorRenderbuffer[rt]);let At=n.get(p[rt]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,st.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+rt,i.TEXTURE_2D,At,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,st.__webglMultisampledFramebuffer)}else if(M.depthBuffer&&M.storeMultisampledDepthBuffer===!1&&l){let p=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[p])}}}function le(M){return Math.min(s.maxSamples,M.samples)}function fe(M){let p=n.get(M);return M.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&p.__useRenderToTexture!==!1}function S(M){let p=a.render.frame;u.get(M)!==p&&(u.set(M,p),M.update())}function Mt(M,p){let P=M.colorSpace,O=M.format,H=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||P!==Ms&&P!==Un&&(qt.getTransfer(P)===jt?(O!==Qe||H!==Ge)&&Pt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Lt("WebGLTextures: Unsupported texture color space:",P)),p}function Tt(M){return typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement?(c.width=M.naturalWidth||M.width,c.height=M.naturalHeight||M.height):typeof VideoFrame<"u"&&M instanceof VideoFrame?(c.width=M.displayWidth,c.height=M.displayHeight):(c.width=M.width,c.height=M.height),c}this.allocateTextureUnit=J,this.resetTextureUnits=G,this.getTextureUnits=U,this.setTextureUnits=V,this.setTexture2D=K,this.setTexture2DArray=X,this.setTexture3D=tt,this.setTextureCube=et,this.rebindTextures=Zt,this.setupRenderTarget=te,this.updateRenderTargetMipmap=Gt,this.updateMultisampleRenderTarget=Ae,this.setupDepthRenderbuffer=Bt,this.setupFrameBufferTexture=pt,this.useMultisampledRTT=fe,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function Wg(i,t){function e(n,s=Un){let r,a=qt.getTransfer(s);if(n===Ge)return i.UNSIGNED_BYTE;if(n===ba)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Sa)return i.UNSIGNED_SHORT_5_5_5_1;if(n===ml)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===gl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===fl)return i.BYTE;if(n===pl)return i.SHORT;if(n===is)return i.UNSIGNED_SHORT;if(n===va)return i.INT;if(n===un)return i.UNSIGNED_INT;if(n===je)return i.FLOAT;if(n===dn)return i.HALF_FLOAT;if(n===_l)return i.ALPHA;if(n===xl)return i.RGB;if(n===Qe)return i.RGBA;if(n===_n)return i.DEPTH_COMPONENT;if(n===ti)return i.DEPTH_STENCIL;if(n===Ma)return i.RED;if(n===Ea)return i.RED_INTEGER;if(n===ei)return i.RG;if(n===wa)return i.RG_INTEGER;if(n===Ta)return i.RGBA_INTEGER;if(n===js||n===Qs||n===tr||n===er)if(a===jt)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===js)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Qs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===tr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===er)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===js)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Qs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===tr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===er)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Aa||n===Ca||n===Ra||n===Pa)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Aa)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ca)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ra)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Pa)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ia||n===La||n===Da||n===Na||n===Ua||n===nr||n===Fa)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Ia||n===La)return a===jt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Da)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Na)return r.COMPRESSED_R11_EAC;if(n===Ua)return r.COMPRESSED_SIGNED_R11_EAC;if(n===nr)return r.COMPRESSED_RG11_EAC;if(n===Fa)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Oa||n===Ba||n===ka||n===za||n===Va||n===Ga||n===Ha||n===Wa||n===Xa||n===qa||n===Ya||n===Za||n===Ja||n===Ka)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Oa)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ba)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ka)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===za)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Va)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ga)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ha)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Wa)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Xa)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===qa)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ya)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Za)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Ja)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Ka)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===$a||n===ja||n===Qa)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===$a)return a===jt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ja)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Qa)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===to||n===eo||n===ir||n===no)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===to)return r.COMPRESSED_RED_RGTC1_EXT;if(n===eo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ir)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===no)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ss?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}var Xg=`
void main() {
...
}`,zl=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){let n=new Fs(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(t){if(this.texture!==null&&this.mesh===null){let e=t.cameras[0].viewport,n=new Ze({vertexShader:Xg,fragmentShader:qg,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new _e(new di(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Vl=class extends cn{constructor(t,e){super();let n=this,s=null,r=1,a=null,o="local-floor",l=1,c=null,u=null,m=null,h=null,f=null,_=null,b=typeof XRWebGLBinding<"u",g=new zl,d={},E=e.getContextAttributes(),C=null,v=null,w=[],T=[],R=new bt,x=null,A=null,I=new Re;I.viewport=new de;let F=new Re;F.viewport=new de;let B=[I,F],G=new ga,U=null,V=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let Q=w[Z];return Q===void 0&&(Q=new Wi,w[Z]=Q),Q.getTargetRaySpace()},this.getControllerGrip=function(Z){let Q=w[Z];return Q===void 0&&(Q=new Wi,w[Z]=Q),Q.getGripSpace()},this.getHand=function(Z){let Q=w[Z];return Q===void 0&&(Q=new Wi,w[Z]=Q),Q.getHandSpace()};function J(Z){let Q=T.indexOf(Z.inputSource);if(Q===-1)return;let mt=w[Q];mt!==void 0&&(mt.update(Z.inputSource,Z.frame,c||a),mt.dispatchEvent({type:Z.type,data:Z.inputSource}))}function Y(){s.removeEventListener("select",J),s.removeEventListener("selectstart",J),s.removeEventListener("selectend",J),s.removeEventListener("squeeze",J),s.removeEventListener("squeezestart",J),s.removeEventListener("squeezeend",J),s.removeEventListener("end",Y),s.removeEventListener("inputsourceschange",K);for(let Z=0;Z<w.length;Z++){let Q=T[Z];Q!==null&&(T[Z]=null,w[Z].disconnect(Q))}U=null,V=null,g.reset();for(let Z in d)delete d[Z];if(t.setRenderTarget(C),f=null,h=null,m=null,s=null,v=null,Yt.stop(),n.isPresenting=!1,t.setPixelRatio(x),t.setSize(R.width,R.height,!1),A!==null){let Z=A.camera;Z.fov=A.fov,Z.zoom=A.zoom,Z.updateProjectionMatrix(),A=null}n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){r=Z,n.isPresenting===!0&&Pt("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){o=Z,n.isPresenting===!0&&Pt("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(Z){c=Z},this.getBaseLayer=function(){return h!==null?h:f},this.getBinding=function(){return m===null&&b&&(m=new XRWebGLBinding(s,e)),m},this.getFrame=function(){return _},this.getSession=function(){return s},this.setSession=async function(Z){if(s=Z,s!==null){if(C=t.getRenderTarget(),s.addEventListener("select",J),s.addEventListener("selectstart",J),s.addEventListener("selectend",J),s.addEventListener("squeeze",J),s.addEventListener("squeezestart",J),s.addEventListener("squeezeend",J),s.addEventListener("end",Y),s.addEventListener("inputsourceschange",K),E.xrCompatible!==!0&&await e.makeXRCompatible(),x=t.getPixelRatio(),t.getSize(R),b&&"createProjectionLayer"in XRWebGLBinding.prototype){let mt=null,Dt=null,pt=null;E.depth&&(pt=E.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,mt=E.stencil?ti:_n,Dt=E.stencil?ss:un);let Ot={colorFormat:e.RGBA8,depthFormat:pt,scaleFactor:r};m=this.getBinding(),h=m.createProjectionLayer(Ot),s.updateRenderState({layers:[h]}),t.setPixelRatio(1),t.setSize(h.textureWidth,h.textureHeight,!1),v=new ze(h.textureWidth,h.textureHeight,{format:Qe,type:Ge,depthTexture:new Xn(h.textureWidth,h.textureHeight,Dt,void 0,void 0,void 0,void 0,void 0,void 0,mt),stencilBuffer:E.stencil,colorSpace:t.outputColorSpace,samples:E.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1,storeMultisampledDepthBuffer:h.ignoreDepthValues===!1,storeMultisampledStencilBuffer:h.ignoreDepthValues===!1})}else{let mt={antialias:E.antialias,alpha:!0,depth:E.depth,stencil:E.stencil,framebufferScaleFactor:r};f=new XRWebGLLayer(s,e,mt),s.updateRenderState({baseLayer:f}),t.setPixelRatio(1),t.setSize(f.framebufferWidth,f.framebufferHeight,!1),v=new ze(f.framebufferWidth,f.framebufferHeight,{format:Qe,type:Ge,colorSpace:t.outputColorSpace,stencilBuffer:E.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1,storeMultisampledDepthBuffer:f.ignoreDepthValues===!1,storeMultisampledStencilBuffer:f.ignoreDepthValues===!1})}v.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),Yt.setContext(s),Yt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function K(Z){for(let Q=0;Q<Z.removed.length;Q++){let mt=Z.removed[Q],Dt=T.indexOf(mt);Dt>=0&&(T[Dt]=null,w[Dt].disconnect(mt))}for(let Q=0;Q<Z.added.length;Q++){let mt=Z.added[Q],Dt=T.indexOf(mt);if(Dt===-1){for(let Ot=0;Ot<w.length;Ot++)if(Ot>=T.length){T.push(mt),Dt=Ot;break}else if(T[Ot]===null){T[Ot]=mt,Dt=Ot;break}if(Dt===-1)break}let pt=w[Dt];pt&&pt.connect(mt)}}let X=new L,tt=new L;function et(Z,Q,mt){X.setFromMatrixPosition(Q.matrixWorld),tt.setFromMatrixPosition(mt.matrixWorld);let Dt=X.distanceTo(tt),pt=Q.projectionMatrix.elements,Ot=mt.projectionMatrix.elements,pe=pt[14]/(pt[10]-1),Bt=pt[14]/(pt[10]+1),Zt=(pt[9]+1)/pt[5],te=(pt[9]-1)/pt[5],Gt=(pt[8]-1)/pt[0],re=(Ot[8]+1)/Ot[0],me=pe*Gt,Ae=pe*re,le=Dt/(-Gt+re),fe=le*-Gt;if(Q.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(fe),Z.translateZ(le),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),pt[10]===-1)Z.projectionMatrix.copy(Q.projectionMatrix),Z.projectionMatrixInverse.copy(Q.projectionMatrixInverse);else{let S=pe+le,Mt=Bt+le,Tt=me-fe,M=Ae+(Dt-fe),p=Zt*Bt/Mt*S,P=te*Bt/Mt*S;Z.projectionMatrix.makePerspective(Tt,M,p,P,S,Mt),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function wt(Z,Q){Q===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(Q.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(s===null)return;let Q=Z.near,mt=Z.far;g.texture!==null&&(g.depthNear>0&&(Q=g.depthNear),g.depthFar>0&&(mt=g.depthFar)),G.near=F.near=I.near=Q,G.far=F.far=I.far=mt,(U!==G.near||V!==G.far)&&(s.updateRenderState({depthNear:G.near,depthFar:G.far}),U=G.near,V=G.far),G.layers.mask=Z.layers.mask|6,I.layers.mask=G.layers.mask&-5,F.layers.mask=G.layers.mask&-3;let Dt=Z.parent,pt=G.cameras;wt(G,Dt);for(let Ot=0;Ot<pt.length;Ot++)wt(pt[Ot],Dt);pt.length===2?et(G,I,F):G.projectionMatrix.copy(I.projectionMatrix),A===null&&Z.isPerspectiveCamera&&(A={camera:Z,fov:Z.fov,zoom:Z.zoom}),xt(Z,G,Dt)};function xt(Z,Q,mt){mt===null?Z.matrix.copy(Q.matrixWorld):(Z.matrix.copy(mt.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(Q.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(Q.projectionMatrix),Z.projectionMatrixInverse.copy(Q.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=Vi*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return G},this.getFoveation=function(){if(!(h===null&&f===null))return l},this.setFoveation=function(Z){l=Z,h!==null&&(h.fixedFoveation=Z),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=Z)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(G)},this.getCameraTexture=function(Z){return d[Z]};let Xt=null;function Ht(Z,Q){if(u=Q.getViewerPose(c||a),_=Q,u!==null){let mt=u.views;f!==null&&(t.setRenderTargetFramebuffer(v,f.framebuffer),t.setRenderTarget(v));let Dt=!1;mt.length!==G.cameras.length&&(G.cameras.length=0,Dt=!0);for(let Bt=0;Bt<mt.length;Bt++){let Zt=mt[Bt],te=null;if(f!==null)te=f.getViewport(Zt);else{let re=m.getViewSubImage(h,Zt);te=re.viewport,Bt===0&&(t.setRenderTargetTextures(v,re.colorTexture,re.depthStencilTexture),t.setRenderTarget(v))}let Gt=B[Bt];Gt===void 0&&(Gt=new Re,Gt.layers.enable(Bt),Gt.viewport=new de,B[Bt]=Gt),Gt.matrix.fromArray(Zt.transform.matrix),Gt.matrix.decompose(Gt.position,Gt.quaternion,Gt.scale),Gt.projectionMatrix.fromArray(Zt.projectionMatrix),Gt.projectionMatrixInverse.copy(Gt.projectionMatrix).invert(),Gt.viewport.set(te.x,te.y,te.width,te.height),Bt===0&&(G.matrix.copy(Gt.matrix),G.matrix.decompose(G.position,G.quaternion,G.scale)),Dt===!0&&G.cameras.push(Gt)}let pt=s.enabledFeatures;if(pt&&pt.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&b){m=n.getBinding();let Bt=m.getDepthInformation(mt[0]);Bt&&Bt.isValid&&Bt.texture&&g.init(Bt,s.renderState)}if(pt&&pt.includes("camera-access")&&b){t.state.unbindTexture(),m=n.getBinding();for(let Bt=0;Bt<mt.length;Bt++){let Zt=mt[Bt].camera;if(Zt){let te=d[Zt];te||(te=new Fs,d[Zt]=te);let Gt=m.getCameraImage(Zt);te.sourceTexture=Gt}}}}for(let mt=0;mt<w.length;mt++){let Dt=T[mt],pt=w[mt];Dt!==null&&pt!==void 0&&pt.update(Dt,Q,c||a)}Xt&&Xt(Z,Q),Q.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:Q}),_=null}let Yt=new zh;Yt.setAnimationLoop(Ht),this.setAnimationLoop=function(Z){Xt=Z},this.dispose=function(){}}},Yg=new Qt,qh=new Nt;qh.set(-1,0,0,0,1,0,0,0,1);function Zg(i,t){function e(g,d){g.matrixAutoUpdate===!0&&g.updateMatrix(),d.value.copy(g.matrix)}function n(g,d){d.color.getRGB(g.fogColor.value,Ml(i)),d.isFog?(g.fogNear.value=d.near,g.fogFar.value=d.far):d.isFogExp2&&(g.fogDensity.value=d.density)}function s(g,d,E,C,v){d.isNodeMaterial?d.uniformsNeedUpdate=!1:d.isMeshBasicMaterial?r(g,d):d.isMeshLambertMaterial?(r(g,d),d.envMap&&(g.envMapIntensity.value=d.envMapIntensity)):d.isMeshToonMaterial?(r(g,d),m(g,d)):d.isMeshPhongMaterial?(r(g,d),u(g,d),d.envMap&&(g.envMapIntensity.value=d.envMapIntensity)):d.isMeshStandardMaterial?(r(g,d),h(g,d),d.isMeshPhysicalMaterial&&f(g,d,v)):d.isMeshMatcapMaterial?(r(g,d),_(g,d)):d.isMeshDepthMaterial?r(g,d):d.isMeshDistanceMaterial?(r(g,d),b(g,d)):d.isMeshNormalMaterial?r(g,d):d.isLineBasicMaterial?(a(g,d),d.isLineDashedMaterial&&o(g,d)):d.isPointsMaterial?l(g,d,E,C):d.isSpriteMaterial?c(g,d):d.isShadowMaterial?(g.color.value.copy(d.color),g.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function r(g,d){g.opacity.value=d.opacity,d.color&&g.diffuse.value.copy(d.color),d.emissive&&g.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(g.map.value=d.map,e(d.map,g.mapTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,e(d.alphaMap,g.alphaMapTransform)),d.bumpMap&&(g.bumpMap.value=d.bumpMap,e(d.bumpMap,g.bumpMapTransform),g.bumpScale.value=d.bumpScale,d.side===Be&&(g.bumpScale.value*=-1)),d.normalMap&&(g.normalMap.value=d.normalMap,e(d.normalMap,g.normalMapTransform),g.normalScale.value.copy(d.normalScale),d.side===Be&&g.normalScale.value.negate()),d.displacementMap&&(g.displacementMap.value=d.displacementMap,e(d.displacementMap,g.displacementMapTransform),g.displacementScale.value=d.displacementScale,g.displacementBias.value=d.displacementBias),d.emissiveMap&&(g.emissiveMap.value=d.emissiveMap,e(d.emissiveMap,g.emissiveMapTransform)),d.specularMap&&(g.specularMap.value=d.specularMap,e(d.specularMap,g.specularMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest);let E=t.get(d),C=E.envMap,v=E.envMapRotation;C&&(g.envMap.value=C,g.envMapRotation.value.setFromMatrix4(Yg.makeRotationFromEuler(v)).transpose(),C.isCubeTexture&&C.isRenderTargetTexture===!1&&g.envMapRotation.value.premultiply(qh),g.reflectivity.value=d.reflectivity,g.ior.value=d.ior,g.refractionRatio.value=d.refractionRatio),d.lightMap&&(g.lightMap.value=d.lightMap,g.lightMapIntensity.value=d.lightMapIntensity,e(d.lightMap,g.lightMapTransform)),d.aoMap&&(g.aoMap.value=d.aoMap,g.aoMapIntensity.value=d.aoMapIntensity,e(d.aoMap,g.aoMapTransform))}function a(g,d){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,d.map&&(g.map.value=d.map,e(d.map,g.mapTransform))}function o(g,d){g.dashSize.value=d.dashSize,g.totalSize.value=d.dashSize+d.gapSize,g.scale.value=d.scale}function l(g,d,E,C){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,g.size.value=d.size*E,g.scale.value=C*.5,d.map&&(g.map.value=d.map,e(d.map,g.uvTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,e(d.alphaMap,g.alphaMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest)}function c(g,d){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,g.rotation.value=d.rotation,d.map&&(g.map.value=d.map,e(d.map,g.mapTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,e(d.alphaMap,g.alphaMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest)}function u(g,d){g.specular.value.copy(d.specular),g.shininess.value=Math.max(d.shininess,1e-4)}function m(g,d){d.gradientMap&&(g.gradientMap.value=d.gradientMap)}function h(g,d){g.metalness.value=d.metalness,d.metalnessMap&&(g.metalnessMap.value=d.metalnessMap,e(d.metalnessMap,g.metalnessMapTransform)),g.roughness.value=d.roughness,d.roughnessMap&&(g.roughnessMap.value=d.roughnessMap,e(d.roughnessMap,g.roughnessMapTransform)),d.envMap&&(g.envMapIntensity.value=d.envMapIntensity)}function f(g,d,E){g.ior.value=d.ior,d.sheen>0&&(g.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),g.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(g.sheenColorMap.value=d.sheenColorMap,e(d.sheenColorMap,g.sheenColorMapTransform)),d.sheenRoughnessMap&&(g.sheenRoughnessMap.value=d.sheenRoughnessMap,e(d.sheenRoughnessMap,g.sheenRoughnessMapTransform))),d.clearcoat>0&&(g.clearcoat.value=d.clearcoat,g.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(g.clearcoatMap.value=d.clearcoatMap,e(d.clearcoatMap,g.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,e(d.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(g.clearcoatNormalMap.value=d.clearcoatNormalMap,e(d.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Be&&g.clearcoatNormalScale.value.negate())),d.dispersion>0&&(g.dispersion.value=d.dispersion),d.retroreflectivity>0&&(g.retroreflectivity.value=d.retroreflectivity),d.iridescence>0&&(g.iridescence.value=d.iridescence,g.iridescenceIOR.value=d.iridescenceIOR,g.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(g.iridescenceMap.value=d.iridescenceMap,e(d.iridescenceMap,g.iridescenceMapTransform)),d.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=d.iridescenceThicknessMap,e(d.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),d.transmission>0&&(g.transmission.value=d.transmission,g.transmissionSamplerMap.value=E.texture,g.transmissionSamplerSize.value.set(E.width,E.height),d.transmissionMap&&(g.transmissionMap.value=d.transmissionMap,e(d.transmissionMap,g.transmissionMapTransform)),g.thickness.value=d.thickness,d.thicknessMap&&(g.thicknessMap.value=d.thicknessMap,e(d.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=d.attenuationDistance,g.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(g.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(g.anisotropyMap.value=d.anisotropyMap,e(d.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=d.specularIntensity,g.specularColor.value.copy(d.specularColor),d.specularColorMap&&(g.specularColorMap.value=d.specularColorMap,e(d.specularColorMap,g.specularColorMapTransform)),d.specularIntensityMap&&(g.specularIntensityMap.value=d.specularIntensityMap,e(d.specularIntensityMap,g.specularIntensityMapTransform))}function _(g,d){d.matcap&&(g.matcap.value=d.matcap)}function b(g,d){let E=t.get(d).light;g.referencePosition.value.setFromMatrixPosition(E.matrixWorld),g.nearDistance.value=E.shadow.camera.near,g.farDistance.value=E.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function Jg(i,t,e,n){let s={},r={},a=[],o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(v,w){let T=w.program;n.uniformBlockBinding(v,T)}function c(v,w){let T=s[v.id];T===void 0&&(g(v),T=u(v),s[v.id]=T,v.addEventListener("dispose",E));let R=w.program;n.updateUBOMapping(v,R);let x=t.render.frame;r[v.id]!==x&&(h(v),r[v.id]=x)}function u(v){let w=m();v.__bindingPointIndex=w;let T=i.createBuffer(),R=v.__size,x=v.usage;return i.bindBuffer(i.UNIFORM_BUFFER,T),i.bufferData(i.UNIFORM_BUFFER,R,x),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,w,T),T}function m(){for(let v=0;v<o;v++)if(a.indexOf(v)===-1)return a.push(v),v;return Lt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(v){let w=s[v.id],T=v.uniforms,R=v.__cache;i.bindBuffer(i.UNIFORM_BUFFER,w);for(let x=0,A=T.length;x<A;x++){let I=T[x];if(Array.isArray(I))for(let F=0,B=I.length;F<B;F++)f(I[F],x,F,R);else f(I,x,0,R)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function f(v,w,T,R){if(b(v,w,T,R)===!0){let x=v.__offset,A=v.value;if(Array.isArray(A)){let I=0;for(let F=0;F<A.length;F++){let B=A[F],G=d(B);_(B,v.__data,I),typeof B!="number"&&typeof B!="boolean"&&!B.isMatrix3&&!ArrayBuffer.isView(B)&&(I+=G.storage/Float32Array.BYTES_PER_ELEMENT)}}else _(A,v.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,x,v.__data)}}function _(v,w,T){typeof v=="number"||typeof v=="boolean"?w[0]=v:v.isMatrix3?(w[0]=v.elements[0],w[1]=v.elements[1],w[2]=v.elements[2],w[3]=0,w[4]=v.elements[3],w[5]=v.elements[4],w[6]=v.elements[5],w[7]=0,w[8]=v.elements[6],w[9]=v.elements[7],w[10]=v.elements[8],w[11]=0):ArrayBuffer.isView(v)?w.set(new v.constructor(v.buffer,v.byteOffset,w.length)):v.toArray(w,T)}function b(v,w,T,R){let x=v.value,A=w+"_"+T;if(R[A]===void 0)return typeof x=="number"||typeof x=="boolean"?R[A]=x:ArrayBuffer.isView(x)?R[A]=x.slice():R[A]=x.clone(),!0;{let I=R[A];if(typeof x=="number"||typeof x=="boolean"){if(I!==x)return R[A]=x,!0}else{if(ArrayBuffer.isView(x))return!0;if(I.equals(x)===!1)return I.copy(x),!0}}return!1}function g(v){let w=v.uniforms,T=0,R=16;for(let A=0,I=w.length;A<I;A++){let F=Array.isArray(w[A])?w[A]:[w[A]];for(let B=0,G=F.length;B<G;B++){let U=F[B],V=Array.isArray(U.value)?U.value:[U.value];for(let J=0,Y=V.length;J<Y;J++){let K=V[J],X=d(K),tt=T%R,et=tt%X.boundary,wt=tt+et;T+=et,wt!==0&&R-wt<X.storage&&(T+=R-wt),U.__data=new Float32Array(X.storage/Float32Array.BYTES_PER_ELEMENT),U.__offset=T,T+=X.storage}}}let x=T%R;return x>0&&(T+=R-x),v.__size=T,v.__cache={},this}function d(v){let w={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(w.boundary=4,w.storage=4):v.isVector2?(w.boundary=8,w.storage=8):v.isVector3||v.isColor?(w.boundary=16,w.storage=12):v.isVector4?(w.boundary=16,w.storage=16):v.isMatrix3?(w.boundary=48,w.storage=48):v.isMatrix4?(w.boundary=64,w.storage=64):v.isTexture?Pt("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(v)?(w.boundary=16,w.storage=v.byteLength):Pt("WebGLRenderer: Unsupported uniform value type.",v),w}function E(v){let w=v.target;w.removeEventListener("dispose",E);let T=a.indexOf(w.__bindingPointIndex);a.splice(T,1),i.deleteBuffer(s[w.id]),delete s[w.id],delete r[w.id]}function C(){for(let v in s)i.deleteBuffer(s[v]);a=[],s={},r={}}return{bind:l,update:c,dispose:C}}var Kg=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Sn=null;function $g(){return Sn===null&&(Sn=new Ds(Kg,16,16,ei,dn),Sn.name="DFG_LUT",Sn.minFilter=Pe,Sn.magFilter=Pe,Sn.wrapS=gn,Sn.wrapT=gn,Sn.generateMipmaps=!1,Sn.needsUpdate=!0),Sn}var ho=class{constructor(t={}){let{canvas:e=hh(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:m=!1,reversedDepthBuffer:h=!1,outputBufferType:f=Ge}=t;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=n.getContextAttributes().alpha}else _=a;let b=f,g=new Set([Ta,wa,Ea]),d=new Set([Ge,un,is,ss,ba,Sa]),E=new Uint32Array(4),C=new Int32Array(4),v=new L,w=null,T=null,R=[],x=[],A=null;this.domElement=e,this.debug={checkShaderErrors:!0,diagnostics:{keywords:!1},onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=hn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let I=this,F=!1,B=null,G=null,U=null,V=null;this._outputColorSpace=Ce;let J=0,Y=0,K=null,X=-1,tt=null,et=new de,wt=new de,xt=null,Xt=new Ft(0),Ht=0,Yt=e.width,Z=e.height,Q=1,mt=null,Dt=null,pt=new de(0,0,Yt,Z),Ot=new de(0,0,Yt,Z),pe=!1,Bt=new Yi,Zt=!1,te=!1,Gt=new Qt,re=new L,me=new de,Ae={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},le=!1;function fe(){return K===null?Q:1}let S=n;function Mt(y,D){return e.getContext(y,D)}let Tt,M,p,P,O,H,it,st,q,j,rt,At,ct,at,Ct,It,Ut,N,ot,$,lt,ft,nt;try{let y={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:m};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${"186"}`),e.addEventListener("webglcontextlost",ae,!1),e.addEventListener("webglcontextrestored",Kt,!1),e.addEventListener("webglcontextcreationerror",nn,!1),S===null){let D="webgl2";if(S=Mt(D,y),S===null)throw Mt(D)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}Rt()}catch(y){throw e.removeEventListener("webglcontextlost",ae,!1),e.removeEventListener("webglcontextrestored",Kt,!1),e.removeEventListener("webglcontextcreationerror",nn,!1),Lt("WebGLRenderer: "+y.message),y}function Rt(){Tt=new sm(S),Tt.init(),lt=new Wg(S,Tt),M=new Zp(S,Tt,t,lt),p=new Gg(S,Tt),M.reversedDepthBuffer&&h&&p.buffers.depth.setReversed(!0),G=S.createFramebuffer(),U=S.createFramebuffer(),V=S.createFramebuffer(),P=new om(S),O=new Cg,H=new Hg(S,Tt,p,O,M,lt,P),it=new im(I),st=new ld(S),ft=new qp(S,st),q=new rm(S,st,P,ft),j=new cm(S,q,st,ft,P),N=new lm(S,M,H),Ct=new Jp(O),rt=new Ag(I,it,Tt,M,ft,Ct),At=new Zg(I,O),ct=new Pg,at=new Fg(Tt),Ut=new Xp(I,it,p,j,_,l),It=new Vg(I,j,M),nt=new Jg(S,P,M,p),ot=new Yp(S,Tt,P),$=new am(S,Tt,P),P.programs=rt.programs,I.capabilities=M,I.extensions=Tt,I.properties=O,I.renderLists=ct,I.shadowMap=It,I.state=p,I.info=P}b!==Ge&&(A=new um(b,e.width,e.height,o,s,r));let St=new Vl(I,S);this.xr=St,this.getContext=function(){return S},this.getContextAttributes=function(){return S.getContextAttributes()},this.forceContextLoss=function(){let y=Tt.get("WEBGL_lose_context");y&&y.loseContext()},this.forceContextRestore=function(){let y=Tt.get("WEBGL_lose_context");y&&y.restoreContext()},this.getPixelRatio=function(){return Q},this.setPixelRatio=function(y){y!==void 0&&(Q=y,this.setSize(Yt,Z,!1))},this.getSize=function(y){return y.set(Yt,Z)},this.setSize=function(y,D,W=!0){if(St.isPresenting){Pt("WebGLRenderer: Can't change size while VR device is presenting.");return}Yt=y,Z=D,e.width=Math.floor(y*Q),e.height=Math.floor(D*Q),W===!0&&(e.style.width=y+"px",e.style.height=D+"px"),A!==null&&A.setSize(e.width,e.height),this.setViewport(0,0,y,D)},this.getDrawingBufferSize=function(y){return y.set(Yt*Q,Z*Q).floor()},this.setDrawingBufferSize=function(y,D,W){Yt=y,Z=D,Q=W,e.width=Math.floor(y*W),e.height=Math.floor(D*W),this.setViewport(0,0,y,D)},this.setEffects=function(y){if(b===Ge){Lt("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(y){for(let D=0;D<y.length;D++)if(y[D].isOutputPass===!0){Pt("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}A.setEffects(y||[])},this.getCurrentViewport=function(y){return y.copy(et)},this.getViewport=function(y){return y.copy(pt)},this.setViewport=function(y,D,W,k){y.isVector4?pt.set(y.x,y.y,y.z,y.w):pt.set(y,D,W,k),p.viewport(et.copy(pt).multiplyScalar(Q).round())},this.getScissor=function(y){return y.copy(Ot)},this.setScissor=function(y,D,W,k){y.isVector4?Ot.set(y.x,y.y,y.z,y.w):Ot.set(y,D,W,k),p.scissor(wt.copy(Ot).multiplyScalar(Q).round())},this.getScissorTest=function(){return pe},this.setScissorTest=function(y){p.setScissorTest(pe=y)},this.setOpaqueSort=function(y){mt=y},this.setTransparentSort=function(y){Dt=y},this.getClearColor=function(y){return y.copy(Ut.getClearColor())},this.setClearColor=function(){Ut.setClearColor(...arguments)},this.getClearAlpha=function(){return Ut.getClearAlpha()},this.setClearAlpha=function(){Ut.setClearAlpha(...arguments)},this.clear=function(y=!0,D=!0,W=!0){let k=0;if(y){let z=!1;if(K!==null){let dt=K.texture.format;z=g.has(dt)}if(z){let dt=K.texture.type,_t=d.has(dt),ut=Ut.getClearColor(),yt=Ut.getClearAlpha(),Et=ut.r,kt=ut.g,Wt=ut.b;_t?(E[0]=Et,E[1]=kt,E[2]=Wt,E[3]=yt,S.clearBufferuiv(S.COLOR,0,E)):(C[0]=Et,C[1]=kt,C[2]=Wt,C[3]=yt,S.clearBufferiv(S.COLOR,0,C))}else k|=S.COLOR_BUFFER_BIT}D&&(k|=S.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),W&&(k|=S.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),k!==0&&S.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(y){y.setRenderer(this),B=y},this.dispose=function(){e.removeEventListener("webglcontextlost",ae,!1),e.removeEventListener("webglcontextrestored",Kt,!1),e.removeEventListener("webglcontextcreationerror",nn,!1),Ut.dispose(),ct.dispose(),at.dispose(),O.dispose(),it.dispose(),j.dispose(),ft.dispose(),nt.dispose(),rt.dispose(),St.dispose(),St.removeEventListener("sessionstart",ql),St.removeEventListener("sessionend",Yl),ni.stop()};function ae(y){y.preventDefault(),Ts("WebGLRenderer: Context Lost."),F=!0}function Kt(){Ts("WebGLRenderer: Context Restored."),F=!1;let y=P.autoReset,D=It.enabled,W=It.autoUpdate,k=It.needsUpdate,z=It.type;Rt(),P.autoReset=y,It.enabled=D,It.autoUpdate=W,It.needsUpdate=k,It.type=z}function nn(y){Lt("WebGLRenderer: A WebGL context could not be created. Reason: ",y.statusMessage)}function fn(y){let D=y.target;D.removeEventListener("dispose",fn),tu(D)}function tu(y){eu(y),O.remove(y)}function eu(y){let D=O.get(y).programs;D!==void 0&&(D.forEach(function(W){rt.releaseProgram(W)}),y.isShaderMaterial&&rt.releaseShaderCache(y))}this.renderBufferDirect=function(y,D,W,k,z,dt){D===null&&(D=Ae);let _t=z.isMesh&&z.matrixWorld.determinantAffine()<0,ut=su(y,D,W,k,z);p.setMaterial(k,_t);let yt=W.index,Et=1;if(k.wireframe===!0){if(yt=q.getWireframeAttribute(W),yt===void 0)return;Et=2}let kt=W.drawRange,Wt=W.attributes.position,vt=kt.start*Et,$t=(kt.start+kt.count)*Et;dt!==null&&(vt=Math.max(vt,dt.start*Et),$t=Math.min($t,(dt.start+dt.count)*Et)),yt!==null?(vt=Math.max(vt,0),$t=Math.min($t,yt.count)):Wt!=null&&(vt=Math.max(vt,0),$t=Math.min($t,Wt.count));let xe=$t-vt;if(xe<0||xe===1/0)return;ft.setup(z,k,ut,W,yt);let ce,se=ot;if(yt!==null&&(ce=st.get(yt),se=$,se.setIndex(ce)),z.isMesh)k.wireframe===!0?(p.setLineWidth(k.wireframeLinewidth*fe()),se.setMode(S.LINES)):se.setMode(S.TRIANGLES);else if(z.isLine){let Le=k.linewidth;Le===void 0&&(Le=1),p.setLineWidth(Le*fe()),z.isLineSegments?se.setMode(S.LINES):z.isLineLoop?se.setMode(S.LINE_LOOP):se.setMode(S.LINE_STRIP)}else z.isPoints?se.setMode(S.POINTS):z.isSprite&&se.setMode(S.TRIANGLES);if(z.isBatchedMesh)if(Tt.get("WEBGL_multi_draw"))se.renderMultiDraw(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount);else{let Le=z._multiDrawStarts,gt=z._multiDrawCounts,Fe=z._multiDrawCount,Jt=yt?st.get(yt).bytesPerElement:1,Ke=O.get(k).currentProgram.getUniforms();for(let pn=0;pn<Fe;pn++)Ke.setValue(S,"_gl_DrawID",pn),se.render(Le[pn]/Jt,gt[pn])}else if(z.isInstancedMesh)se.renderInstances(vt,xe,z.count);else if(W.isInstancedBufferGeometry){let Le=W._maxInstanceCount!==void 0?W._maxInstanceCount:1/0,gt=Math.min(W.instanceCount,Le);se.renderInstances(vt,xe,gt)}else se.render(vt,xe)};function Xl(y,D,W,k){B!==null&&y.isNodeMaterial&&B.setObject(k,y),Zt===!0&&Ct.setState(y,W,!1),y.transparent===!0&&y.side===Ve&&y.forceSinglePass===!1?(y.side=Be,y.needsUpdate=!0,cr(y,D,k),y.side=$n,y.needsUpdate=!0,cr(y,D,k),y.side=Ve):cr(y,D,k)}this.compile=function(y,D,W=null){W===null&&(W=y),B!==null&&B.renderStart(y,D,W),T=at.get(W),T.init(D),x.push(T),W.traverseVisible(function(z){z.isLight&&z.layers.test(D.layers)&&(T.pushLight(z),z.castShadow&&T.pushShadow(z))}),y!==W&&y.traverseVisible(function(z){z.isLight&&z.layers.test(D.layers)&&(T.pushLight(z),z.castShadow&&T.pushShadow(z))}),T.setupLights(),B!==null&&B.updateLights(T.state.lightsArray),te=this.localClippingEnabled,Zt=Ct.init(this.clippingPlanes,te),Zt===!0&&Ct.setGlobalState(this.clippingPlanes,D),B!==null&&It.render(T.state.shadowsArray,W,D);let k=new Set;return y.traverse(function(z){if(!(z.isMesh||z.isPoints||z.isLine||z.isSprite))return;let dt=z.material;if(dt)if(Array.isArray(dt))for(let _t=0;_t<dt.length;_t++){let ut=dt[_t];Xl(ut,W,D,z),k.add(ut)}else Xl(dt,W,D,z),k.add(dt)}),T=x.pop(),B!==null&&B.renderEnd(),k},this.compileAsync=function(y,D,W=null){let k=this.compile(y,D,W);return new Promise(z=>{function dt(){if(k.forEach(function(_t){let yt=O.get(_t).currentProgram;(yt===void 0||yt.isReady())&&k.delete(_t)}),k.size===0){z(y);return}setTimeout(dt,10)}Tt.get("KHR_parallel_shader_compile")!==null?dt():setTimeout(dt,10)})};let xo=null;function nu(y){xo&&xo(y)}function ql(){ni.stop()}function Yl(){ni.start()}let ni=new zh;ni.setAnimationLoop(nu),typeof self<"u"&&ni.setContext(self),this.setAnimationLoop=function(y){xo=y,St.setAnimationLoop(y),y===null?ni.stop():ni.start()},St.addEventListener("sessionstart",ql),St.addEventListener("sessionend",Yl),this.render=function(y,D){if(D!==void 0&&D.isCamera!==!0){Lt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(F===!0)return;B!==null&&B.renderStart(y,D);let W=St.enabled===!0&&St.isPresenting===!0,k=A!==null&&(K===null||W)&&A.begin(I,K);if(y.matrixWorldAutoUpdate===!0&&y.updateMatrixWorld(),D.parent===null&&D.matrixWorldAutoUpdate===!0&&D.updateMatrixWorld(),St.enabled===!0&&St.isPresenting===!0&&(A===null||A.isCompositing()===!1)&&(St.cameraAutoUpdate===!0&&St.updateCamera(D),D=St.getCamera()),y.isScene===!0&&y.onBeforeRender(I,y,D,K),T=at.get(y,x.length),T.init(D),T.state.textureUnits=H.getTextureUnits(),x.push(T),Gt.multiplyMatrices(D.projectionMatrix,D.matrixWorldInverse),Bt.setFromProjectionMatrix(Gt,ln,D.reversedDepth),te=this.localClippingEnabled,Zt=Ct.init(this.clippingPlanes,te),w=ct.get(y,R.length),w.init(),R.push(w),St.enabled===!0&&St.isPresenting===!0){let _t=I.xr.getDepthSensingMesh();_t!==null&&yo(_t,D,-1/0,I.sortObjects)}yo(y,D,0,I.sortObjects),w.finish(),B!==null&&B.updateLights(T.state.lightsArray),I.sortObjects===!0&&w.sort(mt,Dt),le=St.enabled===!1||St.isPresenting===!1||St.hasDepthSensing()===!1,le&&Ut.addToRenderList(w,y),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Zt===!0&&Ct.beginShadows();let z=T.state.shadowsArray;if(It.render(z,y,D),Zt===!0&&Ct.endShadows(),(k&&A.hasRenderPass())===!1){let _t=w.opaque,ut=w.transmissive;if(T.setupLights(),D.isArrayCamera){let yt=D.cameras;if(ut.length>0)for(let Et=0,kt=yt.length;Et<kt;Et++){let Wt=yt[Et];Jl(_t,ut,y,Wt)}le&&Ut.render(y);for(let Et=0,kt=yt.length;Et<kt;Et++){let Wt=yt[Et];Zl(w,y,Wt,Wt.viewport)}}else ut.length>0&&Jl(_t,ut,y,D),le&&Ut.render(y),Zl(w,y,D)}K!==null&&Y===0&&(H.updateMultisampleRenderTarget(K),H.updateRenderTargetMipmap(K)),k&&A.end(I),y.isScene===!0&&y.onAfterRender(I,y,D),ft.resetDefaultState(),X=-1,tt=null,x.pop(),x.length>0?(T=x[x.length-1],H.setTextureUnits(T.state.textureUnits),Zt===!0&&Ct.setGlobalState(I.clippingPlanes,T.state.camera)):T=null,R.pop(),R.length>0?w=R[R.length-1]:w=null,B!==null&&B.renderEnd()};function yo(y,D,W,k){if(y.visible===!1)return;if(y.layers.test(D.layers)){if(y.isGroup)W=y.renderOrder;else if(y.isLOD)y.autoUpdate===!0&&y.update(D);else if(y.isLightProbeGrid)T.pushLightProbeGrid(y);else if(y.isLight)T.pushLight(y),y.castShadow&&T.pushShadow(y);else if(y.isSprite){if(!y.frustumCulled||y.intersectsFrustum(Bt)){k&&me.setFromMatrixPosition(y.matrixWorld).applyMatrix4(Gt);let _t=j.update(y),ut=y.material;ut.visible&&w.push(y,_t,ut,W,me.z,null,D)}}else if((y.isMesh||y.isLine||y.isPoints)&&(!y.frustumCulled||y.intersectsFrustum(Bt))){let _t=j.update(y),ut=y.material;if(k&&(y.boundingSphere!==void 0?(y.boundingSphere===null&&y.computeBoundingSphere(),me.copy(y.boundingSphere.center)):(_t.boundingSphere===null&&_t.computeBoundingSphere(),me.copy(_t.boundingSphere.center)),me.applyMatrix4(y.matrixWorld).applyMatrix4(Gt)),Array.isArray(ut)){let yt=_t.groups;for(let Et=0,kt=yt.length;Et<kt;Et++){let Wt=yt[Et],vt=ut[Wt.materialIndex];vt&&vt.visible&&w.push(y,_t,vt,W,me.z,Wt,D)}}else ut.visible&&w.push(y,_t,ut,W,me.z,null,D)}}let dt=y.children;for(let _t=0,ut=dt.length;_t<ut;_t++)yo(dt[_t],D,W,k)}function Zl(y,D,W,k){let{opaque:z,transmissive:dt,transparent:_t}=y;T.setupLightsView(W),Zt===!0&&Ct.setGlobalState(I.clippingPlanes,W),k&&p.viewport(et.copy(k)),z.length>0&&lr(z,D,W),dt.length>0&&lr(dt,D,W),_t.length>0&&lr(_t,D,W),p.buffers.depth.setTest(!0),p.buffers.depth.setMask(!0),p.buffers.color.setMask(!0),p.setPolygonOffset(!1)}function Jl(y,D,W,k){if((W.isScene===!0?W.overrideMaterial:null)!==null)return;if(T.state.transmissionRenderTarget[k.id]===void 0){let vt=Tt.has("EXT_color_buffer_half_float")||Tt.has("EXT_color_buffer_float");T.state.transmissionRenderTarget[k.id]=new ze(1,1,{generateMipmaps:!0,type:vt?dn:Ge,minFilter:Qn,samples:Math.max(4,M.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,colorSpace:qt.workingColorSpace})}let dt=T.state.transmissionRenderTarget[k.id],_t=k.viewport||et;dt.setSize(_t.z*I.transmissionResolutionScale,_t.w*I.transmissionResolutionScale);let ut=I.getRenderTarget(),yt=I.getActiveCubeFace(),Et=I.getActiveMipmapLevel();I.setRenderTarget(dt),I.getClearColor(Xt),Ht=I.getClearAlpha(),Ht<1&&I.setClearColor(16777215,.5),I.clear(),le&&Ut.render(W);let kt=I.toneMapping;I.toneMapping=hn;let Wt=k.viewport;if(k.viewport!==void 0&&(k.viewport=void 0),T.setupLightsView(k),Zt===!0&&Ct.setGlobalState(I.clippingPlanes,k),lr(y,W,k),H.updateMultisampleRenderTarget(dt),H.updateRenderTargetMipmap(dt),Tt.has("WEBGL_multisampled_render_to_texture")===!1){let vt=!1;for(let $t=0,xe=D.length;$t<xe;$t++){let ce=D[$t],{object:se,geometry:Le,material:gt,group:Fe}=ce;if(gt.side===Ve&&se.layers.test(k.layers)){let Jt=gt.side;gt.side=Be,gt.needsUpdate=!0,Kl(se,W,k,Le,gt,Fe),gt.side=Jt,gt.needsUpdate=!0,vt=!0}}vt===!0&&(H.updateMultisampleRenderTarget(dt),H.updateRenderTargetMipmap(dt))}I.setRenderTarget(ut,yt,Et),I.setClearColor(Xt,Ht),Wt!==void 0&&(k.viewport=Wt),I.toneMapping=kt}function lr(y,D,W){let k=D.isScene===!0?D.overrideMaterial:null;for(let z=0,dt=y.length;z<dt;z++){let _t=y[z],{object:ut,geometry:yt,group:Et}=_t,kt=_t.material;kt.allowOverride===!0&&k!==null&&(kt=k),ut.layers.test(W.layers)&&Kl(ut,D,W,yt,kt,Et)}}function Kl(y,D,W,k,z,dt){B!==null&&z.isNodeMaterial&&B.setObject(y,z),y.onBeforeRender(I,D,W,k,z,dt),y.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,y.matrixWorld),y.normalMatrix.getNormalMatrix(y.modelViewMatrix),z.onBeforeRender(I,D,W,k,y,dt),z.transparent===!0&&z.side===Ve&&z.forceSinglePass===!1?(z.side=Be,z.needsUpdate=!0,I.renderBufferDirect(W,D,k,z,y,dt),z.side=$n,z.needsUpdate=!0,I.renderBufferDirect(W,D,k,z,y,dt),z.side=Ve):I.renderBufferDirect(W,D,k,z,y,dt),y.onAfterRender(I,D,W,k,z,dt)}function cr(y,D,W){D.isScene!==!0&&(D=Ae);let k=O.get(y),z=T.state.lights,dt=T.state.shadowsArray,_t=z.state.version,ut=rt.getParameters(y,z.state,dt,D,W,T.state.lightProbeGridArray),yt=rt.getProgramCacheKey(ut),Et=k.programs;k.environment=y.isMeshStandardMaterial||y.isMeshLambertMaterial||y.isMeshPhongMaterial?D.environment:null,k.fog=D.fog;let kt=y.isMeshStandardMaterial||y.isMeshLambertMaterial&&!y.envMap||y.isMeshPhongMaterial&&!y.envMap;k.envMap=it.get(y.envMap||k.environment,kt),k.envMapRotation=k.environment!==null&&y.envMap===null?D.environmentRotation:y.envMapRotation,Et===void 0&&(y.addEventListener("dispose",fn),Et=new Map,k.programs=Et);let Wt=Et.get(yt);if(Wt!==void 0){if(k.currentProgram===Wt&&k.lightsStateVersion===_t)return jl(y,ut),Wt}else ut.uniforms=rt.getUniforms(y),B!==null&&y.isNodeMaterial&&B.build(y,W,ut),y.onBeforeCompile(ut,I),Wt=rt.acquireProgram(ut,yt),Et.set(yt,Wt),k.uniforms=ut.uniforms;let vt=k.uniforms;return(!y.isShaderMaterial&&!y.isRawShaderMaterial||y.clipping===!0)&&(vt.clippingPlanes=Ct.uniform),jl(y,ut),k.needsLights=au(y),k.lightsStateVersion=_t,k.needsLights&&(vt.ambientLightColor.value=z.state.ambient,vt.lightProbe.value=z.state.probe,vt.sunLights.value=z.state.sun,vt.sunLightShadows.value=z.state.sunShadow,vt.directionalLights.value=z.state.directional,vt.directionalLightShadows.value=z.state.directionalShadow,vt.spotLights.value=z.state.spot,vt.spotLightShadows.value=z.state.spotShadow,vt.rectAreaLights.value=z.state.rectArea,vt.ltc_1.value=z.state.rectAreaLTC1,vt.ltc_2.value=z.state.rectAreaLTC2,vt.pointLights.value=z.state.point,vt.pointLightShadows.value=z.state.pointShadow,vt.hemisphereLights.value=z.state.hemi,vt.sunShadowMatrix.value=z.state.sunShadowMatrix,vt.sunShadowCascade.value=z.state.sunShadowCascade,vt.directionalShadowMatrix.value=z.state.directionalShadowMatrix,vt.spotLightMatrix.value=z.state.spotLightMatrix,vt.spotLightMap.value=z.state.spotLightMap,vt.pointShadowMatrix.value=z.state.pointShadowMatrix),k.lightProbeGrid=T.state.lightProbeGridArray.length>0,k.currentProgram=Wt,k.uniformsList=null,Wt}function $l(y){if(y.uniformsList===null){let D=y.currentProgram.getUniforms();y.uniformsList=os.seqWithValue(D.seq,y.uniforms)}return y.uniformsList}function jl(y,D){let W=O.get(y);W.outputColorSpace=D.outputColorSpace,W.batching=D.batching,W.batchingColor=D.batchingColor,W.instancing=D.instancing,W.instancingColor=D.instancingColor,W.instancingMorph=D.instancingMorph,W.skinning=D.skinning,W.morphTargets=D.morphTargets,W.morphNormals=D.morphNormals,W.morphColors=D.morphColors,W.morphTargetsCount=D.morphTargetsCount,W.numClippingPlanes=D.numClippingPlanes,W.numIntersection=D.numClipIntersection,W.vertexAlphas=D.vertexAlphas,W.vertexTangents=D.vertexTangents,W.toneMapping=D.toneMapping}function iu(y,D){if(y.length===0)return null;if(y.length===1)return y[0].texture!==null?y[0]:null;v.setFromMatrixPosition(D.matrixWorld);for(let W=0,k=y.length;W<k;W++){let z=y[W];if(z.texture!==null&&z.boundingBox.containsPoint(v))return z}return null}function su(y,D,W,k,z){D.isScene!==!0&&(D=Ae),H.resetTextureUnits();let dt=D.fog,_t=k.isMeshStandardMaterial||k.isMeshLambertMaterial||k.isMeshPhongMaterial?D.environment:null,ut=K===null?I.outputColorSpace:K.isXRRenderTarget===!0?K.texture.colorSpace:qt.workingColorSpace,yt=k.isMeshStandardMaterial||k.isMeshLambertMaterial&&!k.envMap||k.isMeshPhongMaterial&&!k.envMap,Et=it.get(k.envMap||_t,yt),kt=k.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,Wt=!!W.attributes.tangent&&(!!k.normalMap||k.anisotropy>0),vt=!!W.morphAttributes.position,$t=!!W.morphAttributes.normal,xe=!!W.morphAttributes.color,ce=hn;k.toneMapped&&(K===null||K.isXRRenderTarget===!0)&&(ce=I.toneMapping);let se=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,Le=se!==void 0?se.length:0,gt=O.get(k),Fe=T.state.lights;if(Zt===!0&&(te===!0||y!==tt)){let oe=y===tt&&k.id===X;Ct.setState(k,y,oe)}let Jt=!1;k.version===gt.__version?(gt.needsLights&&gt.lightsStateVersion!==Fe.state.version||gt.outputColorSpace!==ut||z.isBatchedMesh&&gt.batching===!1||!z.isBatchedMesh&&gt.batching===!0||z.isBatchedMesh&&gt.batchingColor===!0&&z._colorsTexture===null||z.isBatchedMesh&&gt.batchingColor===!1&&z._colorsTexture!==null||z.isInstancedMesh&&gt.instancing===!1||!z.isInstancedMesh&&gt.instancing===!0||z.isSkinnedMesh&&gt.skinning===!1||!z.isSkinnedMesh&&gt.skinning===!0||z.isInstancedMesh&&gt.instancingColor===!0&&z.instanceColor===null||z.isInstancedMesh&&gt.instancingColor===!1&&z.instanceColor!==null||z.isInstancedMesh&&gt.instancingMorph===!0&&z.morphTexture===null||z.isInstancedMesh&&gt.instancingMorph===!1&&z.morphTexture!==null||gt.envMap!==Et||k.fog===!0&&gt.fog!==dt||gt.numClippingPlanes!==void 0&&(gt.numClippingPlanes!==Ct.numPlanes||gt.numIntersection!==Ct.numIntersection)||gt.vertexAlphas!==kt||gt.vertexTangents!==Wt||gt.morphTargets!==vt||gt.morphNormals!==$t||gt.morphColors!==xe||gt.toneMapping!==ce||gt.morphTargetsCount!==Le||!!gt.lightProbeGrid!=T.state.lightProbeGridArray.length>0)&&(Jt=!0):(Jt=!0,gt.__version=k.version);let Ke=gt.currentProgram;Jt===!0&&(Ke=cr(k,D,z),B&&k.isNodeMaterial&&B.onUpdateProgram(k,Ke,gt));let pn=!1,Fn=!1,_i=!1,ie=Ke.getUniforms(),ge=gt.uniforms;if(p.useProgram(Ke.program)&&(pn=!0,Fn=!0,_i=!0),k.id!==X&&(X=k.id,Fn=!0),gt.needsLights){let oe=iu(T.state.lightProbeGridArray,z);gt.lightProbeGrid!==oe&&(gt.lightProbeGrid=oe,Fn=!0)}if(pn||tt!==y){p.buffers.depth.getReversed()&&y.reversedDepth!==!0&&(y._reversedDepth=!0,y.updateProjectionMatrix()),ie.setValue(S,"projectionMatrix",y.projectionMatrix),ie.setValue(S,"viewMatrix",y.matrixWorldInverse);let Bn=ie.map.cameraPosition;Bn!==void 0&&Bn.setValue(S,re.setFromMatrixPosition(y.matrixWorld)),M.logarithmicDepthBuffer&&ie.setValue(S,"logDepthBufFC",2/(Math.log(y.far+1)/Math.LN2)),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&ie.setValue(S,"isOrthographic",y.isOrthographicCamera===!0),tt!==y&&(tt=y,Fn=!0,_i=!0)}if(gt.needsLights&&(Fe.state.sunShadowMap.length>0&&ie.setValue(S,"sunShadowMap",Fe.state.sunShadowMap,H),Fe.state.directionalShadowMap.length>0&&ie.setValue(S,"directionalShadowMap",Fe.state.directionalShadowMap,H),Fe.state.spotShadowMap.length>0&&ie.setValue(S,"spotShadowMap",Fe.state.spotShadowMap,H),Fe.state.pointShadowMap.length>0&&ie.setValue(S,"pointShadowMap",Fe.state.pointShadowMap,H)),z.isSkinnedMesh){ie.setOptional(S,z,"bindMatrix"),ie.setOptional(S,z,"bindMatrixInverse");let oe=z.skeleton;oe&&(oe.boneTexture===null&&oe.computeBoneTexture(),ie.setValue(S,"boneTexture",oe.boneTexture,H))}z.isBatchedMesh&&(ie.setOptional(S,z,"batchingTexture"),ie.setValue(S,"batchingTexture",z._matricesTexture,H),ie.setOptional(S,z,"batchingIdTexture"),ie.setValue(S,"batchingIdTexture",z._indirectTexture,H),ie.setOptional(S,z,"batchingColorTexture"),z._colorsTexture!==null&&ie.setValue(S,"batchingColorTexture",z._colorsTexture,H));let On=W.morphAttributes;if((On.position!==void 0||On.normal!==void 0||On.color!==void 0)&&N.update(z,W,Ke),(Fn||gt.receiveShadow!==z.receiveShadow)&&(gt.receiveShadow=z.receiveShadow,ie.setValue(S,"receiveShadow",z.receiveShadow)),(k.isMeshStandardMaterial||k.isMeshLambertMaterial||k.isMeshPhongMaterial)&&k.envMap===null&&D.environment!==null&&(ge.envMapIntensity.value=D.environmentIntensity),ge.dfgLUT!==void 0&&(ge.dfgLUT.value=$g()),Fn){if(ie.setValue(S,"toneMappingExposure",I.toneMappingExposure),gt.needsLights&&ru(ge,_i),dt&&k.fog===!0&&At.refreshFogUniforms(ge,dt),At.refreshMaterialUniforms(ge,k,Q,Z,T.state.transmissionRenderTarget[y.id]),gt.needsLights&&gt.lightProbeGrid){let oe=gt.lightProbeGrid;ge.probesSH.value=oe.texture,ge.probesMin.value.copy(oe.boundingBox.min),ge.probesMax.value.copy(oe.boundingBox.max),ge.probesResolution.value.copy(oe.resolution)}os.upload(S,$l(gt),ge,H)}if(k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(os.upload(S,$l(gt),ge,H),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&ie.setValue(S,"center",z.center),ie.setValue(S,"modelViewMatrix",z.modelViewMatrix),ie.setValue(S,"normalMatrix",z.normalMatrix),ie.setValue(S,"modelMatrix",z.matrixWorld),k.uniformsGroups!==void 0){let oe=k.uniformsGroups;for(let Bn=0,xi=oe.length;Bn<xi;Bn++){let tc=oe[Bn];nt.update(tc,Ke),nt.bind(tc,Ke)}}return Ke}function ru(y,D){y.ambientLightColor.needsUpdate=D,y.lightProbe.needsUpdate=D,y.sunLights.needsUpdate=D,y.sunLightShadows.needsUpdate=D,y.directionalLights.needsUpdate=D,y.directionalLightShadows.needsUpdate=D,y.pointLights.needsUpdate=D,y.pointLightShadows.needsUpdate=D,y.spotLights.needsUpdate=D,y.spotLightShadows.needsUpdate=D,y.rectAreaLights.needsUpdate=D,y.hemisphereLights.needsUpdate=D}function au(y){return y.isMeshLambertMaterial||y.isMeshToonMaterial||y.isMeshPhongMaterial||y.isMeshStandardMaterial||y.isShadowMaterial||y.isShaderMaterial&&y.lights===!0}this.getActiveCubeFace=function(){return J},this.getActiveMipmapLevel=function(){return Y},this.getRenderTarget=function(){return K},this.setRenderTargetTextures=function(y,D,W){let k=O.get(y);k.__autoAllocateDepthBuffer=y.resolveDepthBuffer===!1,k.__autoAllocateDepthBuffer===!1&&(k.__useRenderToTexture=!1),O.get(y.texture).__webglTexture=D,O.get(y.depthTexture).__webglTexture=k.__autoAllocateDepthBuffer?void 0:W,k.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(y,D){let W=O.get(y);W.__webglFramebuffer=D,W.__useDefaultFramebuffer=D===void 0},this.setRenderTarget=function(y,D=0,W=0){K=y,J=D,Y=W;let k=null,z=!1,dt=!1;if(y){let ut=O.get(y);if(ut.__useDefaultFramebuffer!==void 0){p.bindFramebuffer(S.FRAMEBUFFER,ut.__webglFramebuffer),et.copy(y.viewport),wt.copy(y.scissor),xt=y.scissorTest,p.viewport(et),p.scissor(wt),p.setScissorTest(xt),X=-1;return}else if(ut.__webglFramebuffer===void 0)H.setupRenderTarget(y);else if(ut.__hasExternalTextures)H.rebindTextures(y,O.get(y.texture).__webglTexture,O.get(y.depthTexture).__webglTexture);else if(y.depthBuffer){let kt=y.depthTexture;if(ut.__boundDepthTexture!==kt){if(kt!==null&&O.has(kt)&&(y.width!==kt.image.width||y.height!==kt.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");H.setupDepthRenderbuffer(y)}}let yt=y.texture;(yt.isData3DTexture||yt.isDataArrayTexture||yt.isCompressedArrayTexture)&&(dt=!0);let Et=O.get(y).__webglFramebuffer;y.isWebGLCubeRenderTarget?(Array.isArray(Et[D])?k=Et[D][W]:k=Et[D],z=!0):y.samples>0&&H.useMultisampledRTT(y)===!1?k=O.get(y).__webglMultisampledFramebuffer:Array.isArray(Et)?k=Et[W]:k=Et,et.copy(y.viewport),wt.copy(y.scissor),xt=y.scissorTest}else et.copy(pt).multiplyScalar(Q).floor(),wt.copy(Ot).multiplyScalar(Q).floor(),xt=pe;if(W!==0&&(k=G),p.bindFramebuffer(S.FRAMEBUFFER,k)&&p.drawBuffers(y,k),p.viewport(et),p.scissor(wt),p.setScissorTest(xt),z){let ut=O.get(y.texture);S.framebufferTexture2D(S.FRAMEBUFFER,S.COLOR_ATTACHMENT0,S.TEXTURE_CUBE_MAP_POSITIVE_X+D,ut.__webglTexture,W)}else if(dt){let ut=D;for(let yt=0;yt<y.textures.length;yt++){let Et=O.get(y.textures[yt]);S.framebufferTextureLayer(S.FRAMEBUFFER,S.COLOR_ATTACHMENT0+yt,Et.__webglTexture,W,ut)}}else if(y!==null&&W!==0){let ut=O.get(y.texture);S.framebufferTexture2D(S.FRAMEBUFFER,S.COLOR_ATTACHMENT0,S.TEXTURE_2D,ut.__webglTexture,W)}X=-1};function Ql(y){let D=O.get(y);return(D.__readFormat!==y.format||D.__readType!==y.type)&&(D.__readFormat=y.format,D.__readType=y.type,D.__formatReadable=M.textureFormatReadable(y.format),D.__typeReadable=M.textureTypeReadable(y.type)),D}this.readRenderTargetPixels=function(y,D,W,k,z,dt,_t,ut=0){if(!(y&&y.isWebGLRenderTarget)){Lt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let yt=O.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&_t!==void 0&&(yt=yt[_t]),yt){p.bindFramebuffer(S.FRAMEBUFFER,yt);try{let Et=y.textures[ut],kt=Et.format,Wt=Et.type;y.textures.length>1&&S.readBuffer(S.COLOR_ATTACHMENT0+ut);let vt=Ql(Et);if(vt.__formatReadable===!1){Lt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(vt.__typeReadable===!1){Lt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}D>=0&&D<=y.width-k&&W>=0&&W<=y.height-z&&S.readPixels(D,W,k,z,lt.convert(kt),lt.convert(Wt),dt)}finally{let Et=K!==null?O.get(K).__webglFramebuffer:null;p.bindFramebuffer(S.FRAMEBUFFER,Et)}}},this.readRenderTargetPixelsAsync=async function(y,D,W,k,z,dt,_t,ut=0){if(!(y&&y.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let yt=O.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&_t!==void 0&&(yt=yt[_t]),yt)if(D>=0&&D<=y.width-k&&W>=0&&W<=y.height-z){p.bindFramebuffer(S.FRAMEBUFFER,yt);let Et=y.textures[ut],kt=Et.format,Wt=Et.type;y.textures.length>1&&S.readBuffer(S.COLOR_ATTACHMENT0+ut);let vt=Ql(Et);if(vt.__formatReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(vt.__typeReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let $t=S.createBuffer();S.bindBuffer(S.PIXEL_PACK_BUFFER,$t),S.bufferData(S.PIXEL_PACK_BUFFER,dt.byteLength,S.STREAM_READ),S.readPixels(D,W,k,z,lt.convert(kt),lt.convert(Wt),0),S.bindBuffer(S.PIXEL_PACK_BUFFER,null);let xe=K!==null?O.get(K).__webglFramebuffer:null;p.bindFramebuffer(S.FRAMEBUFFER,xe);let ce=S.fenceSync(S.SYNC_GPU_COMMANDS_COMPLETE,0);return S.flush(),await dh(S,ce,4),S.bindBuffer(S.PIXEL_PACK_BUFFER,$t),S.getBufferSubData(S.PIXEL_PACK_BUFFER,0,dt),S.bindBuffer(S.PIXEL_PACK_BUFFER,null),S.deleteBuffer($t),S.deleteSync(ce),dt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(y,D=null,W=0){let k=Math.pow(2,-W),z=Math.floor(y.image.width*k),dt=Math.floor(y.image.height*k),_t=D!==null?D.x:0,ut=D!==null?D.y:0;H.setTexture2D(y,0),S.copyTexSubImage2D(S.TEXTURE_2D,W,0,0,_t,ut,z,dt),p.unbindTexture()},this.copyTextureToTexture=function(y,D,W=null,k=null,z=0,dt=0){let _t,ut,yt,Et,kt,Wt,vt,$t,xe,ce=y.isCompressedTexture?y.mipmaps[dt]:y.image;if(W!==null)_t=W.max.x-W.min.x,ut=W.max.y-W.min.y,yt=W.isBox3?W.max.z-W.min.z:1,Et=W.min.x,kt=W.min.y,Wt=W.isBox3?W.min.z:0;else{let ge=Math.pow(2,-z);_t=Math.floor(ce.width*ge),ut=Math.floor(ce.height*ge),y.isDataArrayTexture?yt=ce.depth:y.isData3DTexture?yt=Math.floor(ce.depth*ge):yt=1,Et=0,kt=0,Wt=0}k!==null?(vt=k.x,$t=k.y,xe=k.z):(vt=0,$t=0,xe=0);let se=lt.convert(D.format),Le=lt.convert(D.type),gt;D.isData3DTexture?(H.setTexture3D(D,0),gt=S.TEXTURE_3D):D.isDataArrayTexture||D.isCompressedArrayTexture?(H.setTexture2DArray(D,0),gt=S.TEXTURE_2D_ARRAY):(H.setTexture2D(D,0),gt=S.TEXTURE_2D),p.activeTexture(S.TEXTURE0),p.pixelStorei(S.UNPACK_FLIP_Y_WEBGL,D.flipY),p.pixelStorei(S.UNPACK_PREMULTIPLY_ALPHA_WEBGL,D.premultiplyAlpha),p.pixelStorei(S.UNPACK_ALIGNMENT,D.unpackAlignment);let Fe=p.getParameter(S.UNPACK_ROW_LENGTH),Jt=p.getParameter(S.UNPACK_IMAGE_HEIGHT),Ke=p.getParameter(S.UNPACK_SKIP_PIXELS),pn=p.getParameter(S.UNPACK_SKIP_ROWS),Fn=p.getParameter(S.UNPACK_SKIP_IMAGES);p.pixelStorei(S.UNPACK_ROW_LENGTH,ce.width),p.pixelStorei(S.UNPACK_IMAGE_HEIGHT,ce.height),p.pixelStorei(S.UNPACK_SKIP_PIXELS,Et),p.pixelStorei(S.UNPACK_SKIP_ROWS,kt),p.pixelStorei(S.UNPACK_SKIP_IMAGES,Wt);let _i=y.isDataArrayTexture||y.isData3DTexture,ie=D.isDataArrayTexture||D.isData3DTexture;if(y.isDepthTexture){let ge=O.get(y),On=O.get(D),oe=O.get(ge.__renderTarget),Bn=O.get(On.__renderTarget);p.bindFramebuffer(S.READ_FRAMEBUFFER,oe.__webglFramebuffer),p.bindFramebuffer(S.DRAW_FRAMEBUFFER,Bn.__webglFramebuffer);for(let xi=0;xi<yt;xi++)_i&&(S.framebufferTextureLayer(S.READ_FRAMEBUFFER,S.COLOR_ATTACHMENT0,O.get(y).__webglTexture,z,Wt+xi),S.framebufferTextureLayer(S.DRAW_FRAMEBUFFER,S.COLOR_ATTACHMENT0,O.get(D).__webglTexture,dt,xe+xi)),S.blitFramebuffer(Et,kt,_t,ut,vt,$t,_t,ut,S.DEPTH_BUFFER_BIT,S.NEAREST);p.bindFramebuffer(S.READ_FRAMEBUFFER,null),p.bindFramebuffer(S.DRAW_FRAMEBUFFER,null)}else if(z!==0||y.isRenderTargetTexture||O.has(y)){let ge=O.get(y),On=O.get(D);p.bindFramebuffer(S.READ_FRAMEBUFFER,U),p.bindFramebuffer(S.DRAW_FRAMEBUFFER,V);for(let oe=0;oe<yt;oe++)_i?S.framebufferTextureLayer(S.READ_FRAMEBUFFER,S.COLOR_ATTACHMENT0,ge.__webglTexture,z,Wt+oe):S.framebufferTexture2D(S.READ_FRAMEBUFFER,S.COLOR_ATTACHMENT0,S.TEXTURE_2D,ge.__webglTexture,z),ie?S.framebufferTextureLayer(S.DRAW_FRAMEBUFFER,S.COLOR_ATTACHMENT0,On.__webglTexture,dt,xe+oe):S.framebufferTexture2D(S.DRAW_FRAMEBUFFER,S.COLOR_ATTACHMENT0,S.TEXTURE_2D,On.__webglTexture,dt),z!==0?S.blitFramebuffer(Et,kt,_t,ut,vt,$t,_t,ut,S.COLOR_BUFFER_BIT,S.NEAREST):ie?S.copyTexSubImage3D(gt,dt,vt,$t,xe+oe,Et,kt,_t,ut):S.copyTexSubImage2D(gt,dt,vt,$t,Et,kt,_t,ut);p.bindFramebuffer(S.READ_FRAMEBUFFER,null),p.bindFramebuffer(S.DRAW_FRAMEBUFFER,null)}else ie?y.isDataTexture||y.isData3DTexture?S.texSubImage3D(gt,dt,vt,$t,xe,_t,ut,yt,se,Le,ce.data):D.isCompressedArrayTexture?S.compressedTexSubImage3D(gt,dt,vt,$t,xe,_t,ut,yt,se,ce.data):S.texSubImage3D(gt,dt,vt,$t,xe,_t,ut,yt,se,Le,ce):y.isDataTexture?S.texSubImage2D(S.TEXTURE_2D,dt,vt,$t,_t,ut,se,Le,ce.data):y.isCompressedTexture?S.compressedTexSubImage2D(S.TEXTURE_2D,dt,vt,$t,ce.width,ce.height,se,ce.data):S.texSubImage2D(S.TEXTURE_2D,dt,vt,$t,_t,ut,se,Le,ce);p.pixelStorei(S.UNPACK_ROW_LENGTH,Fe),p.pixelStorei(S.UNPACK_IMAGE_HEIGHT,Jt),p.pixelStorei(S.UNPACK_SKIP_PIXELS,Ke),p.pixelStorei(S.UNPACK_SKIP_ROWS,pn),p.pixelStorei(S.UNPACK_SKIP_IMAGES,Fn),dt===0&&D.generateMipmaps&&S.generateMipmap(gt),p.unbindTexture()},this.initRenderTarget=function(y){O.get(y).__webglFramebuffer===void 0&&H.setupRenderTarget(y)},this.initTexture=function(y){y.isCubeTexture?H.setTextureCube(y,0):y.isData3DTexture?H.setTexture3D(y,0):y.isDataArrayTexture||y.isCompressedArrayTexture?H.setTexture2DArray(y,0):H.setTexture2D(y,0),p.unbindTexture()},this.resetState=function(){J=0,Y=0,K=null,p.reset(),ft.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ln}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let e=this.getContext();e.drawingBufferColorSpace=qt._getDrawingBufferColorSpace(t),e.unpackColorSpace=qt._getUnpackColorSpace()}};var Yh={type:"change"},Hl={type:"start"},Jh={type:"end"},po=new Wn,Zh=new qe,Qg=Math.cos(70*Sl.DEG2RAD),Ee=new L,He=2*Math.PI,ne={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Gl=1e-6,mo=class extends Ys{constructor(t,e=null){super(t,e),this.state=ne.NONE,this.target=new L,this.cursor=new L,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Jn.ROTATE,MIDDLE:Jn.DOLLY,RIGHT:Jn.PAN},this.touches={ONE:Kn.ROTATE,TWO:Kn.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle="auto",this._domElementKeyEvents=null,this._lastPosition=new L,this._lastQuaternion=new Ye,this._lastTargetPosition=new L,this._quat=new Ye().setFromUnitVectors(t.up,new L(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new ts,this._sphericalDelta=new ts,this._scale=1,this._panOffset=new L,this._rotateStart=new bt,this._rotateEnd=new bt,this._rotateDelta=new bt,this._panStart=new bt,this._panEnd=new bt,this._panDelta=new bt,this._dollyStart=new bt,this._dollyEnd=new bt,this._dollyDelta=new bt,this._dollyDirection=new L,this._mouse=new bt,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=e_.bind(this),this._onPointerDown=t_.bind(this),this._onPointerUp=n_.bind(this),this._onContextMenu=c_.bind(this),this._onMouseWheel=r_.bind(this),this._onKeyDown=a_.bind(this),this._onTouchStart=o_.bind(this),this._onTouchMove=l_.bind(this),this._onMouseDown=i_.bind(this),this._onMouseMove=s_.bind(this),this._interceptControlDown=h_.bind(this),this._interceptControlUp=u_.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(t){this._cursorStyle=t,t==="grab"?this.domElement.style.cursor="grab":this.domElement.style.cursor="auto"}get cursorStyle(){return this._cursorStyle}connect(t){super.connect(t),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.state=ne.NONE,this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents();let t=this.domElement.getRootNode();t.removeEventListener("keydown",this._interceptControlDown,{capture:!0}),t.removeEventListener("keyup",this._interceptControlUp,{capture:!0}),this._controlActive=!1,this._pointers.length=0,this._pointerPositions={},this.domElement.style.touchAction="",this.domElement.style.cursor="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(t){t.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=t}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Yh),this.update(),this.state=ne.NONE}pan(t,e){this._pan(t,e),this.update()}dollyIn(t){this._dollyIn(t),this.update()}dollyOut(t){this._dollyOut(t),this.update()}rotateLeft(t){this._rotateLeft(t),this.update()}rotateUp(t){this._rotateUp(t),this.update()}update(t=null){let e=this.object.position;Ee.copy(e).sub(this.target),Ee.applyQuaternion(this._quat),this._spherical.setFromVector3(Ee),this.autoRotate&&this.state===ne.NONE&&this._rotateLeft(this._getAutoRotationAngle(t)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,s=this.maxAzimuthAngle;isFinite(n)&&isFinite(s)&&(n<-Math.PI?n+=He:n>Math.PI&&(n-=He),s<-Math.PI?s+=He:s>Math.PI&&(s-=He),n<=s?this._spherical.theta=Math.max(n,Math.min(s,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+s)/2?Math.max(n,this._spherical.theta):Math.min(s,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let r=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let a=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),r=a!=this._spherical.radius}if(Ee.setFromSpherical(this._spherical),Ee.applyQuaternion(this._quatInverse),e.copy(this.target).add(Ee),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let a=null;if(this.object.isPerspectiveCamera){let o=Ee.length();a=this._clampDistance(o*this._scale);let l=o-a;this.object.position.addScaledVector(this._dollyDirection,l),this.object.updateMatrixWorld(),r=!!l}else if(this.object.isOrthographicCamera){let o=new L(this._mouse.x,this._mouse.y,0);o.unproject(this.object);let l=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),r=l!==this.object.zoom;let c=new L(this._mouse.x,this._mouse.y,0);c.unproject(this.object),this.object.position.sub(c).add(o),this.object.updateMatrixWorld(),a=Ee.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;a!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(a).add(this.object.position):(po.origin.copy(this.object.position),po.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(po.direction))<Qg?this.object.lookAt(this.target):(Zh.setFromNormalAndCoplanarPoint(this.object.up,this.target),po.intersectPlane(Zh,this.target))))}else if(this.object.isOrthographicCamera){let a=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),a!==this.object.zoom&&(this.object.updateProjectionMatrix(),r=!0)}return this._scale=1,this._performCursorZoom=!1,r||this._lastPosition.distanceToSquared(this.object.position)>Gl||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Gl||this._lastTargetPosition.distanceToSquared(this.target)>Gl?(this.dispatchEvent(Yh),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(t){return t!==null?He/60*this.autoRotateSpeed*t:He/60/60*this.autoRotateSpeed}_getZoomScale(t){let e=Math.abs(t*.01);return Math.pow(.95,this.zoomSpeed*e)}_rotateLeft(t){this._sphericalDelta.theta-=t}_rotateUp(t){this._sphericalDelta.phi-=t}_panLeft(t,e){Ee.setFromMatrixColumn(e,0),Ee.multiplyScalar(-t),this._panOffset.add(Ee)}_panUp(t,e){this.screenSpacePanning===!0?Ee.setFromMatrixColumn(e,1):(Ee.setFromMatrixColumn(e,0),Ee.crossVectors(this.object.up,Ee)),Ee.multiplyScalar(t),this._panOffset.add(Ee)}_pan(t,e){let n=this.domElement;if(this.object.isPerspectiveCamera){let s=this.object.position;Ee.copy(s).sub(this.target);let r=Ee.length();r*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*t*r/n.clientHeight,this.object.matrix),this._panUp(2*e*r/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(t*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(e*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(t,e){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),s=t-n.left,r=e-n.top,a=n.width,o=n.height;this._mouse.x=s/a*2-1,this._mouse.y=-(r/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(t){return Math.max(this.minDistance,Math.min(this.maxDistance,t))}_handleMouseDownRotate(t){this._rotateStart.set(t.clientX,t.clientY)}_handleMouseDownDolly(t){this._updateZoomParameters(t.clientX,t.clientX),this._dollyStart.set(t.clientX,t.clientY)}_handleMouseDownPan(t){this._panStart.set(t.clientX,t.clientY)}_handleMouseMoveRotate(t){this._rotateEnd.set(t.clientX,t.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let e=this.domElement;this._rotateLeft(He*this._rotateDelta.x/e.clientHeight),this._rotateUp(He*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(t){this._dollyEnd.set(t.clientX,t.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(t){this._panEnd.set(t.clientX,t.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(t){this._updateZoomParameters(t.clientX,t.clientY),t.deltaY<0?this._dollyIn(this._getZoomScale(t.deltaY)):t.deltaY>0&&this._dollyOut(this._getZoomScale(t.deltaY)),this.update()}_handleKeyDown(t){let e=!1;switch(t.code){case this.keys.UP:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(He*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),e=!0;break;case this.keys.BOTTOM:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(-He*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),e=!0;break;case this.keys.LEFT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(He*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),e=!0;break;case this.keys.RIGHT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(-He*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),e=!0;break}e&&(t.preventDefault(),this.update())}_handleTouchStartRotate(t){if(this._pointers.length===1)this._rotateStart.set(t.pageX,t.pageY);else{let e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._rotateStart.set(n,s)}}_handleTouchStartPan(t){if(this._pointers.length===1)this._panStart.set(t.pageX,t.pageY);else{let e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._panStart.set(n,s)}}_handleTouchStartDolly(t){let e=this._getSecondPointerPosition(t),n=t.pageX-e.x,s=t.pageY-e.y,r=Math.sqrt(n*n+s*s);this._dollyStart.set(0,r)}_handleTouchStartDollyPan(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enablePan&&this._handleTouchStartPan(t)}_handleTouchStartDollyRotate(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enableRotate&&this._handleTouchStartRotate(t)}_handleTouchMoveRotate(t){if(this._pointers.length==1)this._rotateEnd.set(t.pageX,t.pageY);else{let n=this._getSecondPointerPosition(t),s=.5*(t.pageX+n.x),r=.5*(t.pageY+n.y);this._rotateEnd.set(s,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let e=this.domElement;this._rotateLeft(He*this._rotateDelta.x/e.clientHeight),this._rotateUp(He*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(t){if(this._pointers.length===1)this._panEnd.set(t.pageX,t.pageY);else{let e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._panEnd.set(n,s)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(t){let e=this._getSecondPointerPosition(t),n=t.pageX-e.x,s=t.pageY-e.y,r=Math.sqrt(n*n+s*s);this._dollyEnd.set(0,r),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(t.pageX+e.x)*.5,o=(t.pageY+e.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enablePan&&this._handleTouchMovePan(t)}_handleTouchMoveDollyRotate(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enableRotate&&this._handleTouchMoveRotate(t)}_addPointer(t){this._pointers.push(t.pointerId)}_removePointer(t){delete this._pointerPositions[t.pointerId];for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId){this._pointers.splice(e,1);return}}_isTrackingPointer(t){for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId)return!0;return!1}_trackPointer(t){let e=this._pointerPositions[t.pointerId];e===void 0&&(e=new bt,this._pointerPositions[t.pointerId]=e),e.set(t.pageX,t.pageY)}_getSecondPointerPosition(t){let e=t.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[e]}_customWheelEvent(t){let e=t.deltaMode,n={clientX:t.clientX,clientY:t.clientY,deltaY:t.deltaY};switch(e){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100;break}return t.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function t_(i){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(i.pointerId),this.domElement.ownerDocument.addEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(i)&&(this._addPointer(i),i.pointerType==="touch"?this._onTouchStart(i):this._onMouseDown(i),this._cursorStyle==="grab"&&(this.domElement.style.cursor="grabbing")))}function e_(i){this.enabled!==!1&&(i.pointerType==="touch"?this._onTouchMove(i):this._onMouseMove(i))}function n_(i){switch(this._removePointer(i),this._pointers.length){case 0:this.domElement.releasePointerCapture(i.pointerId),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(Jh),this.state=ne.NONE,this._cursorStyle==="grab"&&(this.domElement.style.cursor="grab");break;case 1:let t=this._pointers[0],e=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:e.x,pageY:e.y});break}}function i_(i){let t;switch(i.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case Jn.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(i),this.state=ne.DOLLY;break;case Jn.ROTATE:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=ne.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=ne.ROTATE}break;case Jn.PAN:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=ne.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=ne.PAN}break;default:this.state=ne.NONE}this.state!==ne.NONE&&this.dispatchEvent(Hl)}function s_(i){switch(this.state){case ne.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(i);break;case ne.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(i);break;case ne.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(i);break}}function r_(i){this.enabled===!1||this.enableZoom===!1||this.state!==ne.NONE||(i.preventDefault(),this.dispatchEvent(Hl),this._handleMouseWheel(this._customWheelEvent(i)),this.dispatchEvent(Jh))}function a_(i){this.enabled!==!1&&this._handleKeyDown(i)}function o_(i){switch(this._trackPointer(i),this._pointers.length){case 1:switch(this.touches.ONE){case Kn.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(i),this.state=ne.TOUCH_ROTATE;break;case Kn.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(i),this.state=ne.TOUCH_PAN;break;default:this.state=ne.NONE}break;case 2:switch(this.touches.TWO){case Kn.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(i),this.state=ne.TOUCH_DOLLY_PAN;break;case Kn.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(i),this.state=ne.TOUCH_DOLLY_ROTATE;break;default:this.state=ne.NONE}break;default:this.state=ne.NONE}this.state!==ne.NONE&&this.dispatchEvent(Hl)}function l_(i){switch(this._trackPointer(i),this.state){case ne.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(i),this.update();break;case ne.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(i),this.update();break;case ne.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(i),this.update();break;case ne.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(i),this.update();break;default:this.state=ne.NONE}}function c_(i){this.enabled!==!1&&i.preventDefault()}function h_(i){i.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function u_(i){i.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}var go=[{slug:"langgraph-agent",title:"LangGraph-style news agent",repo:"langgraph-agent-lab",github:"https://github.com/Sam9875/langgraph-agent-lab",upstream:"https://github.com/langchain-ai/langgraph",year:"2026",language:"Python",category:"LLM",featured:!0,lab:!0,scene:"graph",blurb:"Four-node stateful graph: planner, retrieval, policy, draft \u2014 built for Column-style news, not a chatbot demo.",story:"Study of LangGraph, rewritten as a graph I own. The change is the policy node: it refuses a headline that is not in the retrieved titles, and the state checkpoints so a dropped run resumes.",tags:["LangGraph","Agents","Policy"],stack:"state graph \xB7 planner \xB7 retrieve \xB7 policy \xB7 draft",arch:[{title:"Query",sub:"user"},{title:"Plan",sub:"sub-qs"},{title:"Retrieve",sub:"news index"},{title:"Policy",sub:"ground"},{title:"Draft",sub:"cite"},{title:"Save",sub:"checkpoint"}],whatsNew:["Policy is a first-class node, not a regex on the system prompt.","citations[] on state \u2014 a draft cannot ship without sources."],next:["Swap the stub LLM for an OpenRouter call behind the same graph."]},{slug:"rag-scratch",title:"RAG from scratch",repo:"rag-from-scratch-lab",github:"https://github.com/Sam9875/rag-from-scratch-lab",upstream:"https://github.com/langchain-ai/rag-from-scratch",year:"2026",language:"Python",category:"NLP",featured:!0,lab:!0,scene:"rag",blurb:"Chunk, embed, retrieve, generate \u2014 no framework. Abstain when the news index is not confident.",story:"First-principles RAG on a news corpus. Hash embeddings so it runs without a download. The generator abstains on low cosine instead of hallucinating a cold-start user an answer.",tags:["RAG","Embeddings","Abstain"],stack:"chunk \xB7 hash-embed \xB7 cosine \xB7 generate / abstain",arch:[{title:"Docs",sub:"news"},{title:"Chunk",sub:"windows"},{title:"Embed",sub:"hash"},{title:"kNN",sub:"cosine"},{title:"Prompt",sub:"context"},{title:"Answer",sub:"or abstain"}],whatsNew:["Confidence gate so a cold-start query can return ABSTAIN.","Corpus is news + thesis facts, not Wikipedia trivia."],next:["Replace hash vectors with a small sentence encoder."]},{slug:"promptfoo-evals",title:"Promptfoo-style LLM evals",repo:"promptfoo-evals-lab",github:"https://github.com/Sam9875/promptfoo-evals-lab",upstream:"https://github.com/promptfoo/promptfoo",year:"2026",language:"Python",category:"LLM",featured:!0,lab:!0,scene:"eval",blurb:"Tiny eval runner with fairness assertions from the Turin tenant-screening audit.",story:"Promptfoo\u2019s idea \u2014 cases in, report out \u2014 pointed at my 7,800-call audit. Gender parity and nationality-leak checks live next to JSON-shape tests.",tags:["Evals","Fairness","Promptfoo"],stack:"cases \xB7 runner \xB7 asserts \xB7 report.json",arch:[{title:"Cases",sub:"YAML-like"},{title:"Model",sub:"stub / API"},{title:"JSON",sub:"shape"},{title:"Parity",sub:"gender"},{title:"Leak",sub:"nationality"},{title:"Report",sub:"pass/fail"}],whatsNew:["Fairness slices as first-class asserts, not a later spreadsheet.","Wired to the same tenant-screening prompts as Tenant-bias-LLM."],next:["Run the same cases against Owl-alpha and Qwen."]},{slug:"unsloth-lora",title:"Unsloth-style LoRA lab",repo:"unsloth-lora-lab",github:"https://github.com/Sam9875/unsloth-lora-lab",upstream:"https://github.com/unslothai/unsloth",year:"2026",language:"Python",category:"LLM",lab:!0,scene:"lora",blurb:"4-bit base + LoRA recipe for news title \u2192 abstract on one GPU. Dry-run without weights.",story:"Unsloth\u2019s single-GPU path, as a recipe I own. Data is MIND/Column style pairs. Eval is ROUGE on held-out abstracts, not a vibe check.",tags:["LoRA","Unsloth","News"],stack:"4-bit base \xB7 LoRA q/v \xB7 SFT \xB7 adapter save",arch:[{title:"Pairs",sub:"title/abs"},{title:"Tokenize",sub:"news"},{title:"Base",sub:"4-bit"},{title:"LoRA",sub:"rank 8"},{title:"SFT",sub:"one GPU"},{title:"Save",sub:"adapter"}],whatsNew:["Dry-run trainer so the recipe is reviewable without a GPU.","News pairs instead of alpaca."],next:["Run for real on a rented 24GB box and publish adapter metrics."]},{slug:"mcp-server",title:"MCP server \u2014 news, listings, risk",repo:"mcp-server-lab",github:"https://github.com/Sam9875/mcp-server-lab",upstream:"https://github.com/modelcontextprotocol/servers",year:"2026",language:"Python",category:"Systems",lab:!0,scene:"mcp",blurb:"Three MCP tools I would actually call: search_news, listing_fit, breakdown_risk.",story:"MCP servers are usually filesystem toys. These tools match Column search, the tenant audit, and Stellantis lookup \u2014 JSON-RPC over stdin so it scripts without the full SDK.",tags:["MCP","Tools","JSON-RPC"],stack:"search_news \xB7 listing_fit \xB7 breakdown_risk",arch:[{title:"Host",sub:"stdio"},{title:"News",sub:"search"},{title:"Fit",sub:"listing"},{title:"Risk",sub:"VIN"},{title:"JSON",sub:"result"},{title:"Agent",sub:"calls"}],whatsNew:["Domain tools, not echo/read_file.","No PII store on listing_fit \u2014 income in, JSON out."],next:["Expose the same tools over the official MCP SDK."]},{slug:"gemini-multimodal",title:"Gemini-style multimodal lab",repo:"gemini-multimodal-lab",github:"https://github.com/Sam9875/gemini-multimodal-lab",upstream:"https://github.com/google-gemini/cookbook",year:"2026",language:"Python",category:"Vision",lab:!0,scene:"multimodal",blurb:"Text, image, short video in one interface. Video path returns an Ego4D-style NLQ span.",story:"Cookbook pattern, pointed at first-person video. A clip plus a query returns (t0, t1) so it can sit in front of VSLNet / Video-LLaVA from the Ego4D repo.",tags:["Gemini","VideoQA","Ego4D"],stack:"text \xB7 image \xB7 video+NLQ \u2192 span",arch:[{title:"Input",sub:"3 modes"},{title:"Encode",sub:"stub"},{title:"Fuse",sub:"modalities"},{title:"Text",sub:"answer"},{title:"Video",sub:"span"},{title:"Out",sub:"JSON"}],whatsNew:["NLQ span on the video path, not caption-only.","Same fuse() for all three modes."],next:["Call Gemini / Video-LLaVA behind fuse()."]},{slug:"qdrant-search",title:"Qdrant-style hybrid search",repo:"qdrant-semantic-search",github:"https://github.com/Sam9875/qdrant-semantic-search",upstream:"https://github.com/qdrant/qdrant",year:"2026",language:"Python",category:"NLP",lab:!0,scene:"vectors",blurb:"Dense + lexical hybrid for news titles and rare supplier SKUs.",story:"Qdrant\u2019s hybrid idea, in-memory, using the same trick as the 2026 supplier-search hackathon: lexical fallback when embeddings blank on part numbers.",tags:["Qdrant","Hybrid","ANN"],stack:"embed \xB7 cosine \xB7 lexical \xB7 0.7/0.3 blend",arch:[{title:"Records",sub:"news/SKU"},{title:"Dense",sub:"vectors"},{title:"Lex",sub:"postings"},{title:"Query",sub:"blend"},{title:"Top-k",sub:"hits"},{title:"Serve",sub:"rank"}],whatsNew:["Hybrid score with an explicit lexical term for SKUs.","Shared records: thesis news + hackathon suppliers."],next:["Drop the same schema into a real Qdrant collection."]},{slug:"openhands-agent",title:"OpenHands-style coding agent",repo:"openhands-coding-agent",github:"https://github.com/Sam9875/openhands-coding-agent",upstream:"https://github.com/OpenHands/OpenHands",year:"2026",language:"Python",category:"LLM",lab:!0,scene:"agent",blurb:"Plan, patch, run tests, stop. The oracle is compile-and-test, not a vibe check.",story:"OpenHands loop, cut down. This is the compile-and-test oracle I want in LLM-for-software-engineering.",tags:["OpenHands","Agent","Oracle"],stack:"plan \xB7 patch \xB7 exec \xB7 assert",arch:[{title:"Task",sub:"spec"},{title:"Plan",sub:"steps"},{title:"Patch",sub:"files"},{title:"Run",sub:"exec"},{title:"Oracle",sub:"tests"},{title:"Stop",sub:"pass/fail"}],whatsNew:["Oracle is an executed test, not BLEU on code.","Workspace is a real folder the agent writes."],next:["Plug the loop into the SE eval dashboard."]},{slug:"mlops-lab",title:"Made-With-ML style MLOps",repo:"made-with-ml-ops",github:"https://github.com/Sam9875/made-with-ml-ops",upstream:"https://github.com/GokuMohandas/Made-With-ML",year:"2026",language:"Python",category:"Industry",lab:!0,scene:"mlops",blurb:"Notebook \u2192 train \u2192 PR-AUC \u2192 model card. Stellantis-shaped temporal split on toy logs.",story:"Made-With-ML\u2019s production path, pointed at breakdown-risk. Time split so future garage visits do not leak. Registry writes model.json + card.md.",tags:["MLOps","PR-AUC","Model card"],stack:"logs \xB7 time split \xB7 train \xB7 register",arch:[{title:"Logs",sub:"toy"},{title:"Clean",sub:"rows"},{title:"Split",sub:"time"},{title:"Train",sub:"GBDT-shaped"},{title:"PR-AUC",sub:"test"},{title:"Card",sub:"registry"}],whatsNew:["Temporal split and PR-AUC, not random accuracy.","Model card is a first-class artifact."],next:["Swap the toy table for a redacted Stellantis shard."]},{slug:"ms-recommenders",title:"Microsoft Recommenders lab",repo:"microsoft-recommenders-lab",github:"https://github.com/Sam9875/microsoft-recommenders-lab",upstream:"https://github.com/recommenders-team/recommenders",year:"2026",language:"Python",category:"RecSys",featured:!0,lab:!0,scene:"towers",blurb:"Two-tower retrieval on a MIND-shaped table with explicit new-user / new-item / both slices.",story:"Recommenders-team patterns, cut to the metric I care about in the Column thesis: recall by cold-start slice, not one blended nDCG.",tags:["MIND","Two-tower","Cold start"],stack:"user bag \xB7 news text \xB7 hash towers \xB7 slice recall",arch:[{title:"Impr",sub:"MIND-like"},{title:"User",sub:"history bag"},{title:"Item",sub:"text"},{title:"Score",sub:"dot"},{title:"Slices",sub:"cold/warm"},{title:"Recall",sub:"@2"}],whatsNew:["Metrics split: new-user, new-item, both, warm.","Same evaluation idea as Two-Tower-thesis, runnable in one file."],next:["Train real towers on MIND Large from this lab\u2019s split code."]},{slug:"two-tower-thesis",title:"Two-tower cold-start recommender",repo:"Two-Tower-thesis",github:"https://github.com/Sam9875/Two-Tower-thesis",year:"2026",language:"Python / HTML",category:"RecSys",featured:!0,scene:"towers",blurb:"Thesis for Column news: a two-tower model that still ranks when the user or the item is brand new.",story:"Sparse user\u2013item logs fail classic collaborative filters. This stack encodes content on both towers, blends a popularity prior for true cold items, and evaluates with recall@k and nDCG on held-out sessions \u2014 not a single blended score that hides the hard slice.",tags:["Two-tower","Cold start","Column news"],stack:"content towers \xB7 contrastive train \xB7 popularity prior \xB7 ranking metrics",arch:[{title:"Events",sub:"sparse clicks"},{title:"Content",sub:"title / body"},{title:"User tower",sub:"history pool"},{title:"Item tower",sub:"embeddings"},{title:"Blend",sub:"prior + score"},{title:"Eval",sub:"nDCG / recall"}],whatsNew:["Hard-negative mining from in-batch plus popular distractors.","Cold-start slice in the eval report: new users vs new items vs both."],next:["Session-aware user tower with a short GRU over the last N reads."]},{slug:"mind-large",title:"MIND Large two-tower",repo:"MIND-large-column",github:"https://github.com/Sam9875/MIND-large-column",year:"2026",category:"RecSys",featured:!0,scene:"towers",blurb:"Train a two-tower retriever on Microsoft MIND Large, then feed candidates to Column ranking.",story:"News ranking needs millions of impressions. MIND Large is the public stand-in: user history as a bag of news, item text as title+abstract, contrastive loss, then ANN retrieval for serving.",tags:["MIND","Retrieval","News"],stack:"MIND Large \xB7 two-tower \xB7 ANN \xB7 candidate gen",arch:[{title:"MIND",sub:"impressions"},{title:"History",sub:"user bag"},{title:"Towers",sub:"user / news"},{title:"Train",sub:"contrastive"},{title:"Index",sub:"ANN"},{title:"Serve",sub:"top-k news"}],whatsNew:["Separate retrieval index from the ranker so Column can swap v3/v4 heads.","Impression-level negatives instead of random news."],next:["Distill the item tower into a smaller encoder for on-device recs."]},{slug:"column-demo",title:"Column news demo",repo:"Column-Demo-apk",github:"https://github.com/Sam9875/Column-Demo-apk",year:"2026",language:"JavaScript",category:"RecSys",featured:!0,scene:"towers",blurb:"Product client for the Column stack \u2014 v3 and v4 ranking reaching a real feed UI.",story:"Models only matter if a reader sees them. The demo wires candidate generation to a mobile/web feed, switches ranking versions, and logs clicks so the thesis loop can close.",tags:["Product","Feed UI","v3 / v4"],stack:"ranking API \xB7 two-tower scores \xB7 session UI",arch:[{title:"Session",sub:"new / return"},{title:"Recall",sub:"two-tower"},{title:"Rank",sub:"v3 or v4"},{title:"Feed",sub:"demo app"},{title:"Clicks",sub:"feedback"},{title:"Loop",sub:"offline eval"}],whatsNew:["Explicit v3 vs v4 toggle in the demo.","Session badge for cold users."],next:["Push impressions back into MIND-style training shards."]},{slug:"tenant-bias",title:"Tenant-bias LLM audit",repo:"Tenant-bias-LLM",github:"https://github.com/Sam9875/Tenant-bias-LLM",year:"2026",language:"Python",category:"LLM",featured:!0,scene:"audit",blurb:"7,800 API calls: do rental-screening LLMs treat Turin applicants differently by gender or national background?",story:"Five Turin listings \xD7 480 synthetic profiles. Owl-alpha (OpenRouter) and Qwen 3.5 9B (Regolo). RQ1 gender, RQ2 nationality, RQ3 intersection, RQ4 mitigation with fairness and chain-of-thought prompts.",tags:["Fairness","Owl-alpha","Qwen"],stack:"OpenRouter \xB7 Regolo \xB7 2400\xD72 audits \xB7 RQ4 mitigation",arch:[{title:"Listings",sub:"5 Turin"},{title:"Profiles",sub:"480"},{title:"LLM",sub:"screener"},{title:"Fit JSON",sub:"yes / no"},{title:"Slices",sub:"RQ1\u20133"},{title:"Mitigate",sub:"RQ4"}],whatsNew:["RQ4: 500 pairs \xD7 three prompt conditions on both models.","Static results dashboard so reviewers need no API keys."],next:["Add a third model class under the same profile set."]},{slug:"ego4d",title:"Egocentric NLQ + VideoQA",repo:"Egocentric_VIsion",github:"https://github.com/Sam9875/Egocentric_VIsion",year:"2025",category:"Vision",featured:!0,scene:"vision",blurb:"Span models on Ego4D (VSLBase / VSLNet) plus a Video-LLaVA question-answering head.",story:"Natural language queries on first-person video: encode clips with Omnivore / EgoVLP, predict a temporal span, then ask Video-LLaVA what happened. Metrics: temporal IoU, BLEU, ROUGE.",tags:["Ego4D","VSLNet","Video-LLaVA"],stack:"Ego4D \xB7 Omnivore \xB7 EgoVLP \xB7 VSLNet \xB7 Video-LLaVA",arch:[{title:"Ego clip",sub:"Ego4D"},{title:"Visual",sub:"Omnivore"},{title:"Query",sub:"NLQ text"},{title:"Span",sub:"VSLNet"},{title:"QA",sub:"Video-LLaVA"},{title:"Metrics",sub:"IoU / BLEU"}],whatsNew:["VideoQA extension on the best span model.","GloVe vs BERT query encoders called out in the writeup."],next:["Swap EgoVLP for a newer egocentric encoder."]},{slug:"llm-se",title:"LLMs for software engineering",repo:"LLM-for-software-engineering",github:"https://github.com/Sam9875/LLM-for-software-engineering",year:"2026",language:"Python",category:"LLM",featured:!0,scene:"eval",blurb:"Eval harness and dashboard for code-oriented LLMs \u2014 tasks, traces, and scoreboards.",story:"Software-engineering prompts need more than a vibe check. This repo runs models against SE tasks, stores traces, and exposes a small dashboard so regressions show up before a demo.",tags:["Evals","Code LLM","Dashboard"],stack:"Python scripts \xB7 results JSON \xB7 dashboard",arch:[{title:"Tasks",sub:"SE prompts"},{title:"Models",sub:"API / local"},{title:"Run",sub:"traces"},{title:"Score",sub:"asserts"},{title:"Store",sub:"results/"},{title:"UI",sub:"dashboard"}],whatsNew:["Task pack split from the runner so new SE problems drop in as JSON.","Dashboard reads gitignored result dumps without re-running paid APIs."],next:["Add a compile-and-test oracle for generated patches."]},{slug:"cyber-agents",title:"Prompt-injection multi-agent defense",repo:"hackathon-Cyber-security-",github:"https://github.com/Sam9875/hackathon-Cyber-security-",year:"2026",language:"Python",category:"LLM",scene:"graph",blurb:"Hackathon system: multi-agent chatbots that catch prompt injection instead of echoing it.",story:"A single chatbot is an easy injection target. Split roles \u2014 planner, tool caller, policy checker \u2014 and require the policy agent to sign off before a tool runs.",tags:["Prompt injection","Multi-agent","Hackathon"],stack:"agent roles \xB7 policy gate \xB7 tool sandbox",arch:[{title:"User",sub:"chat"},{title:"Planner",sub:"intent"},{title:"Policy",sub:"injection scan"},{title:"Tools",sub:"gated"},{title:"Reply",sub:"sanitized"},{title:"Log",sub:"attacks"}],whatsNew:["Policy agent is first-class, not a regex bolted on the prompt.","Attack log so failed injections become regression tests."],next:["Red-team pack with indirect injection via retrieved docs."]},{slug:"supplier-search",title:"Semantic supplier search",repo:"hackathon2026",github:"https://github.com/Sam9875/hackathon2026",year:"2026",language:"Python",category:"NLP",scene:"vectors",blurb:"Hackathon pipeline: ingest suppliers, embed, enrich, and search with hybrid matching.",story:"Procurement queries are messy. Ingest sheets, enrich records, embed them, then hybrid-search so a buyer finds the right vendor without exact SKU strings.",tags:["Embeddings","Hybrid search","Procurement"],stack:"ingest \xB7 embed \xB7 enrich \xB7 search engine \xB7 Streamlit app",arch:[{title:"Sheets",sub:"ingest"},{title:"Enrich",sub:"normalize"},{title:"Embed",sub:"dense"},{title:"Index",sub:"hybrid"},{title:"Query",sub:"buyer text"},{title:"App",sub:"ranked hits"}],whatsNew:["Search engine isolated from ingest.","Lexical fallback when embeddings blank on rare part numbers."],next:["Add a reranker on the top 50 hits."]},{slug:"besstie",title:"BESSTIE dialect extensions",repo:"DNLP-BESSTIE-Extensions",github:"https://github.com/Sam9875/DNLP-BESSTIE-Extensions",year:"2026",language:"Notebook",category:"NLP",scene:"eval",blurb:"Sentiment and sarcasm classification across varieties of English \u2014 not just standard news text.",story:"Models trained on mainstream English miss sarcasm in other varieties. These notebooks extend BESSTIE with extra dialect slices and report where accuracy drops.",tags:["Sarcasm","Dialect","Classification"],stack:"BESSTIE \xB7 notebooks \xB7 variety slices",arch:[{title:"Corpus",sub:"varieties"},{title:"Labels",sub:"sent / sarcasm"},{title:"Encode",sub:"LM"},{title:"Classify",sub:"heads"},{title:"Slice",sub:"dialect"},{title:"Report",sub:"gaps"}],whatsNew:["Per-variety error table so a single macro-F1 cannot hide a dialect collapse.","Sarcasm vs sentiment heads trained jointly, then ablated."],next:["Add a code-switch slice if the license allows."]},{slug:"summarization",title:"Text summarization",repo:"Text-summarization",github:"https://github.com/Sam9875/Text-summarization",year:"2025",language:"Notebook",category:"NLP",scene:"rag",blurb:"Extractive and abstractive summarization notebooks with ROUGE-style checks.",story:"Course / lab work on compressing documents. Compare a simple extractive baseline against a neural abstractive model and keep the numbers honest.",tags:["Summarization","ROUGE","NLP"],stack:"notebooks \xB7 extractive \xB7 abstractive",arch:[{title:"Docs",sub:"source"},{title:"Extract",sub:"sentences"},{title:"Abstract",sub:"seq2seq"},{title:"Score",sub:"ROUGE"},{title:"Compare",sub:"baselines"},{title:"Notes",sub:"failures"}],whatsNew:["Failure cases called out (hallucinated entities) instead of only leaderboard ROUGE.","Single notebook path from raw text to both systems."],next:["Add a faithfulness check against the source sentences."]},{slug:"stellantis",title:"Vehicle breakdown risk",year:"2025\u201326",category:"Industry",featured:!0,scene:"mlops",blurb:"Stellantis: predict breakdown risk from 1M+ service logs, warranty claims, and sensor signals.",story:"Industrial ML, not a notebook toy. Cleaning messy garage data, engineering usage and fault-code features, then comparing CatBoost, LightGBM and Random Forests with calibration in mind. Temporal splits so future visits do not leak into training.",tags:["CatBoost","LightGBM","Pipelines"],stack:"pandas / Spark \xB7 feature pipes \xB7 GBDT \xB7 PR-AUC",arch:[{title:"Logs",sub:"1M+"},{title:"Clean",sub:"units / gaps"},{title:"Features",sub:"usage"},{title:"Models",sub:"GBDT"},{title:"Calibrate",sub:"PR-AUC"},{title:"Score",sub:"ops"}],whatsNew:["Model card: which fault codes actually move the score.","Temporal split so we do not leak future garage visits."],next:["Online monitoring for concept drift on new vehicle lines."]},{slug:"hospital",title:"Post-operative risk models",year:"2025\u201326",category:"Industry",scene:"audit",blurb:"LINKS Foundation & Molinette: complications and nosocomial infection risk for ENT oncology.",story:"Clinical tabular models with explanations. Temporal validation, SHAP drivers, flags meant for a clinician \u2014 not a raw probability dump.",tags:["Healthcare","XGBoost","SHAP"],stack:"clinical features \xB7 XGBoost \xB7 SHAP \xB7 time split",arch:[{title:"EHR",sub:"cohort"},{title:"Feats",sub:"labs"},{title:"Train",sub:"XGB"},{title:"Explain",sub:"SHAP"},{title:"Validate",sub:"time"},{title:"Flags",sub:"clinic"}],whatsNew:["Infection vs complication treated as separate heads.","Clinician-facing top-3 SHAP drivers on each flag."],next:["External validation on a later Molinette window."]},{slug:"age-speech",title:"Age from speech",year:"2024\u201325",category:"NLP",scene:"eval",blurb:"Regression from acoustic and linguistic features of spoken sentences.",story:"PoliTo lab: extract prosody and lexical cues, train ensembles, report MAE/RMSE with error bands \u2014 not a single magic number.",tags:["Speech","Regression"],stack:"acoustic + linguistic \xB7 sklearn",arch:[{title:"Audio",sub:"speech"},{title:"Acoustic",sub:"prosody"},{title:"Lexical",sub:"cues"},{title:"Regress",sub:"ensemble"},{title:"Select",sub:"MAE"},{title:"Age",sub:"bands"}],whatsNew:["Ablation: acoustic-only vs linguistic-only vs both."],next:["Test on a second corpus to check domain shift."]},{slug:"os-paper",title:"Microkernel vs monolithic OS",year:"2023",paper:"https://www.researchgate.net/profile/Samesun-Singh",category:"Systems",scene:"systems",blurb:"Publication: how kernel architecture changes isolation, reliability and fault tolerance.",story:"Safety-critical systems care whether a crash stays in a server or takes the whole kernel. The paper compares isolation and latency trade-offs, not slogans.",tags:["OS","Safety","Paper"],stack:"fault models \xB7 isolation \xB7 latency",arch:[{title:"Load",sub:"safety"},{title:"Mono",sub:"shared"},{title:"Micro",sub:"servers"},{title:"Faults",sub:"crash"},{title:"Props",sub:"isolation"},{title:"Report",sub:"tradeoff"}],whatsNew:["Portfolio writeup states the fault model explicitly (crash vs corrupt)."],next:["Link the PDF once a stable ResearchGate file URL is pinned."]},{slug:"dcn-23",title:"DCN-23",repo:"DCN-23",github:"https://github.com/Sam9875/DCN-23",year:"2025",language:"C++",category:"Systems",scene:"systems",blurb:"Data-communication coursework in C++ \u2014 protocols, sockets, and lab traces.",story:"Low-level networking still matters when you later ship ML services. This lab is the C++ side of that: packets, not notebooks.",tags:["C++","Networking"],stack:"C++ \xB7 sockets \xB7 lab traces",arch:[{title:"Spec",sub:"protocol"},{title:"Socket",sub:"C++"},{title:"Send",sub:"frames"},{title:"Recv",sub:"parse"},{title:"Log",sub:"traces"},{title:"Check",sub:"lab"}],whatsNew:["Framed as systems grounding for later ML serving."],next:["Add a tiny README with build + run commands."]},{slug:"sockets-c",title:"Sockets in C",repo:"Socket-programming-in-c-",github:"https://github.com/Sam9875/Socket-programming-in-c-",year:"2024",language:"C",category:"Systems",scene:"systems",blurb:"TCP client/server exercises in C \u2014 the unglamorous layer under every API.",story:"Bind, listen, accept, read. The point is to remember what a model-serving socket actually is.",tags:["C","TCP"],stack:"BSD sockets \xB7 C",arch:[{title:"Bind",sub:"port"},{title:"Listen",sub:"backlog"},{title:"Accept",sub:"client"},{title:"Read",sub:"buffer"},{title:"Write",sub:"reply"},{title:"Close",sub:"fd"}],whatsNew:["Portfolio card documents the intended client/server flow."],next:["Commit a minimal echo server + client with a Makefile."]},{slug:"ml-lab",title:"Machine & deep learning lab",repo:"machine-deep-lab-3s",github:"https://github.com/Sam9875/machine-deep-lab-3s",year:"2025",category:"Course",scene:"mlops",blurb:"Course lab 3: classical ML through small deep models, with notebooks as the trail.",story:"The lab that sits under later work \u2014 sklearn, a first net, plots. Kept public so the path from coursework to Stellantis / thesis is visible.",tags:["sklearn","Deep learning","Lab"],stack:"notebooks \xB7 sklearn \xB7 small nets",arch:[{title:"Data",sub:"lab set"},{title:"Baseline",sub:"sklearn"},{title:"Net",sub:"MLP"},{title:"Train",sub:"loop"},{title:"Plot",sub:"curves"},{title:"Report",sub:"lab 3"}],whatsNew:["Tagged as coursework so it does not pretend to be a production system."],next:["Pin package versions so the notebook still runs."]},{slug:"hellooow",title:"Hellooow \u2014 interaction study",repo:"Hellooow",github:"https://github.com/Sam9875/Hellooow",year:"2026",language:"JavaScript",category:"Course",scene:"multimodal",blurb:"Small client-side site: layout, motion, and interaction as product craft \u2014 not a course dump.",story:"A personal frontend experiment. Useful as a reminder that ranking models still have to live inside an interface someone will touch.",tags:["Frontend","Interaction"],stack:"JavaScript \xB7 client UI",arch:[{title:"Page",sub:"shell"},{title:"Layout",sub:"rhythm"},{title:"Motion",sub:"easing"},{title:"Input",sub:"tap"},{title:"State",sub:"local"},{title:"Polish",sub:"craft"}],whatsNew:["Recast on the portfolio as a craft study, not a joke repo."],next:["Extract one interaction pattern into the Column demo."]},{slug:"grit",title:"Grit",repo:"Grit",year:"2026",language:"JavaScript",category:"Course",private:!0,scene:"agent",blurb:"Private JavaScript experiment. Closed source \u2014 this page is the public sketch, not the tree.",story:"A private product/interaction experiment. Listed so the GitHub account is complete; internals stay off this site.",tags:["Private","JavaScript"],stack:"JS \xB7 private",arch:[{title:"Idea",sub:"closed"},{title:"Proto",sub:"JS"},{title:"Iterate",sub:"private"},{title:"Hold",sub:"source"},{title:"Note",sub:"portfolio"},{title:"Ask",sub:"walkthrough"}],whatsNew:["Named on the site without exposing the private tree."],next:["Walkthrough on request."]},{slug:"portfolio-site",title:"This portfolio",repo:"Sam9875.github.io",github:"https://github.com/Sam9875/Sam9875.github.io",year:"2026",language:"TypeScript",category:"Course",scene:"constellation",blurb:"Personal site: CV, every public repo, 3D architecture views, and the 2026 lab set.",story:"Static Pages plus this interactive app. GitHub links are live. Architecture is a first-class button. The ten DS/AI labs are original repos, not silent forks of 90k-star trees.",tags:["Portfolio","Three.js"],stack:"React \xB7 TanStack \xB7 three.js \xB7 GitHub Pages",arch:[{title:"CV",sub:"facts"},{title:"Repos",sub:"catalog"},{title:"Labs",sub:"10 stacks"},{title:"Arch",sub:"pipelines"},{title:"3D",sub:"scenes"},{title:"Ship",sub:"preview"}],whatsNew:["Ten original GitHub labs for the DS/AI stack list, each with a twist from Column / Stellantis / Ego4D.","Per-project 3D scene plus a constellation you can orbit."],next:["Keep Pages and this app in sync when a new repo lands."]}];function Wl(){return go.filter(i=>i.lab)}var tn=[{id:"origin",label:"Origin",kicker:"The manifesto",copy:"Building systems that learn in production.",x:0,z:0,radius:2.35},{id:"labs",label:"Labs",kicker:"Ten original repos",copy:"LangGraph, RAG, evals, LoRA, MCP \u2014 rebuilt with my data.",x:7.6,z:-5.1,radius:4.05},{id:"work",label:"Work",kicker:"Research and product",copy:"Cold-start ranking, a 7,800-call audit, egocentric vision.",x:-7.8,z:-3.1,radius:4.25},{id:"experience",label:"Experience",kicker:"Industry",copy:"Column news, Stellantis, Molinette.",x:-1.2,z:7.8,radius:3.15},{id:"contact",label:"Contact",kicker:"Torino",copy:"Open to data and AI roles.",x:8.4,z:5.2,radius:2.25}],d_=new Set(["two-tower-thesis","mind-large","column-demo","tenant-bias","ego4d","llm-se","cyber-agents","supplier-search"]);function f_(i,t,e,n,s,r){let a=i/Math.max(t,1)*Math.PI*2-Math.PI/2+r*.08,o=Math.sin(i*2.15+r)*.22,l=s+o;return{x:e+Math.cos(a)*l,y:.22+Math.sin(i*1.7+r)*.08,z:n+Math.sin(a)*l}}function or(i,t){return t.map((e,n)=>{let s=f_(n,t.length,i.x,i.z,i.radius*.62,i.radius);return{...e,area:i.id,...s}})}function $h(){let i=tn[0],t=tn[1],e=tn[2],n=tn[3],s=tn[4],r=[{id:"sk-py",label:"Python",kind:"skill"},{id:"sk-sql",label:"SQL",kind:"skill"},{id:"sk-ml",label:"GBDT",kind:"skill"},{id:"sk-llm",label:"LLM",kind:"skill"},{id:"sk-rag",label:"RAG",kind:"skill"},{id:"sk-rec",label:"RecSys",kind:"skill"}],a=Wl().map(u=>({id:u.slug,label:Kh(u),kind:"project",slug:u.slug})),o=go.filter(u=>!u.lab&&!u.private&&d_.has(u.slug)).map(u=>({id:u.slug,label:Kh(u),kind:"project",slug:u.slug})),l=[{id:"job-column",label:"Column news",kind:"job",slug:"two-tower-thesis"},{id:"job-stellantis",label:"Stellantis",kind:"job",slug:"stellantis"},{id:"job-hospital",label:"Molinette",kind:"job",slug:"hospital"},{id:"edu-msc",label:"MSc PoliTo",kind:"edu"},{id:"edu-bsc",label:"BSc PoliTo",kind:"edu"},{id:"edu-msu",label:"MSU exchange",kind:"edu"}],c=[{id:"c-mail",label:"Email",kind:"contact",href:"mailto:samesun987@gmail.com"},{id:"c-gh",label:"GitHub",kind:"contact",href:"https://github.com/Sam9875"},{id:"c-li",label:"LinkedIn",kind:"contact",href:"https://www.linkedin.com/in/samesun-singh-979a86275/"},{id:"c-cv",label:"CV",kind:"contact",href:"/Samesun_Singh_CV_EN.pdf"}];return[...or(i,r),...or(t,a),...or(e,o),...or(n,l),...or(s,c)]}function Kh(i){let t=i.title.replace(/-style /i," ").replace(/ lab$/i,"");return t.length>22?`${t.slice(0,20)}\u2026`:t}var Gy=go.filter(i=>!i.lab),Hy=Wl();var cs="#121a18",en=4050864,p_=1735272,m_=10135714,g_="#e7eee9";function __(i,t=22){let e=i.split(" "),n=[],s="";for(let r of e){let a=s?`${s} ${r}`:r;a.length>t&&s?(n.push(s),s=r):s=a}return s&&n.push(s),n.slice(0,2)}function x_(i,t,e,n,s,r){let a=Math.min(r,s/2,n/2);i.beginPath(),i.moveTo(t+a,e),i.arcTo(t+n,e,t+n,e+s,a),i.arcTo(t+n,e+s,t,e+s,a),i.arcTo(t,e+s,t,e,a),i.arcTo(t,e,t+n,e,a),i.closePath()}function jh(i,t=2.2,e="node"){let n=document.createElement("canvas");n.width=1024,n.height=256;let s=n.getContext("2d");if(!s)return new ci;s.clearRect(0,0,1024,256);let r=e==="area"?[i.slice(0,18)]:__(i,20);s.font=e==="area"?"600 54px 'IBM Plex Sans', system-ui, sans-serif":"600 40px 'IBM Plex Sans', system-ui, sans-serif",s.textAlign="center",s.textBaseline="middle";let a=e==="area"?60:46,o=r.map(g=>s.measureText(g).width),l=Math.max(...o,40),c=Math.min(960,l+56),u=r.length*a+28,m=(1024-c)/2,h=(256-u)/2;e==="node"&&(x_(s,m,h,c,u,18),s.fillStyle="rgba(12, 18, 17, 0.88)",s.fill(),s.strokeStyle="rgba(61, 207, 176, 0.45)",s.lineWidth=2,s.stroke()),s.fillStyle=e==="area"?"#3dcfb0":g_,r.forEach((g,d)=>{s.fillText(g,512,h+14+a/2+d*a)});let f=new Zi(n);f.colorSpace=Ce;let _=new Xi({map:f,transparent:!0,depthTest:!1}),b=new ci(_);return b.scale.set(t,t*.25,1),b.center.set(.5,0),b}function y_(){let i=document.createElement("canvas");i.width=1024,i.height=1024;let t=i.getContext("2d");if(!t)return new Ie;t.fillStyle=cs,t.fillRect(0,0,1024,1024),t.strokeStyle="rgba(61, 207, 176, 0.28)",t.lineWidth=1.1;for(let n=36;n<520;n+=26){t.beginPath();for(let s=0;s<=Math.PI*2+.02;s+=.04){let r=Math.sin(s*3+n*.03)*10+Math.cos(s*5+n*.01)*7,a=512+Math.cos(s)*(n+r),o=512+Math.sin(s)*(n+r)*.9;s===0?t.moveTo(a,o):t.lineTo(a,o)}t.stroke()}t.strokeStyle="rgba(61, 207, 176, 0.16)";for(let[n,s,r]of[[300,720,90],[780,280,110],[240,260,70],[760,760,80]])for(let a=18;a<r;a+=16)t.beginPath(),t.arc(n,s,a,0,Math.PI*2),t.stroke();let e=new Zi(i);return e.colorSpace=Ce,e.anisotropy=4,e}function _o(i){let t=i.getBoundingClientRect(),e=Math.max(Math.floor(t.width||i.clientWidth||window.innerWidth),1),n=Math.max(Math.floor(t.height||i.clientHeight||window.innerHeight),1);return{w:e,h:n}}function v_(i){let t=new ho({antialias:!0,alpha:!0}),{w:e,h:n}=_o(i);return t.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),t.setSize(e,n,!1),t.setClearColor(cs,1),t.outputColorSpace=Ce,t.toneMapping=Js,t.toneMappingExposure=1.25,i.style.background=cs,i.appendChild(t.domElement),t.domElement.style.display="block",t.domElement.style.width="100%",t.domElement.style.height="100%",t.domElement.style.touchAction="none",t.domElement.style.background=cs,t.domElement.style.cursor="grab",t}function b_(i,t){return Math.sin(i*.22)*Math.cos(t*.18)*.28+Math.sin(i*.55+t*.4)*.1}function Qh(i,t,e){let n=i.clone().lerp(t,.5);n.y+=e;let s=new L(-(t.z-i.z),0,t.x-i.x).normalize().multiplyScalar(e*.9);return n.add(s),new Bs(i,n,t)}function Yy(i,t){let e=$h(),n=new Rs;n.background=new Ft(cs),n.fog=new Cs(cs,22,48);let s=_o(i),r=new Re(42,s.w/s.h,.1,80);r.position.set(.8,7.1,8.4);let a=v_(i);n.add(new Vs(14019812,988949,1.15));let o=new Xs(15199977,.85);o.position.set(6,14,8),n.add(o);let l=new Ws(en,.55,42);l.position.set(-8,6,-4),n.add(l);let c=new di(36,36,48,48);c.rotateX(-Math.PI/2);let u=c.attributes.position;for(let S=0;S<u.count;S++)u.setY(S,b_(u.getX(S),u.getZ(S))-.35);c.computeVertexNormals();let m=new _e(c,new Nn({map:y_(),color:1844771,roughness:.96,metalness:0}));n.add(m);let h=new vn({color:en,transparent:!0,opacity:.92,side:Ve,depthWrite:!1}),f=new vn({color:en,transparent:!0,opacity:.38,side:Ve,depthWrite:!1}),_=new Nn({color:en,emissive:en,emissiveIntensity:.55,roughness:.32,metalness:.12}),b=new Nn({color:p_,emissive:en,emissiveIntensity:.4,roughness:.5}),g=new Nn({color:4025182,emissive:en,emissiveIntensity:.35,roughness:.45}),d=new Nn({color:m_,emissive:en,emissiveIntensity:.3,roughness:.55}),E=[],C=[],v=[],w=[],T=tn[0];tn.forEach(S=>{let Tt=h.clone(),M=f.clone(),p=new _e(new Ki(S.radius-.09,S.radius+.09,96),Tt);p.rotation.x=-Math.PI/2,p.position.set(S.x,.04,S.z),p.userData.pick={type:"area",id:S.id},n.add(p),E.push(p);let P=new _e(new Ki(S.radius+.32,S.radius+.44,96),M);P.rotation.x=-Math.PI/2,P.position.set(S.x,.04,S.z),n.add(P);let O=new _e(new Os(Math.max(S.radius-.12,.4),64),new vn({color:en,transparent:!0,opacity:.07,side:Ve,depthWrite:!1}));O.rotation.x=-Math.PI/2,O.position.set(S.x,.015,S.z),n.add(O),C.push({mesh:p,halo:P,id:S.id,base:S.radius});let H=jh(S.label.toUpperCase(),3.4,"area");if(H.position.set(S.x,.78,S.z),n.add(H),S.id!=="origin"){let it=new L(T.x,.12,T.z),st=new L(S.x,.12,S.z),q=Qh(it,st,1.4);w.push(q);let j=new ui(new be().setFromPoints(q.getPoints(40)),new hi({color:en,transparent:!0,opacity:.4}));n.add(j)}});let R=new ks(.22,0),x=new $i(.12,12,10);e.forEach(S=>{let Mt=S.kind==="skill"?x:R,Tt=S.kind==="skill"?b:S.kind==="job"||S.kind==="edu"?g:S.kind==="contact"?d:_,M=new _e(Mt,Tt);M.position.set(S.x,S.y,S.z),M.userData.pick={type:"node",id:S.id,slug:S.slug,kind:S.kind,href:S.href,label:S.label},n.add(M),E.push(M);let p=jh(S.label,S.kind==="skill"?2.05:2.75,"node");p.position.set(S.x,S.y+.42,S.z),p.visible=!1,n.add(p),v.push({mesh:M,sprite:p,node:S,baseY:S.y});let P=tn.find(O=>O.id===S.area);if(P){let O=new L(P.x,.1,P.z),H=new L(S.x,S.y,S.z),it=Qh(O,H,.55);w.push(it);let st=new ui(new be().setFromPoints(it.getPoints(16)),new hi({color:en,transparent:!0,opacity:.32}));n.add(st)}});let A=t.reducedMotion?0:90,I=new $i(.048,6,6),F=new vn({color:en,transparent:!0,opacity:.7}),B=A?new qi(I,F,A):null,G=new ve,U=Array.from({length:A},(S,Mt)=>({path:Mt%Math.max(w.length,1),t:Mt/Math.max(A,1)%1,speed:.04+Mt%5*.012}));B&&n.add(B),i.style.position=i.style.position||"relative";let V=document.createElement("div");V.setAttribute("aria-hidden","true"),V.style.cssText="position:absolute;inset:0;pointer-events:none;overflow:hidden;z-index:2",i.appendChild(V);let J=v.map(S=>{let Mt=document.createElement("span");return Mt.textContent=S.node.label,Mt.style.cssText="position:absolute;transform:translate(-50%,-130%);padding:0.28rem 0.62rem;border-radius:999px;border:1px solid rgba(61,207,176,0.55);background:rgba(18,26,24,0.94);color:#f2f7f4;font:500 13px/1.2 'IBM Plex Sans',system-ui,sans-serif;white-space:nowrap;opacity:0;letter-spacing:0.01em;box-shadow:0 6px 18px rgba(0,0,0,0.35)",V.appendChild(Mt),{tag:Mt,n:S}}),Y=new L,K=new mo(r,a.domElement);K.enableDamping=!0,K.dampingFactor=.07,K.enablePan=!0,K.minDistance=2.2,K.maxDistance=22,K.minPolarAngle=.35,K.maxPolarAngle=1.15,K.autoRotate=!1,K.autoRotateSpeed=0,K.target.set(0,0,0),K.maxAzimuthAngle=1/0,K.minAzimuthAngle=-1/0;let X=new qs;X.params.Points={threshold:.2};let tt=new bt,et=null,wt={x:0,y:0},xt="origin",Xt=1,Ht=new L,Yt=new L,Z=new L,Q=new L;function mt(S){S!==xt&&(xt=S,t.onAreaChange?.(S))}function Dt(){let S=K.target,Mt="origin",Tt=1/0;return tn.forEach(M=>{let p=(M.x-S.x)**2+(M.z-S.z)**2;p<Tt&&(Tt=p,Mt=M.id)}),Mt}function pt(S,Mt,Tt=9,M=.58){Ht.copy(r.position),Z.copy(K.target),Q.set(S,.2,Mt),Yt.set(S+Tt*.1,Math.max(Tt*M,2.4),Mt+Tt*.62),Xt=0,K.autoRotate=!1}function Ot(S){let Mt=Math.max(S.radius*1.4+2.6,4.4);pt(S.x,S.z,Mt,.7),xt=S.id,t.onAreaChange?.(S.id)}function pe(S){let Mt=a.domElement.getBoundingClientRect();return tt.x=(S.clientX-Mt.left)/Mt.width*2-1,tt.y=-((S.clientY-Mt.top)/Mt.height)*2+1,X.setFromCamera(tt,r),X.intersectObjects(E,!1)[0]}let Bt=S=>{wt={x:S.clientX,y:S.clientY},a.domElement.style.cursor="grabbing"},Zt=S=>{let Tt=pe(S)?.object??null;if(Tt!==et){et=Tt;let M=Tt?.userData.pick??null;t.onHover?.(M),a.domElement.style.cursor=M?"pointer":"grab",v.forEach(p=>{p.sprite.visible=p.mesh===Tt||p.node.area===xt})}},te=S=>{if(a.domElement.style.cursor=et?"pointer":"grab",Math.hypot(S.clientX-wt.x,S.clientY-wt.y)>6)return;let Tt=pe(S)?.object.userData.pick;if(Tt){if(Tt.type==="area"){let M=tn.find(p=>p.id===Tt.id);M&&Ot(M)}else{let M=e.find(p=>p.id===Tt.id);M&&(pt(M.x,M.z,3.6,.7),xt=M.area,t.onAreaChange?.(M.area))}t.onPick?.(Tt)}};a.domElement.addEventListener("pointerdown",Bt),a.domElement.addEventListener("pointermove",Zt),a.domElement.addEventListener("pointerup",te);let Gt=new L,re=performance.now(),me=0,Ae=()=>{me=requestAnimationFrame(Ae);let S=(performance.now()-re)/1e3,Mt=Math.min(.05,1/60);if(Xt<1){Xt=Math.min(1,Xt+Mt*1.55);let P=Xt*Xt*(3-2*Xt);r.position.lerpVectors(Ht,Yt,P),K.target.lerpVectors(Z,Q,P)}if(t.reducedMotion||(C.forEach((P,O)=>{let H=P.id===xt,it=(H?1.06:1)+Math.sin(S*1.4+O)*(H?.018:.008);P.mesh.scale.set(it,it,it),P.halo.scale.set(it*1.02,it*1.02,it*1.02);let st=P.mesh.material,q=P.halo.material;st.opacity=H?1:.62,q.opacity=H?.55:.22}),v.forEach((P,O)=>{P.mesh.position.y=P.baseY+Math.sin(S*1.6+O*.5)*.05,P.sprite.position.y=P.mesh.position.y+.42;let H=P.mesh===et||P.node.area===xt;P.mesh.scale.setScalar(P.mesh===et?1.4:H?1.12:1)}),B&&w.length&&(U.forEach((P,O)=>{P.t=(P.t+P.speed*Mt)%1,w[P.path%w.length].getPoint(P.t,Gt),G.position.copy(Gt),G.scale.setScalar(.9+Math.sin(S*3+O)*.15),G.updateMatrix(),B.setMatrixAt(O,G.matrix)}),B.instanceMatrix.needsUpdate=!0)),Xt>=1){let P=Dt();mt(P)}let Tt=r.position.distanceTo(K.target)<8.6,{w:M,h:p}=_o(i);J.forEach(({tag:P,n:O})=>{let H=O.mesh===et||Tt&&O.node.area===xt;if(O.sprite.visible=!1,!H){P.style.opacity="0";return}if(Y.set(O.mesh.position.x,O.mesh.position.y+.3,O.mesh.position.z).project(r),Y.z>1){P.style.opacity="0";return}P.style.left=`${(Y.x*.5+.5)*M}px`,P.style.top=`${(-Y.y*.5+.5)*p}px`,P.style.opacity=O.mesh===et?"1":"0.96"}),K.update(),a.render(n,r)};Ae();let le=()=>{let{w:S,h:Mt}=_o(i);r.aspect=S/Mt,r.updateProjectionMatrix(),a.setSize(S,Mt,!1)},fe=new ResizeObserver(le);return fe.observe(i),{flyToArea:S=>{let Mt=tn.find(Tt=>Tt.id===S);Mt&&Ot(Mt)},reset:()=>{Ht.copy(r.position),Z.copy(K.target),Yt.set(.8,7.1,8.4),Q.set(0,0,0),Xt=0,mt("origin")},dispose:()=>{cancelAnimationFrame(me),fe.disconnect(),a.domElement.removeEventListener("pointerdown",Bt),a.domElement.removeEventListener("pointermove",Zt),a.domElement.removeEventListener("pointerup",te),K.dispose(),n.traverse(S=>{if(S instanceof _e||S instanceof qi){S.geometry.dispose();let Mt=S.material;Array.isArray(Mt)?Mt.forEach(Tt=>Tt.dispose()):("map"in Mt&&Mt.map&&Mt.map.dispose(),Mt.dispose())}S instanceof ci&&(S.material.map?.dispose(),S.material.dispose()),S instanceof ui&&(S.geometry.dispose(),S.material.dispose())}),a.dispose(),a.domElement.remove(),V.remove()}}}export{Yy as mountLivingMap};
